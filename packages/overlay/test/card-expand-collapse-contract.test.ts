...
describe("card expand and collapse contract", () => {
  ...
  test("CardHeader single click and keyboard toggle both directions", () => {
    ...
    expect(src).toContain('import { Button } from "./ui/Button"')
    expect(src).toContain("<Button")
    expect(src).toContain('class="card__head-main"')
    expect(src).toContain('data-ui="card-head-main"')
    expect(src).toContain('variant="ghost"')
    expect(src).toContain('size="mini"')
  ...
  test("GoalWorkflowGroup follows the same header toggle contract", () => {
    ...
    expect(src).toContain('data-ui="gwg-header"')
    expect(src).toContain('variant="ghost"')
    expect(src).toContain('size="mini"')
    expect(src).toContain('tone="neutral"')
    expect(src).toContain("aria-expanded={expanded()}")
    expect(src).not.toContain('class="gwg-header"')
