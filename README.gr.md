...
nix run nixpkgs#opencode           # ή github:yangheng95/argus με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το OpenCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/yangheng95/argus/releases) ή το [opencode.ai/download](https://opencode.ai/download).
