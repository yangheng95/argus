---
title: Zen
description: Lista selecionada de modelos fornecidos pelo argus.
---
...
O Argus Zen é uma lista de modelos testados e verificados fornecidos pela equipe do argus.

:::note
O Argus Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no argus. Você faz login no Argus Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o argus.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o argus.
:::
...
O Argus Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O Argus Zen funciona como qualquer outro provedor no argus.

1. Você faz login no **<a href={console}>Argus Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Argus Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do argus usa o formato `argus/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `argus/gpt-5.2-codex` na sua configuração.
...
- GLM 4.7 Free está disponível no argus por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Kimi K2.5 Free está disponível no argus por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- MiniMax M2.1 Free está disponível no argus por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no argus por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o argus também.
