...
| Existing restore race record | `specs/records/2026-06/2026-06-13-coding-assistant-restore-selection-race.md` says `applyDirectory` owns directory reload and `selectTask` owns task switching. | Reuse those boundaries, no new store or duplicate task directory cache.                                                                           |
