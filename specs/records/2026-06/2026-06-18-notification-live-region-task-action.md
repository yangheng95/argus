...
| --------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `rg -n -e "NotificationCenter" -e "app-notification" -e "activateTaskNotification" packages/overlay/src packages/overlay/test specs` | `NotificationCenter.tsx` is the only creator of `.app-notification`; it is mounted by `main.tsx` for toast and `App.tsx` for the right panel. | Fix the shared component once; do not create toast/panel branches.                           |
