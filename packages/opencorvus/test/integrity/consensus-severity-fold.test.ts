    ...
    drilldowns: [
      {
        ...
        purpose: "Check whether quota handling is only a warning concern.",
        result: "ADV-3: Quota warning is missing.",
      },
    ],
    coverage: [
      {
        ...
        requirementID: "REQ-3",
        status: "covered",
        evidence: "Normal persistence is bounded separately from quota hardening.",
      },
    ],
    evidence: [{ checkIDs: ["check-advisory-quota"], note: "ADV-3: Quota warning is missing." }],
    openQuestions: [],
  },
  {
    reviewerID: "rev_blocking",
    checkIDs: ["check-blocking-quota"],
    ...
    drilldowns: [
      {
        ...
        kind: "diff_for_file",
        target: "src/services/storage.ts",
        purpose: "Check whether quota handling is being promoted to blocking data loss.",
        result: "BF-1: Quota failure silently loses persistence.",
      },
    ],
    coverage: [
      {
        ...
        requirementID: "REQ-3",
        status: "covered",
        evidence: "Normal persistence behavior is distinct from quota exhaustion.",
      },
    ],
    evidence: [{ checkIDs: ["check-blocking-quota"], note: "BF-1: Quota failure silently loses persistence." }],
    openQuestions: [],
  },
]
