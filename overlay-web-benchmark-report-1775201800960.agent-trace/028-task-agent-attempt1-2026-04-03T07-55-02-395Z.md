...
- Plan: 2 goals
- Active run: run_d525640ae001a92kQ7SyDU54fj (running)
- Budget: 13/20 runs, 0/8 fixes
...
Executor run run_d525640ae001a92kQ7SyDU54fj completed.
...
看起来测试目标尚未完成。让我重新创建运行并提交执行，因为当前运行可能处于挂起状态。
