---
title: SDK
description: Типобезопасный JS-клиент для сервера argus.
---
...
Вы можете передать объект конфигурации для настройки поведения. Экземпляр по-прежнему получает ваш `argus.json`, но вы можете переопределить или добавить встроенную конфигурацию:
...
Если у вас уже есть работающий экземпляр argus, вы можете создать экземпляр клиента для подключения к нему:
