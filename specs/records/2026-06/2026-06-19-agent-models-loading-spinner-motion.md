...
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
| `rg -n "agent-models-loading-spinner                       | oc-spin                                                                                                                  | spinner" packages/overlay/src packages/overlay/test specs`                                                           | `.agent-models-loading-spinner` is live, but only `.card__spinner` and `.app-notification__spinner` animate. | Extend the existing spinner contract to this live selector. |
