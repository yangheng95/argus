...
| Retired TUI runtime                 | `packages/opencorvus/src/tui/runtime.ts`                  | Removed by `specs/new-arch/2026-06-10-tui-removal-plan.md`; no longer a current call site.                       | No current action. Preserve this row only as historical audit context.                                                                         |
