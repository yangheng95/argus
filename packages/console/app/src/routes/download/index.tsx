...
import desktopAppIcon from "../../asset/brand/mascot-ar-icon.png"
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://opencorvus.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>opencorvus.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
