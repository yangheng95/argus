---
title: Zen
description: Lista seleccionada de modelos proporcionada por Argus.
---
...
Argus Zen es una lista de modelos probados y verificados proporcionada por el equipo Argus.

:::note
Argus Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en Argus. Inicias sesion en Argus Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar Argus.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Argus.
:::
...
Argus Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

Argus Zen funciona como cualquier otro proveedor en Argus.

1. Inicias sesión en **<a href={console}>Argus Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona Argus Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de Argus
usa el formato `argus/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `argus/gpt-5.2-codex` en tu configuracion.
...
- GLM 4.7 Free está disponible en Argus por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en Argus por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en Argus por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en Argus por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con Argus también.
