---
title: CLI
description: OpenCorvus command-line interface reference.
---
...
| `--format default       | json`                                                 | Select formatted output or raw JSON events |
...
`opencorvus mcp serve` and `opencorvus mcp browser` are internal server entrypoints.

### Other common commands

| Command                         | Purpose                                                             |
| ------------------------------- | ------------------------------------------------------------------- |
| `opencorvus acp`                | Start the [Agent Client Protocol](/docs/acp/) server                |
| `opencorvus agent`              | Create or list local agents                                         |
| `opencorvus db`                 | Open the SQLite shell, run a positional query, print path, or reset |
| `opencorvus debug`              | Debug config, files, LSP, snapshots, skills, paths, and agents      |
...
| `opencorvus slack`              | Start the embedded Slack adapter                                    |
