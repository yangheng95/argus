...
| `specs/new-arch/2026-04-30-instance-bootstrap-darwin-cascade.md` | Remove `process.cwd()` as project-directory fallback; avoid implicit side effects from sidecar CWD. |
| `specs/new-arch/2026-06-11-cwd-project-discovery-and-edit.md` | `Project.discoverFromLaunchDirectory` is the single discovery helper; project-scoped routes still require explicit directory. |
| `specs/new-arch/2026-06-12-editable-cwd-default-launch-directory.md` | Introduced generated default workspace. This is now rejected by the 2026-06-28 audit because it conflicts with no fallback and explicit directory ownership. |
| `specs/new-arch/2026-06-20-workspace-onboarding-path-input-single-source.md` | Onboarding/manual path entry must use the existing `setDirectory` lifecycle, not a parallel directory switch path. |
| `specs/new-arch/2026-06-22-overlay-new-task-directory-ownership.md` | Task directory ownership must fail loud when missing or conflicting; no current-directory fallback. |
