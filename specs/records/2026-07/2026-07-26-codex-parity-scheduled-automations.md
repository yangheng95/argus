...
5. Re-run focused tests after visual changes, inspect the complete diff, commit
   with `dsw-33987`, and push the branch to `myhexin` through normal hooks.
