...
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| `rg -n 'EXPLORER_ROW_HEIGHT           | row.depth \\\* 14                                                                                                                                | file-explorer-row' packages/overlay/src packages/overlay/test specs`                               | Production hits are isolated to `FileExplorerPanel.tsx` and `inspector.css`; tests pin native row button semantics and focus-visible CSS. | Update the single live owner and its existing tests. |
