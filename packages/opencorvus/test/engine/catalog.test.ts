...
describe("engine status catalog", () => {
  test("goal-run catalog centralizes projection and terminal semantics", () => {
    const cases = [
      ["queued", "pending", "pending", true, false, true, false, false, false, false, false],
      ["accepted", "pending", "pending", true, true, true, false, false, false, false, true],
      ["planning", "pending", "pending", true, true, true, false, false, false, false, true],
      ["running", "running", "running", true, true, true, false, false, false, false, true],
      ["evaluating", "running", "running", true, true, true, false, false, false, false, true],
      ["blocked", "running", "running", true, true, true, false, false, false, false, true],
      ["completed", "passed", "completed", false, false, false, true, true, false, false, true],
      ["failed", "failed", "failed", false, false, false, true, false, true, false, false],
      ["aborted", "failed", "aborted", false, false, false, true, false, false, true, false],
    ] as const
    ...
    for (const [
      ...
      expect(isResettableGoalRunStatus(status)).toBe(resettable)
