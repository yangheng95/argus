...
test("ChatBubble uses one unified IM bubble for user and agent cards with restorable folding", () => {
  ...
  expect(CHAT_BUBBLE_TSX).toContain("cardMessageSegments(props.node)")
  expect(CHAT_BUBBLE_TSX).toContain('class="chat-bubble__flow"')
  expect(CHAT_BUBBLE_TSX).toContain('class="chat-bubble__flow-avatar"')
  ...
  expect(CHAT_BUBBLE_CSS).toContain(".chat-bubble__flow")
  expect(CHAT_BUBBLE_CSS).toContain(".chat-bubble__flow-link")
  expect(CHAT_BUBBLE_CSS).toContain(".chat-bubble__flow-avatar")
