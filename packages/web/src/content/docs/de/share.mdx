---
title: Teilen
description: Teile Argus-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Argus-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Argus Folgendes:
...
Argus hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Argus den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`argus.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du argus in deiner Organisation einsetzt.
