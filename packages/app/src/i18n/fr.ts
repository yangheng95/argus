export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans argus.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (argus.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Argus ne supporte pas encore l'authentification MCP.",
