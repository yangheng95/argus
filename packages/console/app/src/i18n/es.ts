...
export const dict = {
  ...
  "notFound.title": "No encontrado | opencorvus",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "opencorvus logo claro",
  "notFound.logoDarkAlt": "opencorvus logo oscuro",
  ...
  "app.meta.description": "OpenCorvus - El agente de codificación de código abierto.",

  "home.title": "OpenCorvus | El agente de codificación IA de código abierto",

  "temp.title": "opencorvus | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "opencorvus zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por opencorvus",
  ...
  "temp.screenshot.caption": "opencorvus TUI con el tema tokyonight",
  "temp.screenshot.alt": "opencorvus TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de opencorvus claro",
  "temp.logoDarkAlt": "logo de opencorvus oscuro",
  ...
  "home.what.title": "¿Qué es OpenCorvus?",
  "home.what.body":
    "OpenCorvus es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, OpenCorvus es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "OpenCorvus no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es OpenCorvus?",
  "home.faq.a1":
    "OpenCorvus es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso OpenCorvus?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar OpenCorvus?",
  "home.faq.a3.p1":
    "No necesariamente, OpenCorvus viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, OpenCorvus también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con OpenCorvus?",
  "home.faq.a4.p1":
    "Sí, OpenCorvus soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar OpenCorvus en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! OpenCorvus ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta OpenCorvus?",
  "home.faq.a6":
    "OpenCorvus es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es OpenCorvus de código abierto?",
  "home.faq.a8.p1": "Sí, OpenCorvus es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que OpenCorvus ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "OpenCorvus Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que OpenCorvus ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es OpenCorvus Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de OpenCorvus.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá OpenCorvus negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, OpenCorvus añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con OpenCorvus, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de OpenCorvus.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con OpenCorvus, puedes usar Zen con cualquier agente.",
  ...
  "black.workspace.title": "OpenCorvus Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a OpenCorvus Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de OpenCorvus Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "OpenCorvus Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con opencorvus cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona opencorvus",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia opencorvus y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de opencorvus.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de opencorvus Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a OpenCorvus Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan OpenCorvus Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan OpenCorvus Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a OpenCorvus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "OpenCorvus Go" como proveedor en tu configuración de opencorvus para usar los modelos Go.',
  "workspace.lite.other.title": "Suscripción Go",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a OpenCorvus Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Go es una suscripción de $10 al mes que proporciona acceso confiable a modelos de codificación abiertos populares con generosos límites de uso.",
  ...
  "download.title": "OpenCorvus | Descargar",
  "download.meta.description": "Descarga OpenCorvus para macOS, Windows y Linux",
  "download.hero.title": "Descargar OpenCorvus",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "OpenCorvus Terminal",
  "download.section.desktop": "OpenCorvus Desktop (Beta)",
  "download.section.extensions": "Extensiones OpenCorvus",
  "download.section.integrations": "Integraciones OpenCorvus",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar OpenCorvus a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", OpenCorvus funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "OpenCorvus es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque OpenCorvus funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en OpenCorvus.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "OpenCorvus | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a OpenCorvus para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "OpenCorvus opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es OpenCorvus Enterprise?",
  "enterprise.faq.a1":
    "OpenCorvus Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con OpenCorvus Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. OpenCorvus por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con OpenCorvus Enterprise?",
  "enterprise.faq.a4":
    "Sí. OpenCorvus no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "OpenCorvus | Marca",
  "brand.meta.description": "Guías de marca de OpenCorvus",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca OpenCorvus.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "OpenCorvus | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de OpenCorvus",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para OpenCorvus",
