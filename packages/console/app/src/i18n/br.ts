...
export const dict = {
  ...
  "notFound.title": "Não encontrado | opencorvus",
  "notFound.heading": "404 - Página não encontrada",
  "notFound.home": "Início",
  "notFound.docs": "Documentação",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo opencorvus claro",
  "notFound.logoDarkAlt": "logo opencorvus escuro",
  ...
  "app.meta.description": "OpenCorvus - O agente de codificação de código aberto.",

  "home.title": "OpenCorvus | O agente de codificação de código aberto com IA",

  "temp.title": "opencorvus | Agente de codificação com IA feito para o terminal",
  ...
  "temp.feature.zen.afterLink": "fornecida pela opencorvus",
  ...
  "temp.screenshot.caption": "OpenCorvus TUI com o tema tokyonight",
  "temp.screenshot.alt": "OpenCorvus TUI com tema tokyonight",
  "temp.logoLightAlt": "logo opencorvus claro",
  "temp.logoDarkAlt": "logo opencorvus escuro",
  ...
  "home.what.title": "O que é OpenCorvus?",
  "home.what.body":
    "OpenCorvus é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, OpenCorvus é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "OpenCorvus não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é OpenCorvus?",
  "home.faq.a1":
    "OpenCorvus é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o OpenCorvus?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o OpenCorvus?",
  "home.faq.a3.p1":
    "Não necessariamente, OpenCorvus vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, OpenCorvus também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o OpenCorvus?",
  "home.faq.a4.p1":
    "Sim, OpenCorvus suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o OpenCorvus apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! OpenCorvus agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o OpenCorvus?",
  "home.faq.a6":
    "OpenCorvus é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "OpenCorvus é código aberto?",
  "home.faq.a8.p1": "Sim, OpenCorvus é totalmente open source. O código-fonte é público no",
  ...
  "zen.faq.q1": "O que é OpenCorvus Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do OpenCorvus.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a OpenCorvus pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a OpenCorvus adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o OpenCorvus, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do OpenCorvus.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o OpenCorvus, você pode usá-lo com qualquer agente.",
  ...
  "black.meta.title": "OpenCorvus Black | Acesse os melhores modelos de codificação do mundo",
  "black.meta.description": "Tenha acesso ao Claude, GPT, Gemini e mais com os planos de assinatura OpenCorvus Black.",
  ...
  "black.title": "OpenCorvus Black | Preços",
  ...
  "black.workspace.title": "OpenCorvus Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar OpenCorvus Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do OpenCorvus Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use o Zen com qualquer agente de codificação e continue usando outros provedores com opencorvus sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione opencorvus",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o opencorvus e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços opencorvus.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do opencorvus Gateway",
  ...
  "workspace.black.subscription.message": "Você assina o OpenCorvus Black por ${{plan}} por mês.",
  ...
  "workspace.lite.subscription.message": "Você assina o OpenCorvus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "OpenCorvus Go" como provedor na sua configuração do opencorvus para usar os modelos Go.',
  "workspace.lite.other.title": "Assinatura Go",
  "workspace.lite.other.message":
    "Outro membro neste workspace já assina o OpenCorvus Go. Apenas um membro por workspace pode assinar.",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "O OpenCorvus Go é uma assinatura de $10 por mês que fornece acesso confiável a modelos abertos de codificação populares com limites de uso generosos.",
  ...
  "download.title": "OpenCorvus | Baixar",
  "download.meta.description": "Baixe o OpenCorvus para macOS, Windows e Linux",
  "download.hero.title": "Baixar OpenCorvus",
  ...
  "download.section.extensions": "Extensões OpenCorvus",
  "download.section.integrations": "Integrações OpenCorvus",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o OpenCorvus a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o OpenCorvus funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O OpenCorvus é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o OpenCorvus funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no OpenCorvus.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "OpenCorvus | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a OpenCorvus para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O OpenCorvus opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é OpenCorvus Enterprise?",
  "enterprise.faq.a1":
    "OpenCorvus Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o OpenCorvus Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O OpenCorvus por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o OpenCorvus Enterprise?",
  "enterprise.faq.a4":
    "Sim. O OpenCorvus não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "OpenCorvus | Marca",
  "brand.meta.description": "Diretrizes da marca OpenCorvus",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca OpenCorvus.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "OpenCorvus | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do OpenCorvus",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no OpenCorvus",
