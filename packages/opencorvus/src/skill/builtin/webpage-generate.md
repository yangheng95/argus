...
- `mirror/generated-visual-source/*`
...
- `frontend_spec` must include a "visual framework handoff" section naming `binding-manifest.json`, generated View components, slot ownership, and the required container/wrapper layer.
