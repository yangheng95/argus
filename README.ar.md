...
nix run nixpkgs#opencode           # او github:yangheng95/argus لاحدث فرع dev
```
...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/yangheng95/argus/releases) او من [opencode.ai/download](https://opencode.ai/download).
