...
O opencorvus suporta variáveis de ambiente de proxy padrão e certificados personalizados para ambientes de rede corporativa.

---

## Proxy

O opencorvus respeita variáveis de ambiente de proxy padrão.
...
Se sua empresa usa CAs personalizadas para conexões HTTPS, configure o opencorvus para confiá-las.
