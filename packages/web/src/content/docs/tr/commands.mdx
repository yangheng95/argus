...
`.opencorvus/commands/test.md` oluştur:
...
opencorvus işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

opencorvus [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/opencorvus/commands/`
- Proje başına: `.opencorvus/commands/`
...
opencorvus, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
