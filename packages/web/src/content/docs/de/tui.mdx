---
title: TUI
description: Arbeite mit OpenCorvus in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenCorvus bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet OpenCorvus die TUI im aktuellen Verzeichnis.
...
In der OpenCorvus-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
You can customize TUI behavior through your OpenCorvus config file.
