export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Argus. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Argus",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Argus CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
