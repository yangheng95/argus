...
| -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| `rg -n -F '.executor-chip-slot .oc-button[data-ui^="executor-chip-"]:hover' packages/overlay/src packages/overlay/test specs` | The executor chip hover emphasis had one live CSS owner.                                    | Extend this owner to `:focus-visible`.                    |
| `rg -n -F '.executor-chip-slot .oc-button[data-ui^="executor-chip-"]:focus' packages/overlay/src packages/overlay/test specs` | No executor chip focus selector existed.                                                    | Add `:focus-visible`, not broad `:focus`.                 |
