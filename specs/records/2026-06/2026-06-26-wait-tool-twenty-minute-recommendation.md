...
- `specs/records/2026-06/orchestrator-no-decision-stop-2026-06-18.md` classifies `wait` as an
  observation/pause tool. It must not become a decision effect and must not be
  used as polling progress.
- `specs/records/2026-06/2026-06-24-read-context-drilldown-only.md` removed
