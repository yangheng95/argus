...
const routes = [
  ...
  { method: "GET", path: "session/:sessionID/panel-settings", description: "Read session-scoped overlay panel settings." },
  { method: "PATCH", path: "session/:sessionID/panel-settings", description: "Update session-scoped overlay panel settings." },
  ...
  { method: "GET", path: "session", description: "List managed sessions." },
  { method: "POST", path: "session", description: "Create a managed session." },
  { method: "GET", path: "session/:sessionID", description: "Read a managed session." },
  { method: "PATCH", path: "session/:sessionID", description: "Update a managed session title or archive status." },
  { method: "DELETE", path: "session/:sessionID", description: "Delete a managed session." },
  { method: "GET", path: "session/:sessionID/export-html", description: "Export a session transcript as HTML." },
