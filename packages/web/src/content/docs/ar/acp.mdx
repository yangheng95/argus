---
title: دعم ACP
description: استخدم Argus في أي محرر متوافق مع ACP.
---

يدعم Argus بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Argus عبر ACP، اضبط محررك ليشغّل الأمر `argus acp`.

يشغّل هذا الأمر Argus كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Argus' من محدد الوكلاء في AI Chat.
...
لاستخدام Argus كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Argus كوكيل ACP للدردشة.
...
يعمل Argus عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Argus
