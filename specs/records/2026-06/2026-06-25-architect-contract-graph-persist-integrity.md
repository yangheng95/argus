...
- `specs/records/2026-06/2026-06-19-goal-fifo-refill-scheduling-impact.md` keeps graph diagnosis and build selection with the orchestrator model; host code may observe durable facts but must not repair the graph by hidden scheduling.
- `specs/records/2026-06/2026-06-21-frontend-design-research-adversarial-repair.md` records that final `submit_architect` validation is the authoritative blocker for unresolved contract ids.
