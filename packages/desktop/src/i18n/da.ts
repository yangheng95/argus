export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Argus er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "Argus Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Argus CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
