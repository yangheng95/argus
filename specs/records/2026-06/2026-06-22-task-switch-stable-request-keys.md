...
| `git diff --check -- packages/overlay/src/components/MemoryPanel.tsx packages/overlay/test/memory-panel-detail-dialog.test.ts packages/overlay/test/project-directory-request-loop.test.ts packages/overlay/test/browser/left-tool-panels-directory-browser.test.ts specs/records/2026-06/2026-06-22-task-switch-stable-request-keys.md` | Pass                                                                                                                                                    |
