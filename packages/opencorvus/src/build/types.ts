...
/**
 * Terminal payload the build agent returns via SessionLoop's StructuredOutput.
 * Orchestrator reads this directly from the tool_result and decides whether to
 * call `deliver`, `build` again with feedback, or stop.
 *
