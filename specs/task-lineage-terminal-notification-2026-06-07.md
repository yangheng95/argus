...
- Superseded on 2026-06-26 by `specs/new-arch/2026-06-26-mission-task-parallel-subtasks.md`: a mission or parent task may create multiple independent child engine tasks. Dependent child work must queue behind its prerequisite instead of starting in parallel.
