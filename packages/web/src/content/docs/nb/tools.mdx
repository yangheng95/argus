...
:::note
Dette verktøyet er bare tilgjengelig når du bruker OpenCorvus-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sann verdi (f.eks. `true` eller `1`).
