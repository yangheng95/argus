...
| ----------------------------------------------------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- |
| `rg -n '<svg\b                                              | </svg>                                                                           | viewBox=' packages/overlay/src packages/overlay/test specs -g '_.ts' -g '_.tsx' -g '\*.md'` | Runtime source outside `Icon.tsx` only had inline SVG in `ConfigDialogHost.tsx` and `Conversation.tsx`; test fixtures still use SVG as external sample data. | Replace runtime SVG with existing Icon names; leave test fixtures out of runtime guard. |
