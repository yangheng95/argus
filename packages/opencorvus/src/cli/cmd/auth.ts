    ...
    await Instance.provide({
      ...
      async fn() {
        ...
        if (provider === "opencorvus") {
          prompts.log.info("Create an api key at https://opencorvus.ai/auth")
        }
        ...
        if (["cloudflare", "cloudflare-ai-gateway"].includes(provider)) {
          prompts.log.info(
            "Cloudflare AI Gateway can be configured with CLOUDFLARE_GATEWAY_ID, CLOUDFLARE_ACCOUNT_ID, and CLOUDFLARE_API_TOKEN environment variables. Read more: https://opencorvus.ai/docs/providers/#cloudflare-ai-gateway",
          )
        }
