...
This directory contains the living OpenCorvus architecture source of truth. Dated investigation notes, migration logs, benchmark records, and task-specific plans live under `specs/records/2026-06/`.
...
| [08-agent-tool-adapter.md](08-agent-tool-adapter.md) | Agent-to-tool include/exclude adaptation protocol. |
...
| [16-unified-teardown.md](16-unified-teardown.md) | Unified teardown toward the Claude Code / Codex minimal model. |
...
5. Run `bun test packages/opencorvus/test/script/historical-docs-links.test.ts` after any spec move, deletion, or new spec path.
