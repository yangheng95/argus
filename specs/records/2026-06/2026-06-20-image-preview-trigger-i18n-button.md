...
| Search                                                | Result                                                                                                                                                         |
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ---------------- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rg "Open image preview                               | imagePreviewTriggerLabel                                                                                                                                       | data-image-preview-trigger | PreviewableImage | msg-image-trigger" packages/overlay/src packages/overlay/test specs` | Live label callers are `ImagePreview.tsx` and `markdown.ts`; delegated click handling reads only `data-image-preview-trigger/src/alt`; tests pin the English helper output and private class. |
