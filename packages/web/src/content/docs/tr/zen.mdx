---
title: Zen
description: argus ekibinin sundugu secili model listesi.
---
...
Argus Zen, argus ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
Argus Zen su anda beta asamasindadir.
:::

Zen, argus'daki diger provider'lar gibi calisir. Argus Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; argus kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
argus ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
Argus Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

Argus Zen, argus'daki diger provider'lar gibi calisir.

1. **<a href={console}>Argus Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, Argus Zen'i secin ve API anahtarinizi yapistirin
...
argus config'inizdeki [model id](/docs/config/#models), `argus/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `argus/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin argus'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin argus'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin argus'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin argus'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
Argus Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve argus'da diger provider'lari her zaman acik tutmak
