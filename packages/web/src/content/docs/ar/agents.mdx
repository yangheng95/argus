...
يوجد نوعان من الوكلاء في OpenCorvus: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي OpenCorvus مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي OpenCorvus مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي OpenCorvus مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `opencorvus.json`:
...
- عام: `~/.config/opencorvus/agents/`
- لكل مشروع: `.opencorvus/agents/`
...
إذا لم يتم تحديد temperature، يستخدم OpenCorvus القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات OpenCorvus العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات OpenCorvus الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenCorvus Zen](/docs/zen)، فستستخدم `opencorvus/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `opencorvus models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/yangheng95/opencorvus).
:::
