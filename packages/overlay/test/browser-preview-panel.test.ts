...
test("browser preview panel uses mature primitives and HostTransport-backed service", () => {
  ...
  expect(component).toContain('from "../services/host-transport"')
  expect(component).toContain("currentTarget()?.viewports")
  expect(component).toContain("visibleViewportIDs")
  expect(component).toContain("viewportByID")
  expect(component).toContain("visibleViewportCount")
  ...
  expect(component).toContain("browser-preview-visibility-toggles")
  expect(component).toContain("browser-preview-viewport-toggle")
  expect(component).toContain("browser_preview.viewport.toggle")
  expect(component).toContain("closeViewport")
  expect(component).toContain("browser-preview-frame-grid")
  expect(component).toContain("browser-preview-frame-header")
  expect(component).toContain("canEmbedPreviewFrame")
  expect(component).toContain('getHostTransport().kind !== "vscode"')
  expect(component).toContain("embeddableFrameUrl")
  expect(component).toContain('data-ui="browser-preview-host-blocked"')
  expect(component).toContain("browser_preview.empty.host_blocked")
  expect(component).toContain('data-ui="browser-preview-frame-close"')
  ...
  expect(component).not.toContain('class="browser-preview-evidence"')
  ...
  expect(css).toContain(".browser-preview-visibility-toggles")
  expect(css).toContain(".browser-preview-viewport-toggle")
  expect(css).toContain(".browser-preview-frame-grid")
  expect(css).toContain(".browser-preview-frame-header")
  expect(css).toContain('.browser-preview-frame-actions .oc-button[data-ui="browser-preview-frame-close"]')
  expect(css).toContain(".browser-preview-frame")
  expect(css).toContain('.browser-preview-empty[data-status="host-blocked"]')
  expect(css).not.toContain(".browser-preview-evidence {")
