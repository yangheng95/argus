...
| ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `rg -n -e "knowledge-search" -e "search-field" -e "memory-search" packages/overlay/src packages/overlay/test specs` | `knowledge-search` only appears in `MemoryPanel.tsx`, `settings.css`, and tests. Shared search-field callers already exist in TaskList, FileExplorer, MissionList, and CodingAssistantSessionList. | Retire `knowledge-search` instead of adapting it.                                                                     |
