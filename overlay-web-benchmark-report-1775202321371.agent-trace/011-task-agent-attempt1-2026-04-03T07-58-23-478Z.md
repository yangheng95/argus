...
- Plan: 2 goals
- Active run: run_d52595fb4001moCIsn1JKP0qKT (running)
...
Executor run run_d52595fb4001moCIsn1JKP0qKT completed.
...
测试目标仍在运行状态，但executor说run已经完成。让我尝试直接执行测试目标。
