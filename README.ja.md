...
nix run nixpkgs#opencode           # または github:yangheng95/argus で最新 dev ブランチ
```
...
OpenCode はデスクトップアプリとしても利用できます。[releases page](https://github.com/yangheng95/argus/releases) から直接ダウンロードするか、[opencode.ai/download](https://opencode.ai/download) を利用してください。
