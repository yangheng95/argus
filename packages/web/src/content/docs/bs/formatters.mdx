---
title: Formateri
description: Argus koristi formatere specifične za jezik.
---

Argus automatski formatira datoteke nakon što su napisane ili uređene pomoću formatera specifičnih za jezik. Ovo osigurava da kod koji se generira prati stilove koda vašeg projekta.

---

## Ugrađeni

Argus dolazi sa nekoliko ugrađenih formatera za popularne jezike i okvire. Ispod je lista formatera, podržanih ekstenzija datoteka i naredbi ili opcija konfiguracije koje su mu potrebne.
...
Dakle, ako vaš projekat ima `prettier` u vašem `package.json`, Argus će ga automatski koristiti.

---

## Kako radi

Kada Argus piše ili uređuje datoteku, on:
...
Možete prilagoditi formatere kroz `formatter` odjeljak u vašoj Argus konfiguraciji.
