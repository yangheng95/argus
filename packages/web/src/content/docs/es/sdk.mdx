---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor opencorvus.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/v2/gen/types.gen.ts`

El SDK opencorvus JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar opencorvus mediante programación.
...
Cree una instancia de opencorvus:
...
| `port`     | `number`      | Puerto del servidor                             | `7878`         |
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `opencorvus.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de opencorvus, puede crear una instancia de cliente para conectarse a ella:
...
| Opción          | Tipo       | Descripción                                  | Predeterminado          |
| --------------- | ---------- | -------------------------------------------- | ----------------------- |
| `baseUrl`       | `string`   | URL del servidor                             | `http://localhost:7878` |
