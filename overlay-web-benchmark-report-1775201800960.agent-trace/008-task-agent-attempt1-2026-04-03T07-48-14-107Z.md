...
- Plan: 2 goals
- Active run: run_d52501db9001KnIbFmYCJHpfpM (running)
- Budget: 3/20 runs, 0/8 fixes
...
Executor run run_d52501db9001KnIbFmYCJHpfpM completed.
...
测试目标仍在运行状态，但没有交付物。让我尝试创建一个新的运行来执行这个目标。
