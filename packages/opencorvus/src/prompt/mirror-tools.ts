...
export function buildMirrorToolsPromptSection(opts: { cwd: string }): string {
  ...
  const teaching = [
    ...
    "  6. `webpage_evaluate` (reference.png, rendered.png) → numeric score, threshold 85/100, and verdict",
    "  7. `webpage_vision_judge` (reference.png, rendered.png) → qualitative acceptance verdict",
