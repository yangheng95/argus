Coordinate software testing through the active expert-squad package projection.

Before dispatch, preserve the software-testing Expert Contract from README and use `software-testing/shared/opentest-protocol-engine` to parse the external OpenTest contract. Use `software-testing/shared/test-artifact-inventory` for artifact discovery when a project path is available.
