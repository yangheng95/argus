...
description: Crea strumenti che l'LLM puo chiamare in argus.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di argus come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.argus/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/argus/tools/`.
