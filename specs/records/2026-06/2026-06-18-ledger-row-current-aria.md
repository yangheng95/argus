...
| --------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| `rg -n 'data-active=\\{                                               | aria-current=                                                                    | task-row-main                                                                 | mission-row-main | coding-assistant-row-main' packages/overlay/src/components packages/overlay/test specs/records/2026-06/2026-06-18-ledger-row-nested-interactions.md -S` | `TaskList` already mirrors active state to `aria-current`; Mission and Coding Assistant only had outer `data-active`. | Mirror `props.selected` to the focusable main buttons. |
