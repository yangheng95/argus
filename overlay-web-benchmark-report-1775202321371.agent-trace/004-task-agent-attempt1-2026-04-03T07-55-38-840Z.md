...
- Plan: 2 goals
- Active run: run_d524e93bf001mAMvnn7z0u7x52 (running)
...
Executor run run_d524e93bf001mAMvnn7z0u7x52 completed.
...
测试目标仍在运行状态，但执行器说已经完成。让我重新创建运行并提交执行，以便同时执行两个目标。
