...
| Git baseline | Clean `work-v0.0.9beta-yr-0718` at `201907f89`, equal to `myhexin/work-v0.0.9beta-yr-0718` after fetch. |
...
6. Run document health, exact call-site/diff review, fetch the latest git-cc
