...
| `specs/new-arch/01-agents.md` and `13-agent-communication-matrix.md`   | Update architecture wording that previously required confirmation before task creation.                                             |
