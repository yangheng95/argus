...
test("ConversationAgentRail stays a fixed narrow left rail inside the message pane", () => {
  ...
  expect(css).toContain(".conversation-body:has(.conversation-agent-rail-host:not(:empty))::after")
  expect(css).toContain("width: var(--conversation-agent-rail-width);")
...
test("ConversationAgentRail keeps stack and row DOM stable across workflow refreshes", () => {
  ...
  expect(css).toContain(".conversation-agent-rail__stack")
  expect(css).toContain("grid-auto-rows: var(--conversation-agent-rail-tick-height)")
  expect(css).toContain("gap: var(--conversation-agent-rail-tick-gap)")
})
