...
Language Server Protocol (LSP), FileWatcher, Version Control System (VCS),
...
Language Server Protocol (LSP), FileWatcher, interactive Version Control System
...
Reusing service owners does not require starting Language Server Protocol
(LSP), FileWatcher, interactive Version Control System (VCS), every sandbox, or
