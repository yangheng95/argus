...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Hexin budget route  | `packages/opencorvus/src/server/routes/provider.ts` owns `GET /provider/hexin/budget`. `specs/records/2026-06/bug-hunt-2026-06-17.md` BH-005 reports upstream error body can echo secrets.                              | Keep one route. Tighten response schema and redact upstream error bodies; never return provider bearer text.                                            |
