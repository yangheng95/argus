...
export const dict = {
  ...
  "notFound.title": "見つかりません | OpenCorvus",
  "notFound.heading": "404 - ページが見つかりません",
  "notFound.home": "ホーム",
  "notFound.docs": "ドキュメント",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "opencorvusのロゴ（ライト）",
  "notFound.logoDarkAlt": "opencorvusのロゴ（ダーク）",
  ...
  "app.meta.description": "OpenCorvus - オープンソースのコーディングエージェント。",

  "home.title": "OpenCorvus | オープンソースのAIコーディングエージェント",

  "temp.title": "OpenCorvus | ターミナル向けに構築されたAIコーディングエージェント",
  ...
  "temp.feature.zen.beforeLink": "OpenCorvusが提供する",
  ...
  "temp.screenshot.caption": "tokyonight テーマを使用した OpenCorvus TUI",
  "temp.screenshot.alt": "tokyonight テーマの OpenCorvus TUI",
  "temp.logoLightAlt": "opencorvusのロゴ（ライト）",
  "temp.logoDarkAlt": "opencorvusのロゴ（ダーク）",
  ...
  "home.what.title": "OpenCorvusとは？",
  "home.what.body":
    "OpenCorvusは、ターミナル、IDE、またはデスクトップでのコード作成を支援するオープンソースのエージェントです。",
  ...
  "home.privacy.body":
    "OpenCorvusはコードやコンテキストデータを一切保存しないため、プライバシーが重視される環境でも利用できます。",
  "home.privacy.learnMore": "詳しくは",
  "home.privacy.link": "プライバシー",

  "home.faq.q1": "OpenCorvusとは？",
  "home.faq.a1":
    "OpenCorvusは、任意のAIモデルでコードの作成・実行を支援するオープンソースのエージェントです。ターミナルベースのインターフェース、デスクトップアプリ、IDE拡張として利用できます。",
  "home.faq.q2": "OpenCorvusの使い方は？",
  "home.faq.a2.before": "最も簡単な始め方は",
  "home.faq.a2.link": "イントロを読む",
  "home.faq.q3": "OpenCorvusには追加のAIサブスクリプションが必要ですか？",
  "home.faq.a3.p1": "必ずしも必要ではありません。OpenCorvusには、アカウント不要で使える無料モデルが含まれています。",
  "home.faq.a3.p2.beforeZen": "これらに加えて、",
  "home.faq.a3.p2.afterZen": " アカウントを作成することで、人気のコーディングモデルを利用できます。",
  "home.faq.a3.p3":
    "Zenの利用を推奨していますが、OpenCorvusはOpenAI、Anthropic、xAIなどの主要プロバイダーにも対応しています。",
  "home.faq.a3.p4.beforeLocal": "さらに、",
  "home.faq.a3.p4.localLink": "ローカルモデル",
  "home.faq.q4": "既存のAIサブスクリプションをOpenCorvusで使えますか？",
  "home.faq.a4.p1":
    "はい、OpenCorvusは主要プロバイダーのサブスクリプションプランに対応しています。Claude Pro/Max、ChatGPT Plus/Pro、GitHub Copilotのサブスクリプションを利用できます。",
  "home.faq.q5": "ターミナルだけで使えますか？",
  "home.faq.a5.beforeDesktop": "もう違います！OpenCorvusは今は",
  "home.faq.a5.desktop": "デスクトップ",
  "home.faq.a5.and": "と",
  "home.faq.a5.web": "ウェブ",
  "home.faq.q6": "OpenCorvusの価格は？",
  "home.faq.a6":
    "OpenCorvusは100%無料で使えます。無料モデルも含まれています。他のプロバイダーに接続する場合は追加費用が発生することがあります。",
  ...
  "home.faq.q8": "OpenCorvusはオープンソースですか？",
  "home.faq.a8.p1": "はい、OpenCorvusは完全にオープンソースです。ソースコードは",
  "home.faq.a8.p2": "の",
  ...
  "home.zenCta.body":
    "Zenは、OpenCorvusがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",
  "home.zenCta.link": "Zenについて知る",

  "zen.title": "OpenCorvus Zen | コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.title": "コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.body":
    "Zenは、OpenCorvusがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",

  "zen.faq.q1": "OpenCorvus Zenとは？",
  "zen.faq.a1":
    "Zenは、OpenCorvusのチームが作成した、コーディングエージェント向けにテスト・ベンチマークされたAIモデルの厳選セットです。",
  ...
  "zen.faq.a3":
    "Zenは営利目的ではありません。Zenはモデル提供元のコストをそのままあなたに渡します。Zenの利用が増えるほど、OpenCorvusはより良いレートを交渉し、その分をあなたに還元できます。",
  "zen.faq.q4": "Zenの料金は？",
  ...
  "zen.faq.a4.p3": "コストを賄うために、OpenCorvusは$20の残高チャージあたり$1.23の小さな決済手数料のみを追加します。",
  ...
  "zen.faq.a8":
    "ZenはOpenCorvusとの相性が良いですが、どのエージェントでもZenを利用できます。お使いのコーディングエージェントのセットアップ手順に従ってください。",
  ...
  "zen.problem.subtitle": "OpenCorvusユーザーだけでなく、すべての人を対象にこの問題を修正しています。",
  ...
  "zen.how.body": "ZenをOpenCorvusとともに使用することをお勧めしますが、Zenはどのエージェントでも使用できます。",
  ...
  "black.meta.title": "OpenCorvus Black | 世界最高峰のコーディングモデルすべてにアクセス",
  "black.meta.description": "OpenCorvus Black サブスクリプションプランで、Claude、GPT、Gemini などにアクセス。",
  "black.hero.title": "世界最高峰のコーディングモデルすべてにアクセス",
  "black.hero.subtitle": "Claude、GPT、Gemini などを含む",
  "black.title": "OpenCorvus Black | 料金",
  ...
  "black.workspace.title": "OpenCorvus Black | ワークスペースの選択",
  "black.workspace.selectPlan": "このプランのワークスペースを選択してください",
  "black.workspace.name": "ワークスペース {{n}}",
  "black.subscribe.title": "OpenCorvus Black を購読する",
  ...
  "black.subscribe.success.title": "OpenCorvus Black ウェイトリストに登録されました",
  ...
  "workspace.newUser.feature.lockin.body":
    "任意のコーディングエージェントでZenを使用でき、必要に応じていつでもOpenCorvusを備えた他のプロバイダーを使用し続けることができます。",
  ...
  "workspace.newUser.step.login.after": "してOpenCorvusを選択",
  "workspace.newUser.step.pasteKey": "APIキーを貼り付け",
  "workspace.newUser.step.models.before": "OpenCorvusを起動し実行",
  ...
  "workspace.keys.subtitle": "OpenCorvusサービスにアクセスするためのAPIキーを管理します。",
  "workspace.keys.create": "APIキーの作成",
  "workspace.keys.placeholder": "キー名を入力してください",
  "workspace.keys.empty": "OpenCorvusゲートウェイAPIキーを作成する",
  ...
  "workspace.black.subscription.message": "あなたは OpenCorvus Black を月額 ${{plan}} で購読しています。",
  ...
  "workspace.black.waitlist.joined":
    "あなたは月額 ${{plan}} の OpenCorvus Black プランのウェイトリストに登録されています。",
  "workspace.black.waitlist.ready": "月額 ${{plan}} の OpenCorvus Black プランに登録する準備ができました。",
  ...
  "workspace.lite.subscription.message": "あなたは OpenCorvus Go を購読しています。",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、opencorvus の設定で「OpenCorvus Go」をプロバイダーとして選択してください。",
  "workspace.lite.other.title": "Goサブスクリプション",
  "workspace.lite.other.message":
    "このワークスペースの別のメンバーが既に OpenCorvus Go を購読しています。ワークスペースにつき1人のメンバーのみが購読できます。",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Goは月額$10のサブスクリプションプランで、人気のオープンコーディングモデルへの安定したアクセスを十分な利用枠で提供します。",
  ...
  "download.title": "OpenCorvus | ダウンロード",
  "download.meta.description": "OpenCorvus を macOS、Windows、Linux 向けにダウンロード",
  "download.hero.title": "OpenCorvus をダウンロード",
  ...
  "download.faq.a3.beforeLocal":
    "必ずしもそうではありませんが、おそらく必要です。OpenCorvusを有料プロバイダーに接続したい場合はAIサブスクリプションが必要ですが、",
  "download.faq.a3.localLink": "ローカルモデル",
  "download.faq.a3.afterLocal.beforeZen": "であれば無料で利用できます。ユーザーには",
  "download.faq.a3.afterZen":
    "の利用をお勧めしていますが、OpenCorvusはOpenAI、Anthropic、xAIなどの主要なプロバイダーに対応しています。",

  "download.faq.a5.p1": "OpenCorvusは100%無料で利用できます。",
  "download.faq.a5.p2.beforeZen":
    "追加コストはモデルプロバイダーのサブスクリプションから発生します。OpenCorvusはどのモデルプロバイダーでも利用できますが、",
  "download.faq.a5.p2.afterZen": "の利用をおすすめします。",

  "download.faq.a6.p1": "あなたのデータと情報は、OpenCorvusで共有リンクを作成したときにのみ保存されます。",
  "download.faq.a6.p2.beforeShare": "詳しくは",
  "download.faq.a6.shareLink": "共有ページ",

  "enterprise.title": "OpenCorvus | 組織向けエンタープライズソリューション",
  "enterprise.meta.description": "エンタープライズソリューションについてOpenCorvusに問い合わせる",
  "enterprise.hero.title": "あなたのコードはあなたのもの",
  "enterprise.hero.body1":
    "OpenCorvusは、データやコンテキストを一切保存せず、ライセンス制限や所有権の主張もなく、組織内で安全に動作します。チームでのトライアルから始め、SSOや社内AIゲートウェイと統合して組織全体に展開できます。",
  ...
  "enterprise.faq.q1": "OpenCorvus Enterpriseとは？",
  "enterprise.faq.a1":
    "OpenCorvus Enterpriseは、コードとデータが決してインフラの外に出ないことを保証したい組織向けです。SSOや社内AIゲートウェイと統合する集中設定を使用することでこれを実現します。",
  "enterprise.faq.q2": "OpenCorvus Enterpriseを始めるには？",
  "enterprise.faq.a2":
    "まずはチームでの社内トライアルから始めてください。OpenCorvusはデフォルトでコードやコンテキストデータを保存しないため、簡単に始められます。その後、価格や導入オプションについてお問い合わせください。",
  ...
  "enterprise.faq.q4": "OpenCorvus Enterpriseでデータは安全ですか？",
  "enterprise.faq.a4":
    "はい。OpenCorvusはコードやコンテキストデータを保存しません。すべての処理はローカル、またはAIプロバイダーへの直接API呼び出しを通じて行われます。集中設定とSSO統合により、データは組織のインフラ内で安全に保たれます。",

  "brand.title": "OpenCorvus | ブランド",
  "brand.meta.description": "OpenCorvus ブランドガイドライン",
  "brand.heading": "ブランドガイドライン",
  "brand.subtitle": "OpenCorvusブランドを扱うためのリソースと素材です。",
  "brand.downloadAll": "すべての素材をダウンロード",

  "changelog.title": "OpenCorvus | 変更履歴",
  "changelog.meta.description": "OpenCorvus リリースノートと変更履歴",
  "changelog.hero.title": "変更履歴",
  "changelog.hero.subtitle": "OpenCorvusの新しいアップデートと改善",
