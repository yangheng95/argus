      ...
      execute: async (params) => {
        ...
        return {
          ...
          output: [
            ...
            "Before writing files for another region, render the target project for this region, compare it against the reference pixels, repair visible mismatches in this same region, then record this region's replacement result and call record_frontend_region_selection for the next region.",
          ].filter(Boolean).join("\n"),
