...
| Historical launcher contract | `specs/records/2026-06/2026-06-16-left-activity-composer-binding.md` says New Task should select the Tasks left activity and center panel. | Reuse that contract; do not add a parallel New Task panel or hidden message path.                       |
