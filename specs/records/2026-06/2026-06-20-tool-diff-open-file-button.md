...
| --------------------------------------------------------- | ------------------------------------------------------------------- | ---------------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `rg -n "msg-tool-diff-link                                | InlineToolPart                                                      | tool-diff                                                        | data-file-path | openPathInSelectedEditor" packages/overlay/src packages/overlay/test specs` | `.msg-tool-diff-link` has one production owner in `InlineToolPart` and one hover-only CSS rule in `messages.css`. | Replace this structured tool opener with `Button`; keep markdown `file-link` unchanged. |
