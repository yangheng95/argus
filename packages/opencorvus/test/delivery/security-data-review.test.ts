...
import { runSecurityDataReview } from "../../src/delivery/specialists/security-data"
...
describe("delivery security and data specialist review", () => {
  test("security review is absent when security surface is not selected", async () => {
    const review = await runSecurityDataReview({
      ...
      deliveryID: "dlv_security_absent",
  ...
  test("security review requires dependency or file evidence", async () => {
    const review = await runSecurityDataReview({
      ...
      deliveryID: "dlv_security_missing",
      projectRoot: process.cwd(),
  ...
  test("security review flags hardcoded secret-like assignments", async () => {
    ...
    const review = await runSecurityDataReview({
      ...
      deliveryID: "dlv_security_secret",
      projectRoot: dir,
  ...
  test("security review flags unsafe upload paths", async () => {
    ...
    const review = await runSecurityDataReview({
      ...
      deliveryID: "dlv_security_upload",
      projectRoot: dir,
  ...
  test("security review flags unconditional destructive data operations", async () => {
    ...
    const review = await runSecurityDataReview({
      ...
      deliveryID: "dlv_security_delete",
      projectRoot: dir,
...
function manifest(
  ...
  return {
    ...
    deliveryId: "dlv_surface_security",
    projectRoot: process.cwd(),
    surfaces,
