...
| `packages/web/src/content/docs/{permissions,zh-cn/permissions}.mdx` | Default-allow documentation only mentioned built-in agent tools.                                                                                                    | Document browser MCP default allow.                                               |
| `deleted pre-June record 2026-05-29-browser-mcp-runtime`                  | Historical draft still said browser MCP sensitive categories ask by default.                                                                                        | Update the permission policy section to the current default-allow decision.       |
