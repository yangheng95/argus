...
function buildUserPrompt(
  ...
  // Full spec content — the goal agent must see every detail to avoid requirement loss.
  // Summary alone causes systematic omissions of acceptance criteria and edge cases.
  if (input.spec.content) {
    sections.push(`# Spec (Full)\n\n${input.spec.content}`)
  } else if (input.spec.summary) {
