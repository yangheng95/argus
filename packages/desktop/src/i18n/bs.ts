export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Argus-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Argus-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "Argus Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Argus CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
