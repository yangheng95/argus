    ...
    goalWorkflows: [
      {
        ...
        goalObjective: "Keep the goal header, objective text, and status icon readable in the right inspector.",
        goalStatus: "running",
        orderIndex: 0,
        retryCount: 1,
        priority: "blocking",
        ...
        acceptanceSpecs: [
          {
            id: "a11y-spec",
            title: "Keyboard path",
            scorers: [{ type: "heuristic", spec: { kind: "shell", cmd: "bun test packages/overlay/test/a11y.test.ts" } }],
          },
        ],
