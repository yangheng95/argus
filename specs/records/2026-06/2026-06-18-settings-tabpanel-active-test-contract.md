...
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `rg -n 'class="config-tab-panel active"                                                            | \.config-tab-panel\.active' packages/overlay/src packages/overlay/test specs` | Production and static tests reject the old class; only historical text mentions it positively. | Keep production unchanged and update the stale historical acceptance wording.                   |
