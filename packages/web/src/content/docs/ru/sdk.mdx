---
title: SDK
description: Типобезопасный JS-клиент для сервера opencorvus.
---
...
Вы можете передать объект конфигурации для настройки поведения. Экземпляр по-прежнему получает ваш `opencorvus.json`, но вы можете переопределить или добавить встроенную конфигурацию:
...
Если у вас уже есть работающий экземпляр opencorvus, вы можете создать экземпляр клиента для подключения к нему:
