...
function renderWebCloneSourceOverlay(): string {
  return [
    ...
    "- Do not copy `web-clone-source/`, `frontend-design-skeleton/`, `webpage-evidence/`, legacy `mirror/`, `references/`, or top-level `reference.png` into the acceptance root as deliverables. Reference images and source packages are verification/evidence inputs, not app-owned source.",
