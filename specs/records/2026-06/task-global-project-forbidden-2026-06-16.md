...
> `specs/records/2026-06/remove-global-project-sentinel-2026-06-16.md`: project discovery must
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `deleted pre-June record 2026-04-30-instance-bootstrap-darwin-cascade`       | Task creation in a non-Git directory throws `WorktreeNotGitError`; no hidden `git init`.             | Task creation must require a concrete Git project.                       |
| `specs/records/2026-06/2026-06-12-overlay-init-git-412-retry.md`              | Overlay handles `412 WorktreeNotGitError`, calls `POST /project/current/init-git`, and retries once. | Recovery is explicit before task persistence, not after task corruption. |
