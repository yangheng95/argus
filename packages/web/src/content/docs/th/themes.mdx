...
ด้วย OpenCorvus คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น OpenCorvus จะใช้ธีม `opencorvus` ของเราเอง
...
OpenCorvus มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ OpenCorvus ตรงกับรูปลักษณ์ของ terminal
...
OpenCorvus รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/opencorvus/themes/*.json` หรือ `$XDG_CONFIG_HOME/opencorvus/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.opencorvus/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.opencorvus/themes/*.json`
