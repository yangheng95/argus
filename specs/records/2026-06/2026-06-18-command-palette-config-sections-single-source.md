...
| -------------------------- | ------------- | ----------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `rg -n "CONFIG_SECTIONS    | SETTINGS_TABS | data-config-panel       | openConfigDialog                                                        | setActiveSection                                                                                                                                 | activeSection" packages/overlay/src packages/overlay/test specs`                    | `CONFIG_SECTIONS` is consumed by `ConfigDialogHost`, `services/dialog.ts`, and `TitlebarMenubar`; `CommandPalette` is the only `SETTINGS_TABS` owner. | Delete `SETTINGS_TABS` and consume `CONFIG_SECTIONS` in `CommandPalette`. |
