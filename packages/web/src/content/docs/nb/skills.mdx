...
Agentferdigheter lar OpenCorvus oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går opencorvus opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
opencorvus viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `opencorvus.json`:
