export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Argus.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Argus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Argus.",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (argus.json) udbyder/modelnavne",
  ...
  "settings.general.row.theme.description": "Tilpas hvordan Argus er temabestemt.",
