...
Mit Argus kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Argus das `argus`-Theme.
...
Argus liefert mehrere eingebaute Themes mit.
...
- Argus optisch ans Terminal anpassen wollen
...
Argus unterstuetzt ein flexibles JSON-basiertes Theme-System.
