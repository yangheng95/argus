...
OpenCorvus มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
OpenCorvus มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
OpenCorvus มี subagent ในตัวได้แก่ **General** และ **Explore**

---

## บิวท์อิน

OpenCorvus มาพร้อมกับเอเจนต์หลักและ subagent ในตัวดังนี้
...
กำหนดค่าเอเจนต์ในไฟล์ `opencorvus.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/opencorvus/agents/`
- ระดับโปรเจ็กต์: `.opencorvus/agents/`
...
หมายเหตุ: OpenCorvus ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ OpenCorvus
:::
...
:::tip
ใช้ `opencorvus models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/yangheng95/opencorvus)
:::
