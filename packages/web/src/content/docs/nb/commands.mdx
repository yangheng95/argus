...
Opprett `.opencorvus/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenCorvus-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenCorvus [config](/docs/config):
...
- Per prosjekt: `.opencorvus/commands/`
...
OpenCorvus inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
