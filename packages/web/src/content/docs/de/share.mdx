---
title: Teilen
description: Teile OpenCorvus-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenCorvus-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenCorvus Folgendes:
...
OpenCorvus hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenCorvus den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`opencorvus.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du opencorvus in deiner Organisation einsetzt.
