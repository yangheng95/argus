export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Argus foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Argus",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Argus está ausente. Tente reinstalar o aplicativo de desktop.",
