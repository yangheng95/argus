...
| Git baseline          | Branch `work-v0.0.24beta-yr-0729` initially matched `legacy-remote/work-v0.0.24beta-yr-0729` at `2d4ccae450`. Unrelated in-progress changes exist in Conversation Goal badge production files, its architecture chapter, and its record; they are outside this task and must remain untouched.                                                                                                                                                                                                                                                                                                                                                                                             |
