...
| ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| `rg -n "PromptCatalog                                        | prompt-profile                                                                                            | textarea                                                                    | aria-label                                                                                                      | aria-labelledby                                                                               | prompt-profile-textarea                  | prompt-profile-target" packages/overlay/src/components/settings/PromptCatalog.tsx packages/overlay/test packages/overlay/src specs` | The only prompt profile overlay textareas are in `PromptCatalog.tsx`; they have visible `.prompt-profile-target-copy strong` titles but no accessible relation. | Fix `PromptCatalog.tsx`. |
