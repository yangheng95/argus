...
สร้าง `.opencorvus/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenCorvus:
...
- ระดับผู้ใช้ (Global): `~/.config/opencorvus/commands/`
- ระดับโปรเจ็กต์: `.opencorvus/commands/`
...
OpenCorvus มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
