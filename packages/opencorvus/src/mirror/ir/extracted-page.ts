/**
 * URL `ExtractedPage` IR — the boundary contract between `url/extract`,
 * `url/compile`, and `url/pattern`.
 *
 * Shape mirrors `mirror/src/types.ts::ExtractedPage` verbatim so downstream
 * pattern/contract/scaffold algorithms drop in without a remap layer.
 */
