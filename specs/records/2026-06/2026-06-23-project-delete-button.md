...
| `deleted pre-June record 2026-05-13-close-project-option`                         | Close Project only clears selection/UI and explicitly does not delete files, tasks, or database rows. Project delete must be a separate action.                                      |
| `specs/records/2026-06/2026-06-12-deleted-project-task-record-routes.md`           | `DELETE /task/:taskID` is record-level and must keep working without project directory bootstrap. Do not change task route policy for project delete.                                |
| `specs/records/2026-06/2026-06-22-delete-active-task-record-context.md`            | Active task deletion must cancel/settle real live state before deleting rows; project delete must reuse that service for each task instead of raw cascade deletion.                  |
| `specs/records/2026-06/2026-06-18-project-ledger-group-primitive.md`               | `ProjectLedgerGroup` is the shared project group owner. Header controls must use `Button` primitives.                                                                                |
| `specs/records/2026-06/2026-06-19-project-ledger-group-toggle-button-primitive.md` | The disclosure toggle remains `data-ui="project-group-toggle"` and must not be replaced by custom clickable markup.                                                                  |
| `specs/records/2026-06/2026-06-19-project-ledger-group-disclosure-controls.md`     | The body id and `aria-controls` relationship belong to `ProjectLedgerGroup`; adding project delete must not break disclosure semantics.                                              |
| `specs/records/2026-06/2026-06-23-task-list-row-directory-selection.md`            | Task list project groups are keyed by task directory, and task selection receives the directory explicitly. Project delete should target the group directory, not the selected task. |
