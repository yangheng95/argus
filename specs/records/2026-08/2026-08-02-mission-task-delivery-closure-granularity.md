...
| Current repository state | Branch `v0.0.28beta`, initial HEAD `ed3c5be65afef0e79209c0597dabc6266d719931`, clean worktree at investigation start. Remote delivery target is `myhexin/v0.0.28beta`; new commit subject must start with `dsw-33987`. |
...
6. Commit only task-owned paths with a `dsw-33987` subject, push to `myhexin/v0.0.28beta`, and verify remote containment.
