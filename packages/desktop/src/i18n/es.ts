export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Argus. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Argus",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Argus. Intenta reinstalar la aplicación de escritorio.",
