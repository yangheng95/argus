...
| `specs/records/2026-06/task-lineage-terminal-notification-2026-06-07.md`                   | Historical plan says mission/parent task may create only one new task at a time.            | Mark that creation restriction superseded by dependency-aware parallelism while preserving terminal notification lineage.                                                                           |
