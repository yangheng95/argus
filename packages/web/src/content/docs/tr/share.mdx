---
title: Paylasim
description: argus konusmalarini genel baglantilarla paylasin.
---

argus'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda argus:
...
argus, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak argus manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `argus.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda argus kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
