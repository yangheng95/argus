...
export const dict = {
  ...
  "notFound.title": "غير موجود | argus",
  "notFound.heading": "404 - الصفحة غير موجودة",
  "notFound.home": "الرئيسية",
  "notFound.docs": "الوثائق",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "شعار argus الفاتح",
  "notFound.logoDarkAlt": "شعار argus الداكن",
  ...
  "app.meta.description": "Argus - وكيل البرمجة مفتوح المصدر.",

  "home.title": "Argus | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",

  "temp.title": "argus | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من argus",
  "temp.feature.models.beforeLink": "يدعم أكثر من 75 مزود LLM من خلال",
  "temp.feature.models.afterLink": "، بما في ذلك النماذج المحلية",
  "temp.screenshot.caption": "واجهة Argus الطرفية مع سمة tokyonight",
  "temp.screenshot.alt": "واجهة Argus الطرفية بسمة tokyonight",
  "temp.logoLightAlt": "شعار argus الفاتح",
  "temp.logoDarkAlt": "شعار argus الداكن",
  ...
  "home.what.title": "ما هو Argus؟",
  "home.what.body": "Argus وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم Argus ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن Argus أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو Argus؟",
  "home.faq.a1":
    "Argus وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم Argus؟",
  "home.faq.a2.before": "أسهل طريقة للبدء هي قراءة",
  "home.faq.a2.link": "المقدمة",
  "home.faq.q3": "هل أحتاج لاشتراكات ذكاء اصطناعي إضافية لاستخدام Argus؟",
  "home.faq.a3.p1":
    "ليس بالضرورة، فـ Argus يأتي مع مجموعة من النماذج المجانية التي تستطيع استخدامها دون إنشاء حساب.",
  "home.faq.a3.p2.beforeZen": "وبخلاف ذلك، يمكنك استخدام أي من نماذج البرمجة الشائعة بإنشاء حساب",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "مع أننا نشجّع المستخدمين على استخدام Zen، فإن Argus يعمل أيضًا مع كل المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",
  "home.faq.a3.p4.beforeLocal": "ويمكنك أيضًا ربط",
  "home.faq.a3.p4.localLink": "النماذج المحلية",
  "home.faq.q4": "هل يمكنني استخدام اشتراكاتي الحالية مع Argus؟",
  "home.faq.a4.p1":
    "نعم، يدعم Argus خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام Argus في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! Argus متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة Argus؟",
  "home.faq.a6":
    "Argus مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل Argus مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، Argus مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "home.zenCta.body":
    "يمنحك Zen الوصول إلى مجموعة مختارة بعناية من نماذج الذكاء الاصطناعي التي اختبرها Argus وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة بين المزودين، استخدم نماذج محققة تعمل بكفاءة.",
  "home.zenCta.link": "تعرف على Zen",

  "zen.title": "Argus Zen | مجموعة منسقة من النماذج المحسنة والموثوقة لوكلاء البرمجة",
  "zen.hero.title": "نماذج محسنة وموثوقة لوكلاء البرمجة",
  "zen.hero.body":
    "يمنحك Zen الوصول إلى مجموعة منسقة من نماذج الذكاء الاصطناعي التي اختبرها Argus وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة، استخدم نماذج محققة تعمل بكفاءة.",

  "zen.faq.q1": "ما هو Argus Zen؟",
  "zen.faq.a1":
    "Zen هو مجموعة منسقة من نماذج الذكاء الاصطناعي التي تم اختبارها وقياس أدائها لوكلاء البرمجة، أنشأها الفريق المطور لـ Argus.",
  ...
  "zen.faq.a3":
    "Zen ليس للربح. يمرر Zen التكاليف من مزودي النماذج إليك مباشرة. كلما زاد استخدام Zen، تمكن Argus من التفاوض على أسعار أفضل وتمريرها إليك.",
  ...
  "zen.faq.a4.p3":
    "لتغطية التكاليف، يضيف Argus فقط رسومًا صغيرة لمعالجة الدفع قدرها 1.23 دولار لكل إعادة شحن رصيد بقيمة 20 دولارًا.",
  ...
  "zen.faq.a8":
    "بينما يعمل Zen بشكل رائع مع Argus، يمكنك استخدام Zen مع أي وكيل. اتبع تعليمات الإعداد في وكيل البرمجة المفضل لديك.",
  ...
  "zen.problem.subtitle": "نحن نعمل على إصلاح هذا للجميع، وليس فقط لمستخدمي Argus.",
  ...
  "zen.how.body": "بينما نقترح عليك استخدام Zen مع Argus، يمكنك استخدام Zen مع أي وكيل.",
  ...
  "black.meta.title": "Argus Black | الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.meta.description": "احصل على وصول إلى Claude، GPT، Gemini والمزيد مع خطط اشتراك Argus Black.",
  "black.hero.title": "الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.hero.subtitle": "بما في ذلك Claude، GPT، Gemini والمزيد",
  "black.title": "Argus Black | الأسعار",
  ...
  "black.workspace.title": "Argus Black | اختر مساحة العمل",
  "black.workspace.selectPlan": "اختر مساحة عمل لهذه الخطة",
  "black.workspace.name": "مساحة العمل {{n}}",
  "black.subscribe.title": "اشترك في Argus Black",
  ...
  "black.subscribe.success.title": "أنت في قائمة انتظار Argus Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع argus وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر argus",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ argus ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات argus.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة argus",
  ...
  "workspace.black.subscription.message": "أنت مشترك في Argus Black مقابل ${{plan}} شهريًا.",
  ...
  "workspace.black.waitlist.joined": "أنت في قائمة الانتظار لخطة Argus Black بقيمة ${{plan}} شهريًا.",
  "workspace.black.waitlist.ready": "نحن مستعدون لتسجيلك في خطة Argus Black بقيمة ${{plan}} شهريًا.",
  ...
  "workspace.lite.subscription.message": "أنت مشترك في Argus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'اختر "Argus Go" كمزود في إعدادات argus الخاصة بك لاستخدام نماذج Go.',
  "workspace.lite.other.title": "اشتراك Go",
  "workspace.lite.other.message":
    "عضو آخر في مساحة العمل هذه مشترك بالفعل في Argus Go. يمكن لعضو واحد فقط لكل مساحة عمل الاشتراك.",
  "workspace.lite.promo.title": "Argus Go",
  "workspace.lite.promo.description":
    "Argus Go هو اشتراك بسعر $10 شهريًا يوفر وصولاً موثوقًا إلى نماذج البرمجة المفتوحة الشائعة مع حدود استخدام سخية.",
  ...
  "download.title": "Argus | تنزيل",
  "download.meta.description": "نزّل Argus لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل Argus",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "Argus للطرفية",
  "download.section.desktop": "Argus لسطح المكتب (Beta)",
  "download.section.extensions": "امتدادات Argus",
  "download.section.integrations": "تكاملات Argus",
  ...
  "download.faq.a3.beforeLocal":
    "ليس بالضرورة، ولكن على الأرجح. ستحتاج إلى اشتراك ذكاء اصطناعي إذا كنت تريد ربط Argus بمزوّد مدفوع، رغم أنه يمكنك العمل مع",
  "download.faq.a3.localLink": "النماذج المحلية",
  "download.faq.a3.afterLocal.beforeZen": "مجانًا. بينما نشجع المستخدمين على استخدام",
  "download.faq.a3.afterZen": "، فإن Argus يعمل مع جميع المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",

  "download.faq.a5.p1": "Argus مجاني 100% للاستخدام.",
  "download.faq.a5.p2.beforeZen":
    "أي تكاليف إضافية ستأتي من اشتراكك لدى مزود النماذج. بينما يعمل Argus مع أي مزود نماذج، نوصي باستخدام",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "يتم حفظ بياناتك ومعلوماتك فقط عند إنشاء روابط قابلة للمشاركة في Argus.",
  "download.faq.a6.p2.beforeShare": "اعرف المزيد عن",
  "download.faq.a6.shareLink": "صفحات المشاركة",

  "enterprise.title": "Argus | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع Argus لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل Argus بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.q1": "ما هو Argus Enterprise؟",
  "enterprise.faq.a1":
    "Argus Enterprise مخصص للمؤسسات التي تريد التأكد من أن الكود والبيانات لا تغادر بنيتها التحتية أبدًا. يتحقق ذلك عبر استخدام تكوين مركزي يندمج مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  "enterprise.faq.q2": "كيف أبدأ مع Argus Enterprise؟",
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم Argus بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.q4": "هل بياناتي آمنة مع Argus Enterprise؟",
  "enterprise.faq.a4":
    "نعم. لا يقوم Argus بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "Argus | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ Argus",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ Argus.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "Argus | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ Argus",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ Argus",
