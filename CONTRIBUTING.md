...
By default, `bun dev` runs OpenCode in the `packages/argus` directory. To run it against a different directory or repository:
...
```bash
./packages/argus/dist/opencode-<platform>/bin/opencode
```

Replace `<platform>` with your platform (e.g., `darwin-arm64`, `linux-x64`).

- Core pieces:
  - `packages/argus`: OpenCode core business logic & server.
