...
- `deleted pre-June record 2026-05-23-task-session-runtime-isolation`: mutable runtime
...
- `specs/records/2026-06/2026-06-15-opencorvus-short-runtime-layout.md`: the only
...
- `specs/records/2026-06/task-global-project-forbidden-2026-06-16.md`: task project binding is
