...
Crea `.opencorvus/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di OpenCorvus o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OpenCorvus:
...
- Globale: `~/.config/opencorvus/commands/`
- Per progetto: `.opencorvus/commands/`
...
opencorvus include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
