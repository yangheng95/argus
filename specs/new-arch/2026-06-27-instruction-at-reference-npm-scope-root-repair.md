...
| Existing plan constraint | `specs/new-arch/2026-06-27-bug-hunt-residual-convergence.md` keeps discovered instruction-file read failures fail-fast, while missing optional matches may remain empty. |
