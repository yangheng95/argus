---
title: LSP-servere
description: Argus integreres med dine LSP-servere.
---

Argus integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Argus leveres med flere indbyggede LSP-servere til populære sprog:
...
Når argus åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din argus-konfiguration.
