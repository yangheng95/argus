...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | opencorvus",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo opencorvus",
  "notFound.logoDarkAlt": "ciemne logo opencorvus",
  ...
  "app.meta.description": "OpenCorvus - Otwartoźródłowy agent programistyczny.",

  "home.title": "OpenCorvus | Open source'owy agent AI do kodowania",

  "temp.title": "opencorvus | Agent AI do kodowania zbudowany dla terminala",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez opencorvus",
  "temp.feature.models.beforeLink": "Obsługuje 75+ dostawców LLM przez",
  "temp.feature.models.afterLink": ", w tym modele lokalne",
  "temp.screenshot.caption": "OpenCorvus TUI z motywem tokyonight",
  "temp.screenshot.alt": "OpenCorvus TUI z motywem tokyonight",
  "temp.logoLightAlt": "jasne logo opencorvus",
  "temp.logoDarkAlt": "ciemne logo opencorvus",
  ...
  "home.what.title": "Czym jest OpenCorvus?",
  "home.what.body":
    "OpenCorvus to open source'owy agent, który pomaga pisać kod w terminalu, IDE lub aplikacji desktopowej.",
  ...
  "home.growth.body":
    "Z ponad <strong>{{stars}}</strong> gwiazdkami na GitHubie, <strong>{{contributors}}</strong> współtwórcami i ponad <strong>{{commits}}</strong> commitami, OpenCorvus jest używany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperów każdego miesiąca.",
  ...
  "home.privacy.body":
    "OpenCorvus nie przechowuje Twojego kodu ani danych kontekstowych, dzięki czemu może działać w środowiskach wrażliwych na prywatność.",
  "home.privacy.learnMore": "Dowiedz się więcej o",
  "home.privacy.link": "prywatności",

  "home.faq.q1": "Czym jest OpenCorvus?",
  "home.faq.a1":
    "OpenCorvus to open source'owy agent, który pomaga pisać i uruchamiać kod z dowolnym modelem AI. Jest dostępny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystać z OpenCorvus?",
  "home.faq.a2.before": "Najłatwiej zacząć od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuję dodatkowych subskrypcji AI, aby używać OpenCorvus?",
  "home.faq.a3.p1":
    "Niekoniecznie. OpenCorvus posiada zestaw darmowych modeli, z których możesz korzystać bez zakładania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym możesz używać dowolnych popularnych modeli do kodowania, tworząc konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Chociaż zachęcamy do korzystania z Zen, OpenCorvus działa również ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",
  "home.faq.a3.p4.beforeLocal": "Możesz nawet podłączyć swoje",
  "home.faq.a3.p4.localLink": "lokalne modele",
  "home.faq.q4": "Czy mogę używać moich istniejących subskrypcji AI z OpenCorvus?",
  "home.faq.a4.p1":
    "Tak, OpenCorvus obsługuje plany subskrypcyjne od wszystkich głównych dostawców. Możesz używać swoich subskrypcji Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy mogę używać OpenCorvus tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Już nie! OpenCorvus jest teraz dostępny jako aplikacja na",
  "home.faq.a5.desktop": "pulpit (desktop)",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje OpenCorvus?",
  "home.faq.a6":
    "OpenCorvus jest w 100% darmowy. Zawiera również zestaw darmowych modeli. Mogą pojawić się dodatkowe koszty, jeśli podłączysz innego dostawcę.",
  ...
  "home.faq.q8": "Czy OpenCorvus jest open source?",
  "home.faq.a8.p1": "Tak, OpenCorvus jest w pełni open source. Kod źródłowy jest publicznie dostępny na",
  ...
  "home.zenCta.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które OpenCorvus przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość u różnych dostawców, używaj sprawdzonych modeli, które działają.",
  "home.zenCta.link": "Dowiedz się więcej o Zen",

  "zen.title": "OpenCorvus Zen | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentów kodujących",
  "zen.hero.title": "Niezawodne, zoptymalizowane modele dla agentów kodujących",
  "zen.hero.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które OpenCorvus przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość, używaj sprawdzonych modeli, które działają.",

  "zen.faq.q1": "Czym jest OpenCorvus Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i sprawdzonych pod kątem agentów kodujących, stworzony przez zespół stojący za OpenCorvus.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty od dostawców modeli bezpośrednio do Ciebie. Im większe użycie Zen, tym lepsze stawki OpenCorvus może wynegocjować i przekazać Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryć koszty, OpenCorvus dolicza jedynie niewielką opłatę za przetwarzanie płatności w wysokości $1.23 przy każdym doładowaniu salda o $20.",
  ...
  "zen.faq.a8":
    "Chociaż Zen świetnie działa z OpenCorvus, możesz używać Zen z dowolnym agentem. Postępuj zgodnie z instrukcjami konfiguracji w swoim preferowanym agencie.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników OpenCorvus.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z OpenCorvus, możesz używać Zen z dowolnym agentem.",
  ...
  "black.workspace.title": "OpenCorvus Black | Wybierz obszar roboczy",
  "black.workspace.selectPlan": "Wybierz obszar roboczy dla tego planu",
  "black.workspace.name": "Obszar roboczy {{n}}",
  "black.subscribe.title": "Subskrybuj OpenCorvus Black",
  ...
  "black.subscribe.success.title": "Jesteś na liście oczekujących OpenCorvus Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z OpenCorvus, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz opencorvus",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom opencorvus i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług opencorvus.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy opencorvus",
  ...
  "workspace.black.subscription.message": "Subskrybujesz OpenCorvus Black za ${{plan}} miesięcznie.",
  ...
  "workspace.black.waitlist.joined": "Jesteś na liście oczekujących na plan OpenCorvus Black za ${{plan}} miesięcznie.",
  "workspace.black.waitlist.ready": "Jesteśmy gotowi zapisać Cię do planu OpenCorvus Black za ${{plan}} miesięcznie.",
  ...
  "workspace.lite.subscription.message": "Subskrybujesz OpenCorvus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "OpenCorvus Go" jako dostawcę w konfiguracji opencorvus, aby używać modeli Go.',
  "workspace.lite.other.title": "Subskrypcja Go",
  "workspace.lite.other.message":
    "Inny członek tego obszaru roboczego już subskrybuje OpenCorvus Go. Tylko jeden członek na obszar roboczy może subskrybować.",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Go to subskrypcja za $10 miesięcznie, która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania z hojnymi limitami użycia.",
  ...
  "download.title": "OpenCorvus | Pobierz",
  "download.meta.description": "Pobierz OpenCorvus na macOS, Windows i Linux",
  "download.hero.title": "Pobierz OpenCorvus",
  "download.hero.subtitle": "Dostępne w wersji Beta na macOS, Windows i Linux",
  "download.hero.button": "Pobierz na {{os}}",
  "download.section.terminal": "Terminal OpenCorvus",
  "download.section.desktop": "Pulpit OpenCorvus (Beta)",
  "download.section.extensions": "Rozszerzenia OpenCorvus",
  "download.section.integrations": "Integracje OpenCorvus",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Będziesz potrzebować subskrypcji AI, jeśli chcesz połączyć OpenCorvus z płatnym dostawcą, chociaż możesz pracować z",
  ...
  "download.faq.a3.afterZen":
    ", OpenCorvus współpracuje ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",

  "download.faq.a5.p1": "OpenCorvus jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty będą pochodzić z Twojej subskrypcji u dostawcy modelu. Chociaż OpenCorvus współpracuje z dowolnym dostawcą modeli, zalecamy korzystanie z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje są przechowywane tylko wtedy, gdy tworzysz linki do udostępniania w OpenCorvus.",
  "download.faq.a6.p2.beforeShare": "Dowiedz się więcej o",
  "download.faq.a6.shareLink": "stronach udostępniania",

  "enterprise.title": "OpenCorvus | Rozwiązania Enterprise dla Twojej organizacji",
  "enterprise.meta.description": "Skontaktuj się z OpenCorvus w sprawie rozwiązań dla przedsiębiorstw",
  "enterprise.hero.title": "Twój kod jest Twój",
  "enterprise.hero.body1":
    "OpenCorvus działa bezpiecznie wewnątrz Twojej organizacji bez przechowywania danych czy kontekstu, oraz bez ograniczeń licencyjnych czy roszczeń własnościowych. Rozpocznij okres próbny ze swoim zespołem, a następnie wdróż go w całej organizacji, integrując z SSO i wewnętrzną bramą AI.",
  ...
  "enterprise.faq.q1": "Czym jest OpenCorvus Enterprise?",
  "enterprise.faq.a1":
    "OpenCorvus Enterprise jest dla organizacji, które chcą mieć pewność, że ich kod i dane nigdy nie opuszczą ich infrastruktury. Można to osiągnąć dzięki scentralizowanej konfiguracji, która integruje się z Twoim SSO i wewnętrzną bramą AI.",
  "enterprise.faq.q2": "Jak zacząć z OpenCorvus Enterprise?",
  "enterprise.faq.a2":
    "Po prostu rozpocznij wewnętrzny okres próbny ze swoim zespołem. OpenCorvus domyślnie nie przechowuje Twojego kodu ani danych kontekstowych, co ułatwia start. Następnie skontaktuj się z nami, aby omówić opcje cenowe i wdrożeniowe.",
  ...
  "enterprise.faq.q4": "Czy moje dane są bezpieczne z OpenCorvus Enterprise?",
  "enterprise.faq.a4":
    "Tak. OpenCorvus nie przechowuje Twojego kodu ani danych kontekstowych. Całe przetwarzanie odbywa się lokalnie lub poprzez bezpośrednie wywołania API do Twojego dostawcy AI. Dzięki centralnej konfiguracji i integracji SSO, Twoje dane pozostają bezpieczne w infrastrukturze Twojej organizacji.",

  "brand.title": "OpenCorvus | Marka",
  "brand.meta.description": "Wytyczne marki OpenCorvus",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i aktywa, które pomogą Ci pracować z marką OpenCorvus.",
  "brand.downloadAll": "Pobierz wszystkie zasoby",

  "changelog.title": "OpenCorvus | Dziennik zmian",
  "changelog.meta.description": "Notatki o wydaniu i dziennik zmian OpenCorvus",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia OpenCorvus",
