---
title: Paylasim
description: opencorvus konusmalarini genel baglantilarla paylasin.
---

opencorvus'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda opencorvus:
...
opencorvus, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak opencorvus manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `opencorvus.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda opencorvus kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
