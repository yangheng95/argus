// Copied from OpenCode's plugin manager and adapted to OpenCorvus package names.
import type { TuiPlugin, TuiPluginApi, TuiPluginStatus } from "@opencorvus-ai/plugin/tui"
