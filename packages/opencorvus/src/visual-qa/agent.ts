  ...
  if (input.referenceParityRequired) {
    sections.push(
      "# Reference Parity Evidence Contract\n\n" +
        ...
        "Standalone screenshots and per-screen `browser_preview_compare_scroll_slices` comparisons may support the review but are weaker than Reference vs Implementation comparison; a one-shot whole-page screenshot judge is not valid completion evidence. " +
