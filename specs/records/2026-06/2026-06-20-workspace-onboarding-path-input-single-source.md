...
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------ |
| `rg -n "workspace-onboarding-browser-path-input | workspace-onboarding-browser-path-label input                                                                               | field-input" packages/overlay/src packages/overlay/test specs -S`                                                  | The browser path input has one production owner and one private CSS chrome owner. | Migrate only this input and CSS selector family. |
