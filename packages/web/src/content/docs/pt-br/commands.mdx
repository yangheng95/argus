...
Crie `.opencorvus/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do opencorvus ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do opencorvus:
...
- Por projeto: `.opencorvus/commands/`
...
opencorvus inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
