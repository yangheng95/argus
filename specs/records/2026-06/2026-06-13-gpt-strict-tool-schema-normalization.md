...
- `deleted pre-June record 2026-04-30-result-schema-hardening`
  requires `report_build_result` to reuse the shared `BuildResultSchema`; no
  parallel build-report schema.
- `deleted pre-June record 2026-04-30-terminal-contract-hard-pin`
  replaced split build terminal tools with the single `report_build_result`.
- `deleted pre-June record 2026-04-30-terminal-extra-tool-schema-normalization`
