...
| --- | --- | --- |
| `rg -n --pcre2 "config-section-head-text|config-section-head|config-subsection-head|config-subsection-body|config-subsection|config-section(?!-body)" packages/overlay/src/components packages/overlay/src/main.tsx packages/overlay/src/index.html -g "*.tsx" -g "*.ts" -g "*.html"` | No production creation points. | Retire these selectors instead of preserving CSS-only shells. |
