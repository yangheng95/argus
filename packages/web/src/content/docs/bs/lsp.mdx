---
title: LSP serveri
description: Argus se integriše sa vašim LSP serverima.
---

Argus se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.

## Ugrađeni

Argus dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Možete prilagoditi LSP servere kroz `lsp` odjeljak u vašoj argus konfiguraciji.
