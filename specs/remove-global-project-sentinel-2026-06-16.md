...
- `specs/instance-stale-global-worktree-refresh-2026-06-16.md` patched cached
  `global` contexts because real Git tasks were still seeing `worktree="/"`.
- `specs/task-global-project-forbidden-2026-06-16.md` patched task persistence
  because `engine_task.project_id="global"` is not recoverable task state.
- `specs/task-execution-terminalization-2026-06-16.md` had to special-case
