...
| Method | 路径 | 说明 | operationId |
|---|---|---|---|
| GET | `/browser-preview/target` | Resolve browser preview target | `browserPreview.target` |
| POST | `/browser-preview/verify` | Capture browser preview verification evidence | `browserPreview.verify` |
