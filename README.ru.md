...
nix run nixpkgs#opencode           # или github:yangheng95/argus для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/yangheng95/argus/releases) или с [opencode.ai/download](https://opencode.ai/download).
