...
| ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `rg -n -e "ReasoningPart" -e "reasoning-label" -e "reasoning-toggle" packages/overlay/src packages/overlay/test specs specs/new-arch` | Production owner is `ReasoningPart.tsx`; all rendered transcript reasoning enters through `CardParts.tsx`. Tests still pin `.reasoning-label` as a legitimate tier-3 pill. | Replace the component and retire the old selector from tests.                                   |
