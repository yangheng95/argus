...
Utwórz `.opencorvus/commands/test.md`:
...
Możesz zdefiniować polecenia w `opencorvus.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji opencorvus:
...
- Globalnie: `~/.config/opencorvus/commands/`
- Na projekt: `.opencorvus/commands/`
...
opencorvus zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
