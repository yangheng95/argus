...
6. Perform a second semantic diff review, stage only task-owned paths or hunks,
   commit with `dsw-33987`, push the current branch to `legacy-remote`, and verify the
   remote commit.
