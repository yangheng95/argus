...
| Architecture gateway doc drift                  | `specs/current/architecture/README.md`, `specs/current/architecture/02-data.md`, `specs/current/architecture/03-control.md`, `packages/opencorvus/test/script/document-health.test.ts`                                                                                                                   | retired gateway session kind/path references, `SESSION_KINDS`, `src/gateway`                                                                               |
...
- `bun run --cwd packages/opencorvus typecheck`
- `bun run ./packages/opencorvus/script/docs/render-api-md.ts --check`
- `git diff --check -- packages/opencorvus/src/server/routes/experimental.ts packages/opencorvus/test/server/app-routes.test.ts packages/sdk/openapi.json packages/sdk/js/src/gen/types.gen.ts packages/sdk/js/src/gen/sdk.gen.ts specs/records/2026-06/2026-06-27-bug-hunt-residual-convergence.md`
