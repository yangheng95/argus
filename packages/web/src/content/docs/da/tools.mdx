...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenCorvus-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
