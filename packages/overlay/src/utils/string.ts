// ── String utilities ──
// Exact port of displayString, clipText, stripAssistantBrief, joinBullet
// from app.js, plus re-export of escapeHtml (already ported in markdown.ts).
...
// ── displayString ──
// Exact port of app.js lines 10815–10824.
 ...
 * the original app.js definition; the current implementation does not use it
...
// ── clipText ──
// Exact port of app.js lines 4540–4545.
...
// ── stripAssistantBrief ──
// Exact port of app.js lines 8456–8470.
...
// ── joinBullet ──
// Exact port of app.js lines 792–794.

/**
 * Join non-empty string values with " / " separator, filtering out falsy
 * entries (mirrors app.js joinBullet).
 */
...
// ── delay ──
// Mirrors app.js delay() (line 2008).
...
// ── dedupe ──
// Mirrors app.js dedupe() (line 2416).
...
// ── isAbortError ──
// Mirrors app.js isAbortError() (line 1844).
...
// ── shellSplit ──
// Mirrors app.js shellSplit() (line 3558).
