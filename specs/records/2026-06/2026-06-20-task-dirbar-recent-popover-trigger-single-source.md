...
| ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | --------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------- |
| `rg -n "cwd-recent-trigger                                                                | task-cwd-dropdown                                                                                                                            | Popover\\.Trigger                                                          | data-open | data-expanded | aria-expanded" packages/overlay/src/components/TaskDirBar.tsx packages/overlay/src/styles/surfaces/conversation.css packages/overlay/test/task-cwd-row-layout.test.ts packages/overlay/test/browser/task-dirbar-keyboard.test.ts specs -S` | The remaining recent-trigger mirror is isolated to `TaskDirBar`, `conversation.css`, and its tests. | Fix only this surface. |
| `rg -n "<Popover\\.Trigger" packages/overlay/src packages/overlay/test specs -S` | `ExecutorSelector` and Titlebar Brand Guide already use Kobalte Popover triggers.                                                            | Reuse `Popover.Trigger as={Button}` for the recent trigger.                |
