---
title: TUI
description: argus terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

argus, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

argus'u calistirdiginizda mevcut dizin icin TUI baslar.
...
argus TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
argus'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
argus'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini argus config dosyanizdan ozellestirebilirsiniz.
