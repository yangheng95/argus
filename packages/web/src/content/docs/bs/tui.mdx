---
title: TUI
description: Korištenje korisničkog interfejsa OpenCorvus terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenCorvus pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenCorvus pokreće TUI za trenutni direktorij.
...
Kada koristite OpenCorvus TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenCorvus. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenCorvus. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg OpenCorvus konfiguracionog fajla.
