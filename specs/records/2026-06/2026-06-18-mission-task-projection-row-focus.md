...
| ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| `rg -n -e "mission-task-projection" -e "task-row-main" packages/overlay/src packages/overlay/test specs` | Projection select is the only Mission child task row command using `mission-task-projection-button`; Mission and Assistant main rows already use `.task-row-main`. | Replace the local class with `.task-row-main` plus a stable projection data-ui hook.     |
