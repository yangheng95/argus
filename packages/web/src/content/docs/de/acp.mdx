...
description: Verwenden Sie Argus in jedem ACP-kompatiblen Editor.
---

Argus unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Argus über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `argus acp`.

Der Befehl startet Argus als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Argus“ in der AI Chat Agent Selector.
...
Um Argus als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Argus als ACP-Agent für den Chat verwendet wird.
...
Argus funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Argus-Konfiguration konfiguriert sind
