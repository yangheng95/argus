...
nix run nixpkgs#opencode           # або github:yangheng95/argus для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/yangheng95/argus/releases) або [opencode.ai/download](https://opencode.ai/download).
