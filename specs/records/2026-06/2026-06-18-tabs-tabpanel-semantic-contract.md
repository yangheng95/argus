...
| ------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- | --------------- | ------------ | ------------------------------ | ----------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `rg -n 'from "./ui/Tabs"  | <Tabs                                                                                            | KobalteTabs                                                                           | role="tabpanel" | Tabs.Content | data-ui="executor-popover-tab" | file-changes-view | browser-preview-size-tabs' packages/overlay/src packages/overlay/test specs` | Live `Tabs` callers are `FileChangesPanel`, `ExecutorSelector`, and `BrowserPreviewPanel`. No runtime `role="tabpanel"` exists. | Add `TabList` and `TabPanel` to the primitive; migrate real tabbed surfaces. |
