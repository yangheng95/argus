---
title: TUI
description: Usando la interfaz de usuario del terminal Argus.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Argus proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Argus se inicia TUI para el directorio actual.
...
Cuando utilice Argus TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Argus. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración Argus.
