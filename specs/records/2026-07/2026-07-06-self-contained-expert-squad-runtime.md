...
- Treat the MirrorTest migration as technical distillation, not a template to copy in detail.
...
- `software-testing` remains a package-specific MirrorTest implementation example, not a platform template.
