---
title: LSP Servers
description: Argus integrates with your LSP servers.
---

Argus integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

Argus comes with several built-in LSP servers for popular languages:
...
You can customize LSP servers through the `lsp` section in your argus config.
