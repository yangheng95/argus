export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Argus",
  ...
  "desktop.updater.downloaded.prompt": "已下載 Argus {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "Argus 文件",
  ...
  "desktop.cli.error.sidecarMissing": "Argus CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
