...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Argus'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Argus'da {{provider}} modellerini kullanmak için ",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Argus ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (argus.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Argus henüz MCP kimlik doğrulamasını desteklemiyor.',
