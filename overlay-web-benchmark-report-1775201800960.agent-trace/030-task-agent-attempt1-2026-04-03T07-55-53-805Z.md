...
- Plan: 2 goals
- Active run: run_d52569c310018Yjor7DUL4Fg0i (running)
- Budget: 14/20 runs, 0/8 fixes
...
Executor run run_d52569c310018Yjor7DUL4Fg0i completed.
...
测试目标仍在运行状态。由于执行器提示说执行已完成，但目标状态没有更新，这可能是状态同步问题。让我尝试创建一个运行来执行测试目标：
