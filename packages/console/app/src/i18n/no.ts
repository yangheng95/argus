...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | argus",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "argus logo lys",
  "notFound.logoDarkAlt": "argus logo mørk",
  ...
  "app.meta.description": "Argus - Den åpne kildekode kodingsagenten.",

  "home.title": "Argus | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "argus | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av argus",
  ...
  "temp.screenshot.caption": "argus TUI med tokyonight-tema",
  "temp.screenshot.alt": "argus TUI med tokyonight-tema",
  "temp.logoLightAlt": "argus logo lys",
  "temp.logoDarkAlt": "argus logo mørk",
  ...
  "home.what.title": "Hva er Argus?",
  "home.what.body": "Argus er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes Argus av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "Argus lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er Argus?",
  "home.faq.a1":
    "Argus er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg Argus?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke Argus?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Argus kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men Argus fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med Argus?",
  "home.faq.a4.p1":
    "Ja, Argus støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke Argus i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! Argus er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster Argus?",
  "home.faq.a6":
    "Argus er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er Argus åpen kildekode?",
  "home.faq.a8.p1": "Ja, Argus er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som Argus har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "Argus Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som Argus har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er Argus Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak Argus.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan Argus forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger Argus til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med Argus, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare Argus-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med Argus, kan du bruke Zen med hvilken som helst agent.",
  ...
  "black.meta.title": "Argus Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med Argus Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "Argus Black | Priser",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for Argus Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med argus når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg argus",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start argus og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til argus-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en argus Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Argus Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for Argus Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på Argus Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.message": "Du abonnerer på Argus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "Argus Go" som leverandør i argus-konfigurasjonen din for å bruke Go-modeller.',
  "workspace.lite.other.title": "Go-abonnement",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på Argus Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.title": "Argus Go",
  "workspace.lite.promo.description":
    "Argus Go er et abonnement til $10 per måned som gir pålitelig tilgang til populære åpne kodemodeller med rause bruksgrenser.",
  ...
  "download.title": "Argus | Last ned",
  "download.meta.description": "Last ned Argus for macOS, Windows og Linux",
  "download.hero.title": "Last ned Argus",
  ...
  "download.section.integrations": "Argus Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble Argus til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer Argus med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Argus er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om Argus fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i Argus.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Argus | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt Argus for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "Argus opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er Argus Enterprise?",
  "enterprise.faq.a1":
    "Argus Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Argus Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. Argus lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med Argus Enterprise?",
  "enterprise.faq.a4":
    "Ja. Argus lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "Argus | Merkevare",
  "brand.meta.description": "Argus retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med Argus-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "Argus | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for Argus",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for Argus",
