...
nix run nixpkgs#opencode           # o github:yangheng95/argus para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/yangheng95/argus/releases) o desde [opencode.ai/download](https://opencode.ai/download).
