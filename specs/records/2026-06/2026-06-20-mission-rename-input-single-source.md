...
| Search                               | Result                                                                                                            |
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rg "mission-row-rename-input        | task-row-rename-input                                                                                             | rename-input" packages/overlay/src packages/overlay/test specs` | Mission private selector appears only in `MissionList.tsx` and `mission.css`; shared selector appears in Task/Coding Assistant rows and browser token-closure coverage. |
