...
test("Network proxy settings expose an explicit delete action", async () => {
  ...
  try {
    ...
    await page.waitForFunction(() =>
      document.querySelector(".network-panel .provider-test-result")?.textContent?.includes("Proxy settings deleted."),
    )
