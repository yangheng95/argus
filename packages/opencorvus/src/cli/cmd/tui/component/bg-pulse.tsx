...
import { LogoPulsePainter } from "./bg-pulse-render"

type LogoPulseOptions = RenderableOptions<FrameBufferRenderable> & {
  backgroundPanel?: RGBA
  primary?: RGBA
  logoBase?: RGBA
}

class LogoPulseRenderable extends FrameBufferRenderable {
  private painter = new LogoPulsePainter()

  constructor(ctx: RenderContext, options: LogoPulseOptions = {}) {
...
declare module "@opentui/solid" {
  interface OpenTUIComponents {
    logo_pulse_art: typeof LogoPulseRenderable
  }
}

extend({ logo_pulse_art: LogoPulseRenderable })
