...
:::caution
ขณะนี้โหมดได้รับการกำหนดค่าผ่านตัวเลือก `agent` ในการกำหนดค่า argus ที่
ตัวเลือก `mode` เลิกใช้แล้ว [เรียนรู้เพิ่มเติม](/docs/agents)
:::

โหมดใน argus ช่วยให้คุณปรับแต่งพฤติกรรม เครื่องมือ และพร้อมท์สำหรับกรณีการใช้งานที่แตกต่างกันได้

มาพร้อมกับโหมดในตัวสองโหมด: **สร้าง** และ **วางแผน** คุณสามารถปรับแต่งได้
สิ่งเหล่านี้หรือกำหนดค่าของคุณเองผ่านการกำหนดค่า argus
...
argus มาพร้อมกับโหมดในตัวสองโหมด
...
- `edit` - ​​ไม่สามารถแก้ไขไฟล์ที่มีอยู่ได้ ยกเว้นไฟล์ที่อยู่ใน `.argus/plans/*.md` เพื่อดูรายละเอียดแผนงาน
...
กำหนดค่าโหมดในไฟล์กำหนดค่า `argus.json` ของคุณ:
...
หากไม่มีการระบุอุณหภูมิ argus จะใช้ค่าเริ่มต้นเฉพาะรุ่น (โดยทั่วไปจะเป็น 0 สำหรับรุ่นส่วนใหญ่ และ 0.55 สำหรับรุ่น Qwen)
...
ทั้งการกำหนดค่า argus ส่วนกลางและการกำหนดค่าเฉพาะโครงการ
...
สร้างไฟล์โหมดใน `.argus/modes/` สำหรับโหมดเฉพาะโครงการหรือ `~/.config/argus/modes/` สำหรับโหมดทั่วโลก:
