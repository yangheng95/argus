---
title: Zen
description: Kuratierte Modellliste direkt von Argus.
---
...
Argus Zen ist eine vom Argus-Team getestete und verifizierte Modellliste.

:::note
Argus Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Argus.
Du meldest dich bei Argus Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit Argus funktionieren.
:::
...
Argus Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

Argus Zen funktioniert wie jeder andere Provider in Argus.

1. Melde dich bei **<a href={console}>Argus Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle Argus Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Argus-Konfiguration hat das Format `argus/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `argus/gpt-5.2-codex`.
...
Wir haben Argus Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und Argus weiter mit anderen Providern nutzen kannst
