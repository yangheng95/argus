...
describe("frontend-design prompt assembly", () => {
  ...
  test("webpage rawproject prompts make frontend_design materialize the source project itself", () => {
    ...
    expect(prompt).toContain("do not read unrelated skeleton page wrappers, footer/economy/FAQ/chart/list files, whole manifests, or broad source data before the selected component/data/style/App slice exists")
