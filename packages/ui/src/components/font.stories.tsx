...
const docs = `### Overview
Loads OpenCorvus typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>OpenCorvus Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>OpenCorvus Mono Sample</div>
    </div>
  ),
}
