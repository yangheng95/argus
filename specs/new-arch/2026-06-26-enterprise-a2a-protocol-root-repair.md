...
| `specs/new-arch/13-agent-communication-matrix.md`                    | Current communication is still a hybrid of orchestrator tools, build tools, task subagents, channel ingress, and direct task messages. A2A must become the canonical durable mailbox for worker-to-orchestrator scheduling decisions. |
| `specs/new-arch/2026-06-24-a2a-agent-lifecycle-coordination.md`      | Introduced `request_orchestrator_decision` and `respond_agent_coordination`, but current implementation leaves half-commit, weak wake, and visibility gaps.                                                                           |
| `specs/new-arch/2026-06-24-remove-steer-subagent-tool.md`            | `steer_subagent` must not remain as a compatibility surface or replacement probe.                                                                                                                                                     |
| `specs/new-arch/2026-06-22-build-terminal-finalizer-continuation.md` | `stage_continuation_request` is a narrow same-session finalizer recovery artifact. Reuse its durable claim lessons, not its scope.                                                                                                    |
...
| Tool pools/prompts/docs           | `packages/opencorvus/src/agent/tool-pool-contract.ts`, `packages/opencorvus/src/prompt/core/orchestrator-core.txt`, `specs/new-arch/13-agent-communication-matrix.md`                                       | `packages/opencorvus/test/agent/agent.test.ts`, prompt hygiene tests                                                                                                                  |
