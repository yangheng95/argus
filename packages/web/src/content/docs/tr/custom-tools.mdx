---
title: Özel Araçlar
description: LLM'un argus'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. argus'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.argus/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/argus/tools/` içine yerleştirerek.
