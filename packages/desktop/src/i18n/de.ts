export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Argus wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Argus CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
