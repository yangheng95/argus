...
nix run nixpkgs#opencode           # ili github:yangheng95/argus za najnoviji dev branch
```
...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/yangheng95/argus/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
