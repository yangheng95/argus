...
nix run nixpkgs#opencode           # lub github:yangheng95/argus dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/yangheng95/argus/releases) lub z [opencode.ai/download](https://opencode.ai/download).
