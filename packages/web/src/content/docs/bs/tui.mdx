---
title: TUI
description: Korištenje korisničkog interfejsa Argus terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Argus pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Argus pokreće TUI za trenutni direktorij.
...
Kada koristite Argus TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Argus. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Argus. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg Argus konfiguracionog fajla.
