...
| GET | `/tui/host/connect` | Connect to embedded TUI host | `tui.host.connect` |
| POST | `/tui/host/connect-token` | Issue embedded TUI host connect token | `tui.host.connectToken` |
| POST | `/tui/host/input` | Write input to embedded TUI host | `tui.host.input` |
| GET | `/tui/host/output` | Get embedded TUI host output delta | `tui.host.output` |
| POST | `/tui/host/resize` | Resize embedded TUI host | `tui.host.resize` |
| GET | `/tui/host/snapshot` | Get embedded TUI host snapshot | `tui.host.snapshot` |
| POST | `/tui/host/start` | Start embedded TUI host | `tui.host.start` |
| GET | `/tui/host/status` | Get embedded TUI host status | `tui.host.status` |
| POST | `/tui/host/stop` | Stop embedded TUI host | `tui.host.stop` |
