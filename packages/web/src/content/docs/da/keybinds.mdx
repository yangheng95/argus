...
OpenCorvus har en liste over nøglebindinger, som du kan tilpasse gennem OpenCorvus-konfigurationen.
...
OpenCorvus bruger en `leader` nøgle til de fleste smagsbindinger. Dette undgår konflikter i din terminal.
...
OpenCorvus desktop app prompt input understøtter almindelige Readline/Emacs-style genveje til redigering af tekst. Disse er indbyggede og i øjeblikket ikke konfigurerede via `opencorvus.json`.
