...
- Test
- Plan: 2 goals
- Active run: run_d52598a6f001UgcCieatRi3MQR (running)
- Budget: 18/20 runs, 0/8 fixes
...
Executor run run_d52598a6f001UgcCieatRi3MQR completed.
...
测试目标仍在运行状态。由于执行器提示已经完成，但测试目标状态未更新，可能存在状态同步问题。让我尝试重新提交执行：
