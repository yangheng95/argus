...
export function renderWebpagePrdEvidencePromptSection(evidence: WebpagePrdEvidence | undefined): string | undefined {
  ...
  return [
    ...
    "Do not call `webfetch` against this same URL for visual layout or content extraction. In frontend-research, use delegated build investigation packets for narrow metadata or linked-source confirmation when these artifacts identify a missing fact.",
