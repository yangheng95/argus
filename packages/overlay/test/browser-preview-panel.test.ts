...
test("browser preview panel uses mature primitives and task evidence-backed service", () => {
  ...
  expect(component).toContain('addEventListener("scroll", scheduleLiveImageRectMeasure, { passive: true })')
  expect(component).toContain('removeEventListener("scroll", scheduleLiveImageRectMeasure)')
