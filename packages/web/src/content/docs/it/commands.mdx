...
Puoi aggiungere comandi personalizzati tramite la config di Argus o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Argus:
...
- Globale: `~/.config/argus/commands/`
- Per progetto: `.argus/commands/`
...
argus include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
