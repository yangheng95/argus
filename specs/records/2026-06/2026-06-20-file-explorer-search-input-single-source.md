...
| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| `rg -n "file-explorer-search-input           | file-explorer-search                                                                                                                | search-field-input field-input" packages/overlay/src packages/overlay/test specs -S` | Live production hits are isolated to `FileExplorerPanel.tsx` and `inspector.css`; `search-field-unification.test.ts` pins the old class mix. | Migrate this one search input and update the contract. |
