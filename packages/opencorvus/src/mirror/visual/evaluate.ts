 ...
 *
 * Ported from `mirror/src/service/evaluate.ts`. This module is an atomic
 * tool: it takes two images (data URL or file path), produces a score and
 * a diff-image data URL. No chaining, no context, no side effects beyond
 * reading the input files when paths are supplied.
 *
 * Scoring:
