...
- `AGENTS.md` forbids blind deletion, fallback, compatibility paths, and
  host-side gates.
- `specs/records/2026-06/2026-06-24-prune-obsolete-invalid-tests.md` defined the
...
- `specs/records/2026-06/2026-06-26-repo-obsolete-test-doc-prune-followup.md` narrowed
  repo pruning: useful coverage must be repaired, not deleted.
- `specs/records/2026-06/2026-06-29-spec-consolidation.md` records two intentionally removed
  historical notes.
