...
| --------------------------------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------- | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `rg -n 'prompt-profile-list                         | data-active=                                                                              | aria-current                                 | aria-selected                                                         | aria-pressed' packages/overlay/src/components/settings/PromptCatalog.tsx packages/overlay/test specs`                                  | Only `PromptCatalog` renders `.prompt-profile-list-item`; browser coverage only checked `data-active="true"`. | Fix `PromptCatalog` and extend existing Prompt Profile browser coverage. |
