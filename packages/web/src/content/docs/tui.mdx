---
title: TUI
description: Using the Argus terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Argus provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Argus starts the TUI for the current directory.
...
When using the Argus TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
This is separate from `argus.json`, which configures server/runtime behavior.
