...
Brug den til at bygge integrasjoner og kontrollere opencorvus programmatisk.
...
Opret en forekomst av opencorvus:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `opencorvus.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av opencorvus, kan du oprete en klientforekomst for at koble til den:
