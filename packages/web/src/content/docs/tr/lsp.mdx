...
description: argus, LSP sunucularınızla bütünleşir.
---

argus, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

argus, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP sunucularını, argus yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
