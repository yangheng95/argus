...
| ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `rg -n -e "md-code-copy" -e "data-md-copy" -e "markdown-code-copy" packages/overlay/src packages/overlay/test specs` | Production ownership is `wrapCodeBlock` and `markdown.css`; click behavior only uses `button[data-md-copy]`. | Add `.oc-button` and data attributes without changing clipboard delegation.                |
