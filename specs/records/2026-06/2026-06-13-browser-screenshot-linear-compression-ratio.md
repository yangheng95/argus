...
Existing plan `specs/records/2026-06/2026-06-10-browser-mcp-screenshot-pixel-summary.md` introduced one shared helper, `screenshotPixelSummary`, and intentionally routed both screenshot and observe metadata through it. This remains the single source.
...
| `specs/records/2026-06/2026-06-10-browser-mcp-screenshot-pixel-summary.md`          | Update the design note so historical plan no longer documents the wrong formula.                            |
