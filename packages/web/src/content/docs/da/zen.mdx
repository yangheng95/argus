---
title: Zen
description: Udvalgt liste over modeller leveret af Argus.
---
...
Argus Zen er en liste over testede og verificerede modeller leveret af Argus-teamet.

:::note
Argus Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Argus. Du logger på Argus Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Argus.
:::
...
Argus Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Argus Zen fungerer som alle andre udbydere i Argus.

1. Du logger på **<a href={console}>Argus Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Argus Zen og indsætter API-nøglen.
...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://argus.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://argus.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://argus.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://argus.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i Argus-konfigurationen
bruger formatet `argus/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `argus/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på Argus i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på Argus i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på Argus i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Argus i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Argus også.
