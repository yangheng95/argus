...
| ----------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `rg -n "AgentSessionReplyBox                                                  | card\_\_agent-reply                                                                | <textarea                                                                      | <button" packages/overlay/src packages/overlay/test specs/new-arch specs`                                | `AgentSessionReplyBox.tsx` owns one reply textarea and two local buttons. `Card.tsx` and `ChatBubble.tsx` are the only component callsites. | Migrate only this component; do not touch unrelated raw textareas in interaction/settings surfaces. |
