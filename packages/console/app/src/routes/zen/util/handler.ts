...
import { ProviderTable } from "@opencorvus-ai/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://opencorvus.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://opencorvus.ai/workspace/${authInfo.workspaceID}/members`
