...
| Primitive history | `specs/records/2026-06/2026-06-01-overlay-mature-ui-primitives-refactor.md` records that `@kobalte/core/menubar` migration is blocked by declaration errors.                                             | Do not hand-roll a new interaction system and do not add a second menu source; keep the existing menu implementation while fixing layout. |
