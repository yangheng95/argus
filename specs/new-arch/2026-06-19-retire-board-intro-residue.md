...
| `rg -n 'board-intro|BoardIntro|board-intro__cta|board-intro__cta-action' packages/overlay/src packages/overlay/test specs docs --glob '*.*'` | No component or HTML runtime emission exists. | Strengthen BoardIntro retirement guard across all production styles and source. |
