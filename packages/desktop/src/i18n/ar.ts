export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Argus",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Argus، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Argus",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Argus CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
