...
export const dict = {
  ...
  "dialog.provider.argus.note": "使用 Argus Zen 或 API 密钥连接",
  "dialog.provider.argus.tagline": "可靠的优化模型",
  "dialog.provider.argusGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Argus 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Argus 中使用 {{provider}} 模型。",
  ...
  "provider.connect.argusZen.line1": "Argus Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.argusZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.argusZen.visit.prefix": "访问 ",
  "provider.connect.argusZen.visit.link": "opencode.ai/zen",
  "provider.connect.argusZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Argus 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Argus 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 argus.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Argus 服务器。",
  ...
  "toast.update.description": "Argus 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Argus 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (argus.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Argus 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Argus 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Argus 服务器。",
  ...
  "settings.general.row.language.description": "更改 Argus 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Argus 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Argus 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Argus 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Argus。",
