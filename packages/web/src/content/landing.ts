  ...
  root: {
    ...
    expertSquads: {
      ...
      media: [
        ...
        { alt: "MirrorWatch Agent roster and local package installation" },
        { alt: "Mirror Prism installed Agent roster" },
      ],
    },
    surfaces: {
  ...
  "zh-cn": {
    ...
    expertSquads: {
      ...
      media: [
        ...
        { alt: "MirrorWatch Agent 阵容与本地能力包安装" },
        { alt: "Mirror Prism 已安装 Agent 阵容" },
      ],
    },
    surfaces: {
