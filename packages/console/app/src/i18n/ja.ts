...
export const dict = {
  ...
  "notFound.title": "見つかりません | Argus",
  "notFound.heading": "404 - ページが見つかりません",
  "notFound.home": "ホーム",
  "notFound.docs": "ドキュメント",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "argusのロゴ（ライト）",
  "notFound.logoDarkAlt": "argusのロゴ（ダーク）",
  ...
  "app.meta.description": "Argus - オープンソースのコーディングエージェント。",

  "home.title": "Argus | オープンソースのAIコーディングエージェント",

  "temp.title": "Argus | ターミナル向けに構築されたAIコーディングエージェント",
  ...
  "temp.feature.zen.beforeLink": "Argusが提供する",
  ...
  "temp.screenshot.caption": "tokyonight テーマを使用した Argus TUI",
  "temp.screenshot.alt": "tokyonight テーマの Argus TUI",
  "temp.logoLightAlt": "argusのロゴ（ライト）",
  "temp.logoDarkAlt": "argusのロゴ（ダーク）",
  ...
  "home.what.title": "Argusとは？",
  "home.what.body":
    "Argusは、ターミナル、IDE、またはデスクトップでのコード作成を支援するオープンソースのエージェントです。",
  ...
  "home.privacy.body":
    "Argusはコードやコンテキストデータを一切保存しないため、プライバシーが重視される環境でも利用できます。",
  "home.privacy.learnMore": "詳しくは",
  "home.privacy.link": "プライバシー",

  "home.faq.q1": "Argusとは？",
  "home.faq.a1":
    "Argusは、任意のAIモデルでコードの作成・実行を支援するオープンソースのエージェントです。ターミナルベースのインターフェース、デスクトップアプリ、IDE拡張として利用できます。",
  "home.faq.q2": "Argusの使い方は？",
  "home.faq.a2.before": "最も簡単な始め方は",
  "home.faq.a2.link": "イントロを読む",
  "home.faq.q3": "Argusには追加のAIサブスクリプションが必要ですか？",
  "home.faq.a3.p1": "必ずしも必要ではありません。Argusには、アカウント不要で使える無料モデルが含まれています。",
  "home.faq.a3.p2.beforeZen": "これらに加えて、",
  "home.faq.a3.p2.afterZen": " アカウントを作成することで、人気のコーディングモデルを利用できます。",
  "home.faq.a3.p3":
    "Zenの利用を推奨していますが、ArgusはOpenAI、Anthropic、xAIなどの主要プロバイダーにも対応しています。",
  "home.faq.a3.p4.beforeLocal": "さらに、",
  "home.faq.a3.p4.localLink": "ローカルモデル",
  "home.faq.q4": "既存のAIサブスクリプションをArgusで使えますか？",
  "home.faq.a4.p1":
    "はい、Argusは主要プロバイダーのサブスクリプションプランに対応しています。Claude Pro/Max、ChatGPT Plus/Pro、GitHub Copilotのサブスクリプションを利用できます。",
  "home.faq.q5": "ターミナルだけで使えますか？",
  "home.faq.a5.beforeDesktop": "もう違います！Argusは今は",
  "home.faq.a5.desktop": "デスクトップ",
  "home.faq.a5.and": "と",
  "home.faq.a5.web": "ウェブ",
  "home.faq.q6": "Argusの価格は？",
  "home.faq.a6":
    "Argusは100%無料で使えます。無料モデルも含まれています。他のプロバイダーに接続する場合は追加費用が発生することがあります。",
  ...
  "home.faq.q8": "Argusはオープンソースですか？",
  "home.faq.a8.p1": "はい、Argusは完全にオープンソースです。ソースコードは",
  "home.faq.a8.p2": "の",
  ...
  "home.zenCta.body":
    "Zenは、Argusがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",
  "home.zenCta.link": "Zenについて知る",

  "zen.title": "Argus Zen | コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.title": "コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.body":
    "Zenは、Argusがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",

  "zen.faq.q1": "Argus Zenとは？",
  "zen.faq.a1":
    "Zenは、Argusのチームが作成した、コーディングエージェント向けにテスト・ベンチマークされたAIモデルの厳選セットです。",
  ...
  "zen.faq.a3":
    "Zenは営利目的ではありません。Zenはモデル提供元のコストをそのままあなたに渡します。Zenの利用が増えるほど、Argusはより良いレートを交渉し、その分をあなたに還元できます。",
  "zen.faq.q4": "Zenの料金は？",
  ...
  "zen.faq.a4.p3": "コストを賄うために、Argusは$20の残高チャージあたり$1.23の小さな決済手数料のみを追加します。",
  ...
  "zen.faq.a8":
    "ZenはArgusとの相性が良いですが、どのエージェントでもZenを利用できます。お使いのコーディングエージェントのセットアップ手順に従ってください。",
  ...
  "zen.problem.subtitle": "Argusユーザーだけでなく、すべての人を対象にこの問題を修正しています。",
  ...
  "zen.how.body": "ZenをArgusとともに使用することをお勧めしますが、Zenはどのエージェントでも使用できます。",
  ...
  "black.meta.title": "Argus Black | 世界最高峰のコーディングモデルすべてにアクセス",
  "black.meta.description": "Argus Black サブスクリプションプランで、Claude、GPT、Gemini などにアクセス。",
  "black.hero.title": "世界最高峰のコーディングモデルすべてにアクセス",
  "black.hero.subtitle": "Claude、GPT、Gemini などを含む",
  "black.title": "Argus Black | 料金",
  ...
  "black.workspace.title": "Argus Black | ワークスペースの選択",
  "black.workspace.selectPlan": "このプランのワークスペースを選択してください",
  "black.workspace.name": "ワークスペース {{n}}",
  "black.subscribe.title": "Argus Black を購読する",
  ...
  "black.subscribe.success.title": "Argus Black ウェイトリストに登録されました",
  ...
  "workspace.newUser.feature.lockin.body":
    "任意のコーディングエージェントでZenを使用でき、必要に応じていつでもArgusを備えた他のプロバイダーを使用し続けることができます。",
  ...
  "workspace.newUser.step.login.after": "してArgusを選択",
  "workspace.newUser.step.pasteKey": "APIキーを貼り付け",
  "workspace.newUser.step.models.before": "Argusを起動し実行",
  ...
  "workspace.keys.subtitle": "ArgusサービスにアクセスするためのAPIキーを管理します。",
  "workspace.keys.create": "APIキーの作成",
  "workspace.keys.placeholder": "キー名を入力してください",
  "workspace.keys.empty": "ArgusゲートウェイAPIキーを作成する",
  ...
  "workspace.black.subscription.message": "あなたは Argus Black を月額 ${{plan}} で購読しています。",
  ...
  "workspace.black.waitlist.joined":
    "あなたは月額 ${{plan}} の Argus Black プランのウェイトリストに登録されています。",
  "workspace.black.waitlist.ready": "月額 ${{plan}} の Argus Black プランに登録する準備ができました。",
  ...
  "workspace.lite.subscription.message": "あなたは Argus Go を購読しています。",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、argus の設定で「Argus Go」をプロバイダーとして選択してください。",
  "workspace.lite.other.title": "Goサブスクリプション",
  "workspace.lite.other.message":
    "このワークスペースの別のメンバーが既に Argus Go を購読しています。ワークスペースにつき1人のメンバーのみが購読できます。",
  "workspace.lite.promo.title": "Argus Go",
  "workspace.lite.promo.description":
    "Argus Goは月額$10のサブスクリプションプランで、人気のオープンコーディングモデルへの安定したアクセスを十分な利用枠で提供します。",
  ...
  "download.title": "Argus | ダウンロード",
  "download.meta.description": "Argus を macOS、Windows、Linux 向けにダウンロード",
  "download.hero.title": "Argus をダウンロード",
  ...
  "download.faq.a3.beforeLocal":
    "必ずしもそうではありませんが、おそらく必要です。Argusを有料プロバイダーに接続したい場合はAIサブスクリプションが必要ですが、",
  "download.faq.a3.localLink": "ローカルモデル",
  "download.faq.a3.afterLocal.beforeZen": "であれば無料で利用できます。ユーザーには",
  "download.faq.a3.afterZen":
    "の利用をお勧めしていますが、ArgusはOpenAI、Anthropic、xAIなどの主要なプロバイダーに対応しています。",

  "download.faq.a5.p1": "Argusは100%無料で利用できます。",
  "download.faq.a5.p2.beforeZen":
    "追加コストはモデルプロバイダーのサブスクリプションから発生します。Argusはどのモデルプロバイダーでも利用できますが、",
  "download.faq.a5.p2.afterZen": "の利用をおすすめします。",

  "download.faq.a6.p1": "あなたのデータと情報は、Argusで共有リンクを作成したときにのみ保存されます。",
  "download.faq.a6.p2.beforeShare": "詳しくは",
  "download.faq.a6.shareLink": "共有ページ",

  "enterprise.title": "Argus | 組織向けエンタープライズソリューション",
  "enterprise.meta.description": "エンタープライズソリューションについてArgusに問い合わせる",
  "enterprise.hero.title": "あなたのコードはあなたのもの",
  "enterprise.hero.body1":
    "Argusは、データやコンテキストを一切保存せず、ライセンス制限や所有権の主張もなく、組織内で安全に動作します。チームでのトライアルから始め、SSOや社内AIゲートウェイと統合して組織全体に展開できます。",
  ...
  "enterprise.faq.q1": "Argus Enterpriseとは？",
  "enterprise.faq.a1":
    "Argus Enterpriseは、コードとデータが決してインフラの外に出ないことを保証したい組織向けです。SSOや社内AIゲートウェイと統合する集中設定を使用することでこれを実現します。",
  "enterprise.faq.q2": "Argus Enterpriseを始めるには？",
  "enterprise.faq.a2":
    "まずはチームでの社内トライアルから始めてください。Argusはデフォルトでコードやコンテキストデータを保存しないため、簡単に始められます。その後、価格や導入オプションについてお問い合わせください。",
  ...
  "enterprise.faq.q4": "Argus Enterpriseでデータは安全ですか？",
  "enterprise.faq.a4":
    "はい。Argusはコードやコンテキストデータを保存しません。すべての処理はローカル、またはAIプロバイダーへの直接API呼び出しを通じて行われます。集中設定とSSO統合により、データは組織のインフラ内で安全に保たれます。",

  "brand.title": "Argus | ブランド",
  "brand.meta.description": "Argus ブランドガイドライン",
  "brand.heading": "ブランドガイドライン",
  "brand.subtitle": "Argusブランドを扱うためのリソースと素材です。",
  "brand.downloadAll": "すべての素材をダウンロード",

  "changelog.title": "Argus | 変更履歴",
  "changelog.meta.description": "Argus リリースノートと変更履歴",
  "changelog.hero.title": "変更履歴",
  "changelog.hero.subtitle": "Argusの新しいアップデートと改善",
