...
| -------------------------------- | ----------------------------------- | ----------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `prt_edc374667001PWlSAr40fKipB1` | `local source-binding helper` | `error`     | `2026-06-18 19:31:10` | Agent passed `.opencorvus/r/t/S9/qzBwOu/fd/webpage-evidence/reference.png` as `sourceReferenceArtifactID`; runtime rejected it. |
| `prt_edc377f7c001EpbG6dWCzxj54l` | `local source-binding helper` | `completed` | `2026-06-18 19:31:25` | Binding succeeded with canonical `web-clone-source/reference.png`.                                                              |
...
- `packages/opencorvus/src/tool/local-source-binding-helper.ts`
...
`region comparison tool` and `local source-binding helper` call
runtime code with:
...
- `LocalSourceBindingParameters.sourceReferenceArtifactID`
...
- `packages/opencorvus/test/tool/browser-preview.test.ts` should assert
  `local source-binding helper` rejects non-canonical source references
...
- `local source-binding helper` cannot accept arbitrary `.opencorvus/...`
  source paths.
