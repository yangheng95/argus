...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | opencorvus",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "opencorvus logo lys",
  "notFound.logoDarkAlt": "opencorvus logo mørk",
  ...
  "app.meta.description": "OpenCorvus - Den åpne kildekode kodingsagenten.",

  "home.title": "OpenCorvus | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "opencorvus | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av opencorvus",
  ...
  "temp.screenshot.caption": "opencorvus TUI med tokyonight-tema",
  "temp.screenshot.alt": "opencorvus TUI med tokyonight-tema",
  "temp.logoLightAlt": "opencorvus logo lys",
  "temp.logoDarkAlt": "opencorvus logo mørk",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes OpenCorvus av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "OpenCorvus lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er OpenCorvus?",
  "home.faq.a1":
    "OpenCorvus er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg OpenCorvus?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke OpenCorvus?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. OpenCorvus kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men OpenCorvus fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med OpenCorvus?",
  "home.faq.a4.p1":
    "Ja, OpenCorvus støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke OpenCorvus i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! OpenCorvus er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster OpenCorvus?",
  "home.faq.a6":
    "OpenCorvus er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er OpenCorvus åpen kildekode?",
  "home.faq.a8.p1": "Ja, OpenCorvus er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som OpenCorvus har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "OpenCorvus Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som OpenCorvus har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er OpenCorvus Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak OpenCorvus.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan OpenCorvus forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger OpenCorvus til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med OpenCorvus, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare OpenCorvus-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med OpenCorvus, kan du bruke Zen med hvilken som helst agent.",
  ...
  "black.meta.title": "OpenCorvus Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med OpenCorvus Black-abonnementer.",
  ...
  "black.workspace.title": "OpenCorvus Black | Velg arbeidsområde",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for OpenCorvus Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med opencorvus når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg opencorvus",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start opencorvus og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til opencorvus-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en opencorvus Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på OpenCorvus Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for OpenCorvus Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på OpenCorvus Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "OpenCorvus Go" som leverandør i opencorvus-konfigurasjonen din for å bruke Go-modeller.',
  "workspace.lite.other.title": "Go-abonnement",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på OpenCorvus Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Go er et abonnement til $10 per måned som gir pålitelig tilgang til populære åpne kodemodeller med rause bruksgrenser.",
  ...
  "download.title": "OpenCorvus | Last ned",
  "download.meta.description": "Last ned OpenCorvus for macOS, Windows og Linux",
  "download.hero.title": "Last ned OpenCorvus",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble OpenCorvus til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer OpenCorvus med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "OpenCorvus er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om OpenCorvus fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i OpenCorvus.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "OpenCorvus | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt OpenCorvus for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "OpenCorvus opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er OpenCorvus Enterprise?",
  "enterprise.faq.a1":
    "OpenCorvus Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med OpenCorvus Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. OpenCorvus lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med OpenCorvus Enterprise?",
  "enterprise.faq.a4":
    "Ja. OpenCorvus lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "OpenCorvus | Merkevare",
  "brand.meta.description": "OpenCorvus retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med OpenCorvus-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "OpenCorvus | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for OpenCorvus",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for OpenCorvus",
