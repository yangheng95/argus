---
title: TUI
description: Bruke argus-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

argus gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre argus starter TUI for gjeldende katalog.
...
Når du bruker argus TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til argus. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt argus. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom argus-konfigurasjonsfilen.
