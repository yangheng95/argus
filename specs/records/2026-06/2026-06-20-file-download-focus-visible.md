...
| ------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| `rg -n "msg-file-download | FilePart                                              | download=                                                                                                                         | focus-visible" packages/overlay/src/components packages/overlay/src/styles/surfaces/messages.css packages/overlay/test specs` | `FilePart.tsx` has one `DownloadLink` owner; `messages.css` has base and hover styles but no focus-visible. | Add focus-visible to `messages.css`, not per caller. |
