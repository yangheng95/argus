...
- `specs/records/2026-06/task-project-archive-export-2026-06-04.md` defines the task archive contract and archive shape.
- `specs/records/2026-06/2026-06-14-runtime-memory-retention-hardening.md` records the later runtime-path filter and bounded JSON export requirement for task archives.
