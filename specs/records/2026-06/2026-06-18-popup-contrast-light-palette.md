...
| `rg -n -F "Select.Root" packages/overlay/src packages/overlay/test specs` | Kobalte Select users are Expert Squad, LogViewer, BrowserPreview, AppDialog, and `SettingsSelect`. | Keep the existing Select contrast matrix.                       |
