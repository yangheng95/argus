  ...
  "coding-glm": {
    body: () => (
      <g transform="scale(0.5333333)" stroke="none">
        ...
        />
        <polygon fill="var(--surface)" points="24.3,7.1 13.14,22.91 5.7,22.91 16.86,7.1" />
        <path fill="var(--surface)" d="M14.53,22.91l1.31-1.86c0.2-0.29,0.54-0.47,0.9-0.47h7.09v2.33H14.53z" />
      </g>
    ),
  },
  "avatar-user": {
