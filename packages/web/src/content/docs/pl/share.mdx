---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące opencorvus.
---

Funkcja udostępniania opencorvus umożliwia tworzenie publicznych linków do konwersacji opencorvus, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, opencorvus:
...
opencorvus obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie opencorvus korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `opencorvus.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu opencorvus w Twojej organizacji.
