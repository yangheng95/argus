export const dict = {
  ...
  "dialog.provider.argus.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.argus.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.argusGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Argus",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Argus-u.",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.argusZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.argusZen.visit.prefix": "Posjeti ",
  "provider.connect.argusZen.visit.link": "opencode.ai/zen",
  "provider.connect.argusZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Argus-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Argus-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u argus.json",
  ...
  "dialog.server.description": "Promijeni na koji se Argus server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Argus-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Argus timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (argus.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Argus još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Argus uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Argus server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Argus-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Argus izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Argus-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Argus pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Argus-a.",
