  ...
  return {
    create_frontend_skeleton_project: tool({
      description:
        ...
        "The skeleton is evidence, not the target acceptance project. Its outputDir must be the frontend-design-skeleton evidence directory, never the target app root such as web-clone-target. Frontend-design should use its bounded manifest/iteration sidecars to extract named source regions into the target project.",
      ...
      execute: async (params) => {
        ...
        return {
          ...
          output: [
            ...
            "1b. Do not move, rename, or repurpose this skeleton output as the target acceptance project. The target project remains a separate app populated with `write`/`edit` from selected source regions.",
