...
- `specs/records/2026-06/2026-06-09-serve-memory-retention-p0.md` addressed earlier
  serve memory retention paths such as board cache / live replay pressure.
- `specs/records/2026-06/2026-06-10-serve-sse-abort-closewait-fix.md` addressed SSE
