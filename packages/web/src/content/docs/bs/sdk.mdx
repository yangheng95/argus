---
title: SDK
description: Type-safe JS klijent za opencorvus server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/v2/gen/types.gen.ts`

opencorvus JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje opencorvus-om.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `opencorvus.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu opencorvus instancu, mozete napraviti klijentsku instancu i povezati se na nju:
...
| Opcija          | Tip        | Opis                              | Default                 |
| --------------- | ---------- | --------------------------------- | ----------------------- |
| `baseUrl`       | `string`   | URL servera                       | `http://localhost:7878` |
