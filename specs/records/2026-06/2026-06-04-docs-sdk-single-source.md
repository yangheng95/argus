...
| Legacy product docs              | `docs/product/**` has been removed by `specs/records/2026-06/2026-06-15-historical-docs-consolidation.md`.                                             | Keep all human-facing docs in `packages/web/src/content/docs/**`.                                        |
...
The follow-up cleanup in `specs/records/2026-06/2026-06-15-historical-docs-consolidation.md` removes `docs/product/**` after updating remaining references. The web docs tree is now the only product documentation source.
