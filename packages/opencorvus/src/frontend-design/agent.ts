      ...
      execute: async (params) => {
        ...
        return {
          ...
          output: [
            ...
            "Before writing files for another region, record this region's replacement result and call record_frontend_region_selection for the next region.",
          ].filter(Boolean).join("\n"),
