...
- `specs/records/2026-06/2026-06-15-region-comparison-evidence-runner.md` requires missing/bad bindings to fail loudly and not compare the wrong region.
- `specs/records/2026-06/2026-06-16-local-module-source-binding.md` says source crop need not be pixel-perfect, but it must fully contain the corresponding source module and avoid neighboring modules. Silent clipping violates that authority.
