...
nix run nixpkgs#opencode           # oppure github:yangheng95/argus per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/yangheng95/argus/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
