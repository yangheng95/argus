---
title: ปลั๊กอิน
description: เขียนปลั๊กอินของคุณเองเพื่อขยาย OpenCorvus
---

ปลั๊กอินช่วยให้คุณสามารถขยาย OpenCorvus ได้โดยเชื่อมโยงกับเหตุการณ์ต่างๆ และปรับแต่งลักษณะการทำงาน คุณสามารถสร้างปลั๊กอินเพื่อเพิ่มคุณสมบัติใหม่ บูรณาการกับบริการภายนอก หรือแก้ไขการทำงานเริ่มต้นของ OpenCorvus
...
- `.opencorvus/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/opencorvus/plugins/` - ​​ปลั๊กอินทั่วโลก
...
**ปลั๊กอิน npm** ได้รับการติดตั้งโดยอัตโนมัติโดยใช้ Bun เมื่อเริ่มต้น แพ็คเกจและการขึ้นต่อกันถูกแคชไว้ใน `~/.cache/opencorvus/node_modules/`
...
1. การกำหนดค่าส่วนกลาง (`~/.config/opencorvus/opencorvus.json`)
2. การกำหนดค่าโครงการ (`opencorvus.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/opencorvus/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.opencorvus/plugins/`)
...
OpenCorvus รัน `bun install` เมื่อเริ่มต้นเพื่อติดตั้งสิ่งเหล่านี้ ปลั๊กอินและเครื่องมือของคุณสามารถนำเข้าได้
...
- `client`: ไคลเอนต์ opencorvus SDK สำหรับการโต้ตอบกับ AI
...
นี่คือตัวอย่างบางส่วนของปลั๊กอินที่คุณสามารถใช้เพื่อขยาย opencorvus
...
:::note
หากคุณใช้แอปเดสก์ท็อป OpenCorvus แอปสามารถส่งการแจ้งเตือนของระบบโดยอัตโนมัติเมื่อมีการตอบกลับพร้อมหรือเมื่อเซสชันเกิดข้อผิดพลาด
:::
...
ป้องกันไม่ให้ opencorvus อ่านไฟล์ `.env`:
...
ปลั๊กอินยังสามารถเพิ่มเครื่องมือที่กำหนดเองให้กับ opencorvus:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ opencorvus ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ opencorvus ควบคู่ไปกับเครื่องมือในตัว
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://opencorvus.ai/docs/sdk)สำหรับรายละเอียด
