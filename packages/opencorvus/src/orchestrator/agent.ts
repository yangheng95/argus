...
const ORCHESTRATOR_INSTRUCTIONS = [
  ...
  "  3. Missing functionality → **add_goal** for the gap (contract-level).",
  ...
  "  6. Two consecutive rejections on the SAME goal-set under the same contract → the goal decomposition itself is suspect → **restart_from_stage('plan')** to fully regenerate the goal list while keeping requirements. Do not keep retrying the same goals a third time.",
