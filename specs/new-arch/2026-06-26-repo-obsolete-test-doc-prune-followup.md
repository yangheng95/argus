...
- `specs/new-arch/2026-06-24-prune-obsolete-invalid-tests.md` already defined
  the previous deletion boundary: remove tests only when they assert retired
  contracts.
- `specs/new-arch/2026-06-24-remove-web-clone-source-audit.md` already removed
...
- The repository already has two obsolete historical notes deleted in the
  working tree:
  - `specs/new-arch/2026-06-24-prune-obsolete-invalid-tests.md`
  - `specs/new-arch/2026-06-24-remove-web-clone-source-audit.md`
- `historical-docs-links.test.ts` fails because:
  - `specs/new-arch/2026-06-25-visual-qa-self-report-consistency-repair.md`
    still references missing historical file
    `docs/etfs/final-delivery-report.md`;
  - `specs/tv2ainvest.md` is a live prompt/reference artifact but is missing
    from `specs/README.md`;
  - many existing `specs/new-arch/*.md` files are valid notes but are missing
    from `specs/new-arch/HISTORY.md`.
...
- Keep the two 2026-06-24 obsolete notes deleted and remove their index
  entries.
- Do not delete `specs/tv2ainvest.md`; it is an active task input and must be
  indexed as a prompt/reference artifact.
- Do not delete `specs/new-arch/2026-06-25-visual-qa-self-report-consistency-repair.md`;
