---
title: SDK
description: Type-safe JS client for opencorvus server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/v2/gen/types.gen.ts`

The opencorvus JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control opencorvus programmatically.
...
Create an instance of opencorvus:
...
You can pass a configuration object to customize behavior. The instance still picks up your `opencorvus.json`, but you can override or add configuration inline:
...
If you already have a running instance of opencorvus, you can create a client instance to connect to it:
...
| Option          | Type       | Description                      | Default                 |
| --------------- | ---------- | -------------------------------- | ----------------------- |
| `baseUrl`       | `string`   | URL of the server                | `http://localhost:7878` |
