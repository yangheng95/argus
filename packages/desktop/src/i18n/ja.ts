export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Argus を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Argus のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "Argus ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Argus CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
