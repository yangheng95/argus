...
export function renderHostPreparedFrontendProjectSection(project: HostPreparedFrontendProject): string {
  ...
  const lines = [
    ...
    "Do not output a standalone component checklist. Use the full `submit_frontend_template` schema to populate the public frontend_design report with component reuse strategy, baseline replacement plan, quality project contract, visual/data contracts, completeness review, and open questions.",
