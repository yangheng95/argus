...
Puede agregar comandos personalizados a través de la configuración Argus o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Argus [config](/docs/config):
...
argus incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
