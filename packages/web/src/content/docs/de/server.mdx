...
Der Benutzername ist standardmaessig `opencorvus`, kann aber mit `OPENCODE_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `opencorvus serve` und `opencorvus web`.
