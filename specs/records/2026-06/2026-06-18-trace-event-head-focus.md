...
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `rg -n "trace-event-head                                     | TracePanel" packages/overlay/src packages/overlay/test specs`              | The live event disclosure owner is `TracePanel.tsx`; `card.css` owns `.trace-event-head`; tests cover Panel/Button adoption but not event row focus. | Add focused CSS and tests at the existing owner. |
