---
title: LSP-servere
description: OpenCorvus integreres med dine LSP-servere.
---

OpenCorvus integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

OpenCorvus leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENCORVUS_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når opencorvus åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din opencorvus-konfiguration.
