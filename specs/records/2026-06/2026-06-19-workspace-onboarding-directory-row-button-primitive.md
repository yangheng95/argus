...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `rg -n -e "WorkspaceOnboarding" -e "workspace-onboarding-recent-item" -e "workspace-onboarding-recent-list" packages/overlay/src packages/overlay/test specs` | Production raw rows only live in `WorkspaceOnboardingDialog.tsx`; CSS shell only lives in `workspace-onboarding.css`. Tests currently check ordering and discovery error, not primitive ownership. | Replace both detected and recent rows in one change.                                                             |
