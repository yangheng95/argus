---
title: LSP Server
description: Argus lässt sich in Ihren LSP-Server integrieren.
---

Argus lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

Argus verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn Argus eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Argus-Konfiguration anpassen.
