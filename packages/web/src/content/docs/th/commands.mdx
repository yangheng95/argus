...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Argus:
...
- ระดับผู้ใช้ (Global): `~/.config/argus/commands/`
- ระดับโปรเจ็กต์: `.argus/commands/`
...
Argus มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
