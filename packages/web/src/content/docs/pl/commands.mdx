...
Możesz zdefiniować polecenia w `argus.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji argus:
...
- Globalnie: `~/.config/argus/commands/`
- Na projekt: `.argus/commands/`
...
argus zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
