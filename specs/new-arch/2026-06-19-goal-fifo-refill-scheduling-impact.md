...
- `specs/new-arch/16-unified-teardown.md`
...
- `specs/operator-wake-status-facts-not-scheduler-2026-06-17.md`
  - Runtime monitoring is framed as fact observation, not a host-side scheduler.
- `specs/goal-batch-wake-natural-message-2026-06-04.md`
  - Batch settlement wakes must be real engine facts, not synthetic user messages.
- `specs/new-arch/2026-06-06-integrity-wake-ownership-fix.md`
  - Durable wake facts dedupe orchestrator wake attempts.
- `specs/new-arch/2026-06-07-goal-batch-notification-preserve-stream-error.md`
  - Stream-error blocked runs must not be resumed by liveness automation.
- `specs/new-arch/2026-06-19-final-visual-qa-scoped-build-context.md`
...
- `packages/opencorvus/src/engine/queue.ts`
  ...
  - `drainQueuedTaskEventIfUnowned` starts the queued wake only after ownership clears.
