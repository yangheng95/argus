...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| `rg -n 'trace-event-head                 | TracePanel' packages/overlay/src packages/overlay/test specs`                                 | Live production row owner is `TracePanel.tsx`; style owner is `card.css`; browser fixture and primitive tests pin the old bare class contract. | Migrate the live row and test fixture together. |
