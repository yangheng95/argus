export const dict = {
  ...
  "dialog.provider.argus.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.argus.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.argusGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.argusZen.line1":
    "Argus Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w argus.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (argus.json) nazwy dostawców/modeli",
