...
| -------------------------- | ------------------ | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `rg -n "card\_\_model-hint | card\_\_token-hint | card\_\_usage-hint                                                                            | usageTip                                                                                                      | usage_tooltip" packages/overlay/src packages/overlay/test specs` | Production metadata owner is only `CardHeaderChrome.tsx`; CSS owner is `card.css`. | Add one shared `CardMetaHint` inside `CardHeaderChrome.tsx`. |
