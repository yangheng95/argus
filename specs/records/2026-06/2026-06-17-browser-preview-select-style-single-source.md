...
| ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ----------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| `rg -n "Select.Root<BrowserPreviewCandidate>                                                                                         | browser-preview-candidate-content                                                                      | browser-preview-candidate-option                                                           | oc-select-content | oc-select-option" packages/overlay/src packages/overlay/test specs` | `BrowserPreviewPanel.tsx` renders Kobalte Select but gives content/listbox/item/indicator only Browser Preview-specific class names. `inspector.css` duplicates popup tokens. | Add shared `.oc-select-*` classes to the candidate Select and retire duplicated popup CSS. |
