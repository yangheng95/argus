...
nix run nixpkgs#opencode           # oder github:yangheng95/argus für den neuesten dev-Branch
```
...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/yangheng95/argus/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
