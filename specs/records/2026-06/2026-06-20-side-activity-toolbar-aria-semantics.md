...
| ------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------- | ------------ | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `rg -n "SideActivityToolbar                                         | selectLeftActivity                                                                                  | selectRightActivity                                                                                                          | side-activity-button | aria-pressed | aria-current" packages/overlay/src packages/overlay/test specs` | `SideActivityToolbar` is the single production source for both rails. Right-side browser tests inspect `aria-pressed`; left-side tests do not guard ARIA. | Add explicit per-call semantics instead of deleting `aria-pressed` globally. |
