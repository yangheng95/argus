...
Kreiraj `.argus/commands/test.md`:
...
Možete dodati prilagođene komande kroz Argus konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Argus [config](/docs/config):
...
- Globalno: `~/.config/argus/commands/`
- Po projektu: `.argus/commands/`
...
Argus uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
