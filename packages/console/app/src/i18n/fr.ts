...
export const dict = {
  ...en,
  "app.meta.description": "Argus - L'agent de code open source.",
  "nav.github": "GitHub",
  ...
  "notFound.title": "Introuvable | Argus",
  "notFound.heading": "404 - Page introuvable",
  "notFound.home": "Accueil",
  "notFound.docs": "Documentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "argus logo light",
  "notFound.logoDarkAlt": "argus logo dark",
  ...
  "home.title": "Argus | L'agent de code IA open source",

  "temp.title": "Argus | Agent de code IA conçu pour le terminal",
  ...
  "temp.feature.zen.afterLink": "fournie par Argus",
  ...
  "temp.screenshot.caption": "Argus TUI avec le thème tokyonight",
  "temp.screenshot.alt": "Argus TUI avec le thème tokyonight",
  "temp.logoLightAlt": "argus logo light",
  "temp.logoDarkAlt": "argus logo dark",
  ...
  "home.what.title": "Qu'est-ce que Argus ?",
  "home.what.body":
    "Argus est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, Argus est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "Argus ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que Argus ?",
  "home.faq.a1":
    "Argus est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser Argus ?",
  "home.faq.a2.before": "Le moyen le plus simple de commencer est de lire l'",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Ai-je besoin d'abonnements IA supplémentaires pour utiliser Argus ?",
  "home.faq.a3.p1":
    "Pas forcément : Argus propose des modèles gratuits que vous pouvez utiliser sans créer de compte.",
  "home.faq.a3.p2.beforeZen": "En plus, vous pouvez utiliser des modèles populaires pour le code en créant un compte",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais Argus fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Vous pouvez même connecter vos",
  "home.faq.a3.p4.localLink": "modèles locaux",
  "home.faq.q4": "Puis-je utiliser mes abonnements IA existants avec Argus ?",
  "home.faq.a4.p1":
    "Oui, Argus prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser Argus uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! Argus est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte Argus ?",
  "home.faq.a6":
    "Argus est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "Argus est-il open source ?",
  "home.faq.a8.p1": "Oui, Argus est entièrement open source. Le code source est public sur",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Argus a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  "home.zenCta.link": "En savoir plus sur Zen",

  "zen.title": "Argus Zen | Un ensemble sélectionné de modèles fiables et optimisés pour les agents de code",
  "zen.hero.title": "Modèles fiables et optimisés pour les agents de code",
  "zen.hero.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Argus a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",

  "zen.faq.q1": "Qu'est-ce que Argus Zen ?",
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière Argus.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus Argus peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, Argus ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec Argus, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de Argus.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec Argus, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "black.meta.title": "Argus Black | Accédez aux meilleurs modèles de code au monde",
  "black.meta.description": "Accédez à Claude, GPT, Gemini et plus avec les forfaits d'abonnement Argus Black.",
  "black.hero.title": "Accédez aux meilleurs modèles de code au monde",
  "black.hero.subtitle": "Y compris Claude, GPT, Gemini et plus",
  "black.title": "Argus Black | Tarification",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente Argus Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec Argus quand vous le souhaitez.",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez Argus",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez Argus et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services Argus.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API Argus Gateway",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à Argus Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait Argus Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait Argus Black à {{plan}} $ par mois.",
  ...
  "workspace.lite.subscription.message": "Vous êtes abonné à Argus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Sélectionnez "Argus Go" comme fournisseur dans votre configuration argus pour utiliser les modèles Go.',
  "workspace.lite.other.title": "Abonnement Go",
  "workspace.lite.other.message":
    "Un autre membre de cet espace de travail est déjà abonné à Argus Go. Un seul membre par espace de travail peut s'abonner.",
  "workspace.lite.promo.title": "Argus Go",
  "workspace.lite.promo.description":
    "Argus Go est un abonnement à 10 $ par mois qui offre un accès fiable aux modèles de codage ouverts populaires avec des limites d'utilisation généreuses.",
  ...
  "download.title": "Argus | Téléchargement",
  "download.meta.description": "Téléchargez Argus pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger Argus",
  ...
  "download.section.desktop": "Argus Desktop (Bêta)",
  "download.section.extensions": "Extensions Argus",
  "download.section.integrations": "Intégrations Argus",
  ...
  "download.faq.a3.beforeLocal":
    "Pas forcément, mais probablement. Vous aurez besoin d'un abonnement IA si vous voulez connecter Argus à un fournisseur payant, mais vous pouvez travailler avec des",
  ...
  "download.faq.a3.afterZen":
    ", Argus fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Argus est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si Argus fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Vos données et informations ne sont stockées que lorsque vous créez des liens partageables dans Argus.",
  "download.faq.a6.p2.beforeShare": "En savoir plus sur",
  "download.faq.a6.shareLink": "les pages de partage",

  "enterprise.title": "Argus | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez Argus pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "Argus fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.q1": "Qu'est-ce que Argus Enterprise ?",
  "enterprise.faq.a1":
    "Argus Enterprise s'adresse aux organisations qui veulent s'assurer que leur code et leurs données ne quittent jamais leur infrastructure. Cela est possible grâce à une configuration centralisée qui s'intègre à votre SSO et à votre passerelle IA interne.",
  "enterprise.faq.q2": "Comment démarrer avec Argus Enterprise ?",
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, Argus ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.q4": "Mes données sont-elles sécurisées avec Argus Enterprise ?",
  "enterprise.faq.a4":
    "Oui. Argus ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "Argus | Marque",
  "brand.meta.description": "Guide de marque Argus",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque Argus.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "Argus | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'Argus",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour Argus",
