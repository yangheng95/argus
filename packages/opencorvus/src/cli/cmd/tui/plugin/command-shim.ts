// Copied from OpenCode's legacy TUI command shim and adapted to OpenCorvus keybind names.
import type { TuiCommand, TuiPluginApi } from "@opencorvus-ai/plugin/tui"
