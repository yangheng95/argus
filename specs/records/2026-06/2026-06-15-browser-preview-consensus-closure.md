...
| Source                                                           | Claim                                                                                        |
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `specs/records/2026-06/2026-06-11-browser-preview-manual-url-input.md`  | `PUT /task/:taskID/browser-preview/target` should accept exactly one of `targetID` or `url`. |
