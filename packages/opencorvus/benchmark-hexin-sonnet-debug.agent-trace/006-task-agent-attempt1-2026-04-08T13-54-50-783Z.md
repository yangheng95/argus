...
## Goals (2)
  ...
  - [pending] Implement NoteStore tests (src/note-store.test.ts) [blocking] — src/note-store.test.ts exists and `bun test ./src/note-store.test.ts` exits with code 0 with all 5 t
- Plan: 2 goals
