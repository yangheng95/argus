...
| ------------------------ | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ---------------- | ---------------- | ------------ | -------------- | --------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `rg -n "goal-item        | goals-list                                                                   | goal-status-icon                                                                                    | goal-priority                                                                                                                            | goal-actions                                                 | goal-title-brief | goal-desc-inline | goal-item-id | goal-item-body | \\.goal-desc\\b | plan-version" packages/overlay/src packages/overlay/test specs` | Runtime hits are CSS-only. Production component hits are limited to `Card.tsx` `.card__goal-desc` and `GoalWorkflowGroup.tsx` `.gwg-*`, which are separate live contracts. | Remove retired `.goal-item` / `.goals-list` / non-card `.goal-desc` CSS and update tests to reject them. |
