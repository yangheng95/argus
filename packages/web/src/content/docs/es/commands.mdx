...
Crear `.opencorvus/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenCorvus o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenCorvus [config](/docs/config):
...
- Por proyecto: `.opencorvus/commands/`
...
opencorvus incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
