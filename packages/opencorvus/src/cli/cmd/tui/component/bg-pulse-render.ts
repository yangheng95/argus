...
// Offset so the background ring emits from the estimated logo center when the shimmer peaks.
...
export type LogoPulseRenderOptions = {
  deltaTime?: number
  rgb?: boolean
  cache?: boolean
}
...
export class LogoPulsePainter {
  ...
  render(frameBuffer: OptimizedBuffer, options: LogoPulseRenderOptions = {}) {
