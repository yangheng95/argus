...
| Existing stale selection frontend plan | `specs/records/2026-06/2026-06-05-overlay-deleted-session-stale-card-plan.md` | Related but insufficient. It clears stale UI selection only after task list refresh; this bug is server bootstrap before record deletion.                |
