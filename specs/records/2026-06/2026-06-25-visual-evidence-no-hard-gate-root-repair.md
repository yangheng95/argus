...
- create the requested task in
  ...
  `C:\Users\chuan\myhexin-local\opecorvus\specs/artifacts/tv2ainvest.md`.

## Superseded Design

This record supersedes the host-gating parts of
`specs/records/2026-06/2026-06-20-reference-comparison-evidence-chain-root-repair.md`.
