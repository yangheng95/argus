// Copied from OpenCode's sidebar files plugin and adapted to OpenCorvus package names.
            ...
            {(item) => (
              <box flexDirection="row" gap={1} justifyContent="space-between">
                <text fg={theme().textMuted} wrapMode="none">
                  {Locale.truncateMiddle(item.file, Math.max(2, 36 - changeCountWidth(item)))}
                </text>
