...
nix run nixpkgs#opencode           # 或使用 github:yangheng95/argus 以取得最新開發分支
```
...
OpenCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/yangheng95/argus/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下載。
