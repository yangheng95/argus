...
The default local server is `http://127.0.0.1:7878`. Project-scoped routes need the current project directory, either as a header:
...
The SDK handles the directory header and Basic Auth:
...
For direct controls, use the explicit routes:
