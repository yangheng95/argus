...
| ----------------------- | --------------------- | ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ------------------------------ | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `rg -n "ConnectionBadge | conn-badge            | connection badge                                                                   | handleRestart                                                                                                                                                              | solidConnBadge                                                                             | onDblClick" packages/overlay/src packages/overlay/test specs` | `App.tsx` mounts `ConnectionBadge` once into `#solidConnBadge`. `ConnectionBadge.tsx` owns the hidden double-click restart. `titlebar.css` owns the visual style. Existing tests only assert mount/status, not keyboard semantics. | Fix the single owner and add source/browser coverage. |
| `rg -n "restart         | apiJson\\(\"restart\" | connection_diagnostics" packages/overlay/src packages/overlay/test specs` | `/restart` is not covered as a visible badge contract. `titlebar.connection_diagnostics` already exists and `ConnectionBanner` uses it for the explicit connection action. | Convert the badge action to diagnostics instead of preserving hidden double-click restart. |
