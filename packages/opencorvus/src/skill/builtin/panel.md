---
name: panel-control
description: Control-plane skill for task boards, plans, sessions, delivery, evaluation, and interaction management.
---
...
- Prefer read-only actions first when the user asks for status, plan, delivery, evaluation, sessions, or blockers.
