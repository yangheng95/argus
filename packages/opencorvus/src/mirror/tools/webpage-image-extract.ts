...
Use as step 1 of the image-generate workflow. Requires a vision-capable model — falls back loudly if the configured model has \`capabilities.input.image=false\`.`,
  parameters: z.object({
    images: z
      .array(z.string())
      .min(1)
