...
:::note
Questo strumento e' disponibile solo quando usi il provider OpenCorvus o quando la variabile d'ambiente `OPENCODE_ENABLE_EXA` e' impostata a un valore truthy (ad esempio `true` o `1`).
