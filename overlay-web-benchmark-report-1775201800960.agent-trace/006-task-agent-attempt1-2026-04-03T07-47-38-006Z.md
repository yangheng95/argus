...
- Plan: 2 goals
- Active run: run_d524f5764001jnUpOQdYsbidkH (running)
- Budget: 2/20 runs, 0/8 fixes
...
Executor run run_d524f5764001jnUpOQdYsbidkH completed.
...
测试目标有依赖（goal_note_store），但那个目标已经通过了。让我再仔细查看一下目标状态，然后可能需要重新启动执行。
