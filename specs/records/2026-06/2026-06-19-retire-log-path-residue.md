...
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| `rg -n "log-path" packages/overlay/src packages/overlay/test specs` | `.log-path` appears in `settings.css` and the architecture guard only. | Delete the CSS rule and remove it from the required selector list. |
...
| `Get-Content specs/records/2026-06/2026-06-18-retire-ndjson-log-css-residue.md`     | Existing decision already rejects preserving retired log styling.      | Treat `.log-path` as residue, not compatibility.                   |
