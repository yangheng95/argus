...
Argus มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
Argus มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
Argus มี subagent ในตัวได้แก่ **General** และ **Explore**

---

## บิวท์อิน

Argus มาพร้อมกับเอเจนต์หลักและ subagent ในตัวดังนี้
...
กำหนดค่าเอเจนต์ในไฟล์ `argus.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/argus/agents/`
- ระดับโปรเจ็กต์: `.argus/agents/`
...
หมายเหตุ: Argus ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ Argus
:::
...
:::tip
ใช้ `argus models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/yangheng95/argus)
:::
