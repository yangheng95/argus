...
Du kan tilføje brugerdefinerede kommandoer gennem Argus-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Argus [config](/docs/config):
...
- Globalt: `~/.config/argus/commands/`
- Pr. projekt: `.argus/commands/`
...
argus indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
