...
describe("frontend-design prompt assembly", () => {
  ...
  test("webpage rawproject prompts make frontend_design materialize the source project itself", () => {
    ...
    expect(prompt).toContain("Default target delivery project root: `.`")
    ...
    expect(prompt).toContain("After the skeleton exists, the first target-project edits should create source files")
