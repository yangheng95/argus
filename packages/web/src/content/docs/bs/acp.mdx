---
title: ACP podrška
description: Koristite Argus u bilo kojem uređivaču kompatibilnom sa ACP.
---

Argus podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Argus putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `argus acp`.

Naredba pokreće Argus kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Argus" agenta u AI Chat agent selektoru.
...
Da koristite Argus kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Argus kao ACP chat agenta.
...
Argus radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Argus konfiguraciji
