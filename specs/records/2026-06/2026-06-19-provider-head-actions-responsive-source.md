...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | --------------------- | -------------------- | ---------------- | ---------------------- | ------------------ | -------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| `rg -n "provider-head-actions                                                             | provider-refresh-meta                                                                                                                             | provider-refresh                                                                           | provider-catalog-hint | provider-test-result | provider-spinner | provider-model-actions | provider-card-head | Provider | ProvidersPanel" packages/overlay/src packages/overlay/test specs docs --glob "_._"` | `.provider-head-actions` and `.provider-refresh-meta` are live in `ProvidersPanel.tsx`; `settings.css` had duplicate base rules around the provider responsive media block. | Keep the live hooks, but collapse each base selector to one owner. |
