...
export const dict = {
  ...
  "notFound.title": "找不到頁面 | OpenCorvus",
  "notFound.heading": "404 - 找不到頁面",
  "notFound.home": "首頁",
  "notFound.docs": "文件",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "opencorvus 淺色標誌",
  "notFound.logoDarkAlt": "opencorvus 深色標誌",
  ...
  "app.meta.description": "OpenCorvus - 開源編碼代理。",

  "home.title": "OpenCorvus | 開源 AI 編碼代理",

  "temp.title": "OpenCorvus | 專為終端打造的 AI 編碼代理",
  ...
  "temp.feature.zen.afterLink": "由 OpenCorvus 提供",
  "temp.feature.models.beforeLink": "透過",
  "temp.feature.models.afterLink": "支援 75+ 家 LLM 供應商，包括本地模型",
  "temp.screenshot.caption": "使用 tokyonight 主題的 OpenCorvus TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 OpenCorvus TUI",
  "temp.logoLightAlt": "opencorvus 淺色標誌",
  "temp.logoDarkAlt": "opencorvus 深色標誌",
  ...
  "home.what.title": "什麼是 OpenCorvus？",
  "home.what.body": "OpenCorvus 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，OpenCorvus 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "OpenCorvus 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 OpenCorvus？",
  "home.faq.a1":
    "OpenCorvus 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 OpenCorvus？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 OpenCorvus 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。OpenCorvus 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，你可以透過建立",
  "home.faq.a3.p2.afterZen": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 OpenCorvus 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。OpenCorvus 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "OpenCorvus 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！OpenCorvus 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "OpenCorvus 價格如何？",
  "home.faq.a6": "OpenCorvus 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "OpenCorvus 是開源的嗎？",
  "home.faq.a8.p1": "是的，OpenCorvus 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  ...
  "home.zenCta.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 OpenCorvus 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "OpenCorvus Zen | 專為編碼代理精選的可靠最佳化模型",
  "zen.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "zen.hero.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 OpenCorvus 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "zen.faq.q1": "什麼是 OpenCorvus Zen？",
  "zen.faq.a1": "Zen 是由 OpenCorvus 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "zen.faq.q2": "是什麼讓 Zen 更準確？",
  "zen.faq.a2": "Zen 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "zen.faq.q3": "Zen 更便宜嗎？",
  "zen.faq.a3":
    "Zen 不以營利為目的。Zen 會把模型供應商的成本原樣轉給你。Zen 的使用量越高，OpenCorvus 就越能談到更好的價格並把優惠讓利給你。",
  ...
  "zen.faq.a4.p3": "為了覆蓋成本，OpenCorvus 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "zen.faq.q5": "資料與隱私如何？",
  ...
  "zen.faq.a8":
    "Zen 與 OpenCorvus 搭配得很好，但你也可以在任何代理中使用 Zen。請在你偏好的編碼代理中按照設定說明進行配置。",
  ...
  "zen.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 OpenCorvus 使用者。",
  ...
  "zen.how.body": "雖然我們建議你將 Zen 與 OpenCorvus 一起使用，但你可以將 Zen 與任何代理一起使用。",
  ...
  "black.meta.title": "OpenCorvus Black | 存取全球最佳編碼模型",
  "black.meta.description": "透過 OpenCorvus Black 訂閱方案存取 Claude、GPT、Gemini 等模型。",
  "black.hero.title": "存取全球最佳編碼模型",
  "black.hero.subtitle": "包括 Claude、GPT、Gemini 等",
  "black.title": "OpenCorvus Black | 定價",
  ...
  "black.workspace.title": "OpenCorvus Black | 選擇工作區",
  "black.workspace.selectPlan": "為此方案選擇一個工作區",
  "black.workspace.name": "工作區 {{n}}",
  "black.subscribe.title": "訂閱 OpenCorvus Black",
  ...
  "black.subscribe.success.title": "你已在 OpenCorvus Black 候補名單上",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 OpenCorvus 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 OpenCorvus",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 OpenCorvus 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 OpenCorvus 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 OpenCorvus 閘道器 API 金鑰",
  ...
  "workspace.black.subscription.message": "你已訂閱 OpenCorvus Black，費用為每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "你已加入每月 ${{plan}} 的 OpenCorvus Black 方案候補名單。",
  "workspace.black.waitlist.ready": "我們已準備好將你加入每月 ${{plan}} 的 OpenCorvus Black 方案。",
  ...
  "workspace.lite.subscription.message": "您已訂閱 OpenCorvus Go。",
  ...
  "workspace.lite.subscription.selectProvider":
    "在您的 opencorvus 設定中選擇「OpenCorvus Go」作為提供商，即可使用 Go 模型。",
  "workspace.lite.other.title": "Go 訂閱",
  "workspace.lite.other.message": "此工作區中的另一位成員已訂閱 OpenCorvus Go。每個工作區只能有一位成員訂閱。",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Go 是一個每月 $10 的訂閱方案，提供對主流開放原始碼編碼模型的穩定存取，並配備充足的使用額度。",
  ...
  "download.title": "OpenCorvus | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 OpenCorvus",
  "download.hero.title": "下載 OpenCorvus",
  "download.hero.subtitle": "適用於 macOS、Windows 與 Linux 的 Beta 版現已提供",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "OpenCorvus 終端",
  "download.section.desktop": "OpenCorvus 桌面版（Beta）",
  "download.section.extensions": "OpenCorvus 擴充功能",
  "download.section.integrations": "OpenCorvus 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 OpenCorvus 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  ...
  "enterprise.title": "OpenCorvus | 面向組織的企業解決方案",
  "enterprise.meta.description": "聯絡 OpenCorvus 取得企業解決方案",
  "enterprise.hero.title": "你的程式碼屬於你",
  "enterprise.hero.body1":
    "OpenCorvus 在你的組織內部安全運作，不會儲存任何資料或上下文，也沒有授權限制或所有權主張。你可以先與團隊進行試用，然後透過與你的 SSO 與內部 AI 閘道器整合，將其部署到整個組織。",
  ...
  "enterprise.faq.q1": "什麼是 OpenCorvus Enterprise？",
  "enterprise.faq.a1":
    "OpenCorvus Enterprise 適用於希望確保程式碼與資料絕不離開自己基礎設施的組織。透過中央化設定，它可與你的 SSO 與內部 AI 閘道器整合，以達成此目標。",
  "enterprise.faq.q2": "如何開始使用 OpenCorvus Enterprise？",
  "enterprise.faq.a2":
    "只要先以團隊的內部試用開始。OpenCorvus 預設不會儲存你的程式碼或上下文資料，所以上手非常容易。之後聯絡我們，討論定價與完整實作方案。",
  "enterprise.faq.q3": "企業定價是如何進行的？",
  "enterprise.faq.a3":
    "我們提供按席位的企業定價。如果你有自己的 LLM 閘道器，我們不會對使用的 token 另外收費。更多詳情，請聯絡我們以獲得依據組織需求的客製報價。",
  "enterprise.faq.q4": "我的資料在 OpenCorvus Enterprise 中是安全的嗎？",
  "enterprise.faq.a4":
    "是的。OpenCorvus 不會儲存你的程式碼或上下文資料。所有處理都會在本地或透過直接呼叫你的 AI 供應商 API 完成。透過中央化設定與 SSO 整合，你的資料會安全保留在組織的基礎設施內部。",

  "brand.title": "OpenCorvus | 品牌",
  "brand.meta.description": "OpenCorvus 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "協助你使用 OpenCorvus 品牌的資源與素材。",
  "brand.downloadAll": "下載所有素材",

  "changelog.title": "OpenCorvus | 更新日誌",
  "changelog.meta.description": "OpenCorvus 發布說明與更新日誌",
  "changelog.hero.title": "更新日誌",
  "changelog.hero.subtitle": "OpenCorvus 的新更新與改善",
