---
title: TUI
description: Arbeite mit Argus in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Argus bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Argus die TUI im aktuellen Verzeichnis.
...
In der Argus-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to Argus. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Argus config file.
