...
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | --------- | --------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| `rg -n "CommandPalette                                         | cmdk-input                                                                                                                                          | cmdk-list                                                            | cmdk-item | aria-activedescendant" packages/overlay/src packages/overlay/test specs` | `CommandPalette.tsx` has the only `cmdk-*` listbox surface; no existing `aria-activedescendant` relation exists. | Fix in `CommandPalette.tsx`. |
| `rg -n "command-palette" packages/overlay/test specs` | Existing browser coverage opens the real overlay palette, verifies Dialog primitive DOM, hotkey focus, Escape close, focus restore, and screenshot. | Extend that browser test with active-descendant keyboard assertions. |
