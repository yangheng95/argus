...
Erstellen Sie `.opencorvus/commands/test.md`:

```md title=".opencorvus/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OpenCorvus-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OpenCorvus [config](/docs/config):

```json title="opencorvus.jsonc" {4-12}
{
...
- Global: `~/.config/opencorvus/commands/`
- Pro Projekt: `.opencorvus/commands/`

```markdown title="~/.config/opencorvus/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".opencorvus/commands/component.md"
---
...
```md title=".opencorvus/commands/create-file.md"
---
...
```md title=".opencorvus/commands/analyze-coverage.md"
---
...
```md title=".opencorvus/commands/review-changes.md"
---
...
```md title=".opencorvus/commands/review-component.md"
---
...
OpenCorvus enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
