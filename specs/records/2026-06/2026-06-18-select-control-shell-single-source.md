...
| `rg -n "prompt-profile-select        | app-dialog-select                                                              | browser-preview-candidate                                                                   | log-level-select                                                                | settings-form-select                                                          | agent-model-select" packages/overlay/src packages/overlay/test specs` | Existing class names are used by CSS, browser tests, and contrast matrix fixtures.          | Preserve public class/data selectors; change ownership of shell only.                                                                  |
