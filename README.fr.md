...
nix run nixpkgs#opencode           # ou github:yangheng95/argus pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/yangheng95/argus/releases) ou [opencode.ai/download](https://opencode.ai/download).
