---
title: Deling
description: Del dine Argus-samtaler.
---

Arguss delingsfunksjon lar deg lage offentlige lenker til dine Argus-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Argus støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Argus manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `argus.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av argus i organisasjonen din.
