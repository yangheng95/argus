...
test("integrity reviewers render as distinct reviewer blocks", () => {
  ...
  expect(component).toContain('data-ui="integrity-reviewer-chip"')
  expect(component).not.toContain("integrity__reviewer-chip")
...
test("integrity findings stack verdict text inside one readable body column", () => {
  ...
  expect(component).toContain('data-ui="integrity-issue-tag"')
  expect(component).toContain('data-ui="integrity-repair-tag"')
  expect(component).not.toContain("integrity__tag")
