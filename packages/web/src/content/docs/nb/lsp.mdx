---
title: LSP-servere
description: argus integreres med LSP-serverne dine.
---

Argus integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Argus kommer med flere innebygde LSP-servere for populære språk:
...
Når argus åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Argus-konfigurasjonen.
