...
| ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | ----------------- | --------------- | -------------- | --------------- | -------------- | -------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| `rg -n "section-head-action                                  | sectionHeadAction                                                                                                    | section_head_action                                                        | SectionHeadAction | section-actions | sectionActions | section_actions | SectionActions | section action | head action" packages/overlay/src packages/overlay/test specs/new-arch docs --glob "_._"` | Production hits were only `inspector.css`. Test/spec hits were positive protection or historical notes. | Delete the CSS selectors and convert tests to absence guards. |
