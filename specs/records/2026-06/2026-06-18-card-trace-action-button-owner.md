...
| `rg -n "card\_\_agent-reply-toggle                                                                                        | agent-reply-toggle" packages/overlay/src packages/overlay/test specs/new-arch`                                                                                 | The reply-toggle selector exists only inside `card.css`; no component emits it.                                    | Remove it with the old private card action button shell. |
