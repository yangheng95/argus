---
title: TUI
description: Brug af Argus-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Argus giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Argus starter TUI for den nuværende mappe.
...
Når du bruger Argus TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Argus. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Du kan tilpasse TUI-adfærden gennem Argus-konfigurationsfilen.
