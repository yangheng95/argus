---
title: TUI
description: opencorvus terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

opencorvus, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

opencorvus'u calistirdiginizda mevcut dizin icin TUI baslar.
...
opencorvus TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
opencorvus'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
opencorvus'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini opencorvus config dosyanizdan ozellestirebilirsiniz.
