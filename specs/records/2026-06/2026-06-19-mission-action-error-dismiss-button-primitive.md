...
| ------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `rg -n -e "mission-action-error-dismiss" -e "mission-global-action-error" packages/overlay/src packages/overlay/test specs` | Production ownership is limited to `Mission.tsx` and `mission.css`.                                      | Replace this one dismiss control; no compatibility branch.                            |
