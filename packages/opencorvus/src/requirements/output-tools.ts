...
export const RequirementRegistrationSchema = z.object({
  ...
  evidence_refs: z
    ...
    .default([])
    .describe(
      "Source-qualified research evidence refs that support this requirement, for example deep_research:artifact_123:ev_1 or frontend_research:artifact_123:ev_1. Empty when the requirement does not depend on research facts.",
    ),
})
