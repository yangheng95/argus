...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/yangheng95/argus/releases) eller [opencode.ai/download](https://opencode.ai/download).
