...
nix run nixpkgs#opencode           # eller github:yangheng95/argus for nyeste dev-branch
```
...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/yangheng95/argus/releases) eller [opencode.ai/download](https://opencode.ai/download).
