...
| Pre-June conversation agent workflow rail record         | The rail is a Conversation-owned bottom strip, hidden when there are no real agent records, and must not create synthetic cards.                                                                                          |
