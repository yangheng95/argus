---
title: خوادم LSP
description: يتكامل OpenCorvus مع خوادم LSP لديك.
---

يتكامل OpenCorvus مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي OpenCorvus مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `OPENCORVUS_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح opencorvus ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات opencorvus.
