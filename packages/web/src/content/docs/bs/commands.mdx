...
Kreiraj `.opencorvus/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenCorvus konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenCorvus [config](/docs/config):
...
- Globalno: `~/.config/opencorvus/commands/`
- Po projektu: `.opencorvus/commands/`
...
OpenCorvus uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
