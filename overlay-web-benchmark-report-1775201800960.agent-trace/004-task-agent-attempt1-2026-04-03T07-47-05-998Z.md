...
- Plan: 2 goals
- Active run: run_d52469ef600172L7RBqt9IY67e (running)
...
Executor run run_d52469ef600172L7RBqt9IY67e completed.
...
有一个目标仍在运行中，但执行器已经完成了。这可能是状态不一致的问题。让我尝试重新启动执行：
