...
Mit OpenCorvus kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet OpenCorvus das `opencorvus`-Theme.
...
OpenCorvus liefert mehrere eingebaute Themes mit.
...
- OpenCorvus optisch ans Terminal anpassen wollen
...
OpenCorvus unterstuetzt ein flexibles JSON-basiertes Theme-System.
