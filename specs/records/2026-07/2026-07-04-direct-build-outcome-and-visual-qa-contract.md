...
protocol in `specs/current/architecture/15-agent-facts-and-turns.md`, including
...
- Sources read in this continuation:
  ...
  this record's Recall, `specs/current/architecture/15-agent-facts-and-turns.md`,
