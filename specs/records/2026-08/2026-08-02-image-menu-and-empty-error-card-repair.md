...
| Git baseline          | `work-v0.0.27beta-yr-0801` equals `myhexin/work-v0.0.27beta-yr-0801` at `c35c09367a`. The pre-existing modification to `specs/artifacts/opencorvus-workbuddy-qoderwork-multica-codex-benchmark-catalog.md` is unrelated and must remain untouched.                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
6. Recheck all owners and the scoped diff, commit task-owned files with the
   `dsw-33987` prefix, reconcile with git-cc, and push the current branch.
