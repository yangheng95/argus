---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenCorvus.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenCorvus واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenCorvus إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenCorvus في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenCorvus. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenCorvus. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات OpenCorvus.
