...
test("file explorer and editor are wired through the side activity panels", () => {
  ...
  expect(html).toContain('data-left-activity="tasks"')
  ...
  expect(html).toContain('class="chat-file-editor-activity file-editor-mount"')
  expect(html).toContain('class="chat-diff-activity workspace-mount"')
  ...
  expect(main).toContain('<FileExplorerPanel active={() => leftActivity() === "explorer"} directory={activeDirectory}')
  ...
  expect(main).toContain('document.getElementById("leftPanelChanges")')
  expect(main).toContain('document.getElementById("solidFileChangesMount")')
  expect(main).toContain('changes: document.getElementById("leftPanelChanges")')
  expect(main).toContain('file: document.getElementById("chatFileEditorPane")')
  expect(main).toContain('diff: document.getElementById("chatDiffPane")')
  expect(main).toContain('setChatView("file")')
  expect(main).toContain('setChatView("diff")')
  ...
  expect(workspaceCss).toContain(".chat-file-editor-pane")
  expect(workspaceCss).toContain(".chat-diff-pane")
  expect(workspaceCss).toContain(".chat-file-editor-activity")
  expect(workspaceCss).toContain(".chat-diff-activity")
  expect(workspaceCss).toContain(".chat-diff-activity.workspace-mount")
