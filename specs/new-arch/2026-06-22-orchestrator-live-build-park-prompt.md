...
- `specs/orchestrator-no-decision-stop-2026-06-18.md`: no-decision stops stay
...
- `specs/new-arch/2026-06-19-goal-fifo-refill-scheduling-impact.md`: refill
  wakes are driven by terminal goal_run facts, not by manual polling.
- `specs/new-arch/2026-06-21-orchestrator-tool-only-trace-summary.md`: same-wake
  observation after a decision cannot be treated as a new task decision.
- `specs/new-arch/2026-06-21-world-economy-stuck-adversarial-goal-review.md`:
