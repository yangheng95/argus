...
`specs/new-arch/2026-06-04-docs-sdk-single-source.md`: updating `docs/product/**` does not update the
...
3. Fix four broken historical references found by the link scan:
   ...
   - specs/new-arch/2026-06-04-remove-iwc-aime-provider.md
   - specs/notification-reliability-2026-05-18.md
4. Update `specs/new-arch/README.md` with the current cleanup status so new design notes do not restart the old dual-source pattern.
