...
| Retired external note specs/new-arch/2026-06-04-remove-iwc-aime-provider.md | Delete the stale provider-removal spec because it references the deleted hardcoded-provider module.                                                        |
