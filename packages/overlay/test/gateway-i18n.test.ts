...
const REQUIRED_KEYS = [
  ...
  "gateway.compose.title",
  "gateway.compose.placeholder",
  "gateway.compose.submit",
  "gateway.compose.discard",
  "gateway.proposal.heading",
  "gateway.proposal.queue_choice",
  "gateway.proposal.queue_start_now",
  "gateway.proposal.queue_queue",
  "gateway.proposal.create_all",
  "gateway.proposal.create_failed_one",
