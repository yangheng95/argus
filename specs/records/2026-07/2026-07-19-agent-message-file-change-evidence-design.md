...
| Git baseline                     | `v0.0.9beta` matched `legacy-remote/v0.0.9beta` before this design record; the pre-change push and repository hooks passed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
6. Run historical-document links, document health, diff hygiene, a second code
   review, commit with the required `dsw-33987` prefix, and push to `legacy-remote`.
...
commit, and legacy remote checks above pass.
