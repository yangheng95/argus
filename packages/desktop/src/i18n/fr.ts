export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Argus a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'Argus",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Argus est manquant. Essayez de réinstaller l'application de bureau.",
