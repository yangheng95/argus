...
| ------------------------------------------------------ | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `rg -n "task-progress\_\_pill                          | TaskProgressBar" packages/overlay/src packages/overlay/test specs/new-arch`                         | `TaskProgressBar.tsx` is the live surface; `card.css` owns pill styling; tests only cover structure/collapse. | Add focused CSS and tests at the existing owner. |
