...
test("browser preview panel uses mature primitives and task evidence-backed service", () => {
  ...
  expect(component).toContain("manualUrl")
  expect(component).toContain("submitManualUrl")
  expect(component).toContain('data-ui="browser-preview-url-form"')
  expect(component).toContain("selectTaskBrowserPreviewTarget({ taskID, url })")
  ...
  expect(component).toContain('manualUrlError()')
  ...
  expect(service).toContain("url: input.url")
  ...
  expect(css).toContain(".browser-preview-url-form")
  expect(css).toContain(".browser-preview-url-input")
