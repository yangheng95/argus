...
:::note
Esta ferramenta está disponível apenas ao usar o provedor opencorvus ou quando a variável de ambiente `OPENCODE_ENABLE_EXA` está definida como qualquer valor verdadeiro (por exemplo, `true` ou `1`).
