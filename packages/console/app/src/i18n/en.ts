export const dict = {
  ...
  "notFound.title": "Not Found | opencorvus",
  ...
  "app.meta.description": "OpenCorvus - The open source coding agent.",

  "home.title": "OpenCorvus | The open source AI coding agent",

  "temp.title": "opencorvus | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by opencorvus",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "opencorvus TUI with the tokyonight theme",
  "temp.screenshot.alt": "opencorvus TUI with tokyonight theme",
  ...
  "home.what.title": "What is OpenCorvus?",
  "home.what.body": "OpenCorvus is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, OpenCorvus is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "OpenCorvus does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is OpenCorvus?",
  "home.faq.a1":
    "OpenCorvus is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use OpenCorvus?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use OpenCorvus?",
  "home.faq.a3.p1":
    "Not necessarily, OpenCorvus comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, OpenCorvus also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with OpenCorvus?",
  "home.faq.a4.p1":
    "Yes, OpenCorvus supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use OpenCorvus in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! OpenCorvus is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does OpenCorvus cost?",
  "home.faq.a6":
    "OpenCorvus is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is OpenCorvus open source?",
  "home.faq.a8.p1": "Yes, OpenCorvus is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that OpenCorvus has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "OpenCorvus Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that OpenCorvus has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is OpenCorvus Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind OpenCorvus.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more OpenCorvus can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a8":
    "While Zen works great with OpenCorvus, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just OpenCorvus users.",
  ...
  "zen.how.body": "While we suggest you use Zen with OpenCorvus, you can use Zen with any agent.",
  ...
  "black.meta.title": "OpenCorvus Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with OpenCorvus Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "OpenCorvus Black | Pricing",
  ...
  "black.workspace.title": "OpenCorvus Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to OpenCorvus Black",
  ...
  "black.subscribe.success.title": "You're on the OpenCorvus Black waitlist",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with opencorvus whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select opencorvus",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start opencorvus and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing opencorvus services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an opencorvus Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to OpenCorvus Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month OpenCorvus Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month OpenCorvus Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to OpenCorvus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "OpenCorvus Go" as the provider in your opencorvus configuration to use Go models.',
  "workspace.lite.other.title": "Go Subscription",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to OpenCorvus Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Go is a $10 per month subscription that provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.meta.description": "Download OpenCorvus for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect OpenCorvus to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", OpenCorvus works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "OpenCorvus is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While OpenCorvus works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in OpenCorvus.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "OpenCorvus | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact OpenCorvus for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "OpenCorvus operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is OpenCorvus Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with OpenCorvus Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. OpenCorvus by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with OpenCorvus Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.meta.description": "OpenCorvus brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the OpenCorvus brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "OpenCorvus | Changelog",
  "changelog.meta.description": "OpenCorvus release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to OpenCorvus",
