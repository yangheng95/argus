...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| CLI binary                | `packages/opencorvus/dist/opencorvus-<platform>/opencorvus(.exe)` plus `bin/rg(.exe)`                              | CI currently stages `ui/` sidecar assets next to the CLI binary. Ripgrep is a packaged runtime binary, not a system dependency.                                             | `packages/opencorvus/script/build.ts` and `.github/workflows/build.yml`                                               |
