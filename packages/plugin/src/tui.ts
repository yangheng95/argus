...
/**
 * Legacy `api.command` shape kept so v1 plugins can initialize.
 *
...
/**
 * Legacy `api.command` API kept so v1 plugins can initialize.
 *
...
export type TuiPlugin = (api: TuiPluginApi, options: TuiPluginOptions | undefined, meta: TuiPluginMeta) => Promise<void>
