...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | OpenCorvus",
  "notFound.heading": "404 - Seite nicht gefunden",
  "notFound.home": "Startseite",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "OpenCorvus Logo hell",
  "notFound.logoDarkAlt": "OpenCorvus Logo dunkel",
  ...
  "app.meta.description": "OpenCorvus - Der Open-Source Coding-Agent.",

  "home.title": "OpenCorvus | Der Open-Source AI-Coding-Agent",

  "temp.title": "OpenCorvus | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von OpenCorvus",
  ...
  "temp.screenshot.caption": "OpenCorvus TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "OpenCorvus TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "OpenCorvus Logo hell",
  "temp.logoDarkAlt": "OpenCorvus Logo dunkel",
  ...
  "home.what.title": "Was ist OpenCorvus?",
  "home.what.body":
    "OpenCorvus ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird OpenCorvus von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "OpenCorvus speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist OpenCorvus?",
  "home.faq.a1":
    "OpenCorvus ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich OpenCorvus?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um OpenCorvus zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, OpenCorvus kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert OpenCorvus auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit OpenCorvus nutzen?",
  "home.faq.a4.p1":
    "Ja, OpenCorvus unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich OpenCorvus nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! OpenCorvus ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet OpenCorvus?",
  "home.faq.a6":
    "OpenCorvus ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist OpenCorvus Open Source?",
  "home.faq.a8.p1": "Ja, OpenCorvus ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die OpenCorvus speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "OpenCorvus Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die OpenCorvus speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist OpenCorvus Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter OpenCorvus.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann OpenCorvus Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt OpenCorvus nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit OpenCorvus funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für OpenCorvus-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit OpenCorvus zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "black.meta.title": "OpenCorvus Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit OpenCorvus Black Abos.",
  ...
  "black.title": "OpenCorvus Black | Preise",
  ...
  "black.workspace.title": "OpenCorvus Black | Workspace wählen",
  "black.workspace.selectPlan": "Wähle einen Workspace für diesen Plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "OpenCorvus Black abonnieren",
  ...
  "black.subscribe.success.title": "Du bist auf der OpenCorvus Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit OpenCorvus, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle OpenCorvus",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte OpenCorvus und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf OpenCorvus-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen OpenCorvus Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast OpenCorvus Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.lite.subscription.message": "Du hast OpenCorvus Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "OpenCorvus Go" als Anbieter in deiner opencorvus-Konfiguration, um Go-Modelle zu verwenden.',
  "workspace.lite.other.title": "Go-Abonnement",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat OpenCorvus Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.title": "OpenCorvus Go",
  "workspace.lite.promo.description":
    "OpenCorvus Go ist ein Abonnement für $10 pro Monat, das zuverlässigen Zugriff auf beliebte offene Coding-Modelle mit großzügigen Nutzungslimits bietet.",
  ...
  "download.meta.description": "Lade OpenCorvus für macOS, Windows und Linux herunter",
  "download.hero.title": "OpenCorvus herunterladen",
  ...
  "download.section.integrations": "OpenCorvus Integrationen",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du OpenCorvus mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert OpenCorvus mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "OpenCorvus ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während OpenCorvus mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in OpenCorvus erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "OpenCorvus | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie OpenCorvus für Enterprise-Lösungen",
  "enterprise.hero.title": "Ihr Code gehört Ihnen",
  "enterprise.hero.body1":
    "OpenCorvus arbeitet sicher innerhalb Ihrer Organisation, ohne dass Daten oder Kontext gespeichert werden und ohne Lizenzbeschränkungen oder Eigentumsansprüche. Starten Sie einen Testlauf mit Ihrem Team, dann rollen Sie es in Ihrer Organisation aus, indem Sie es in Ihr SSO und internes AI-Gateway integrieren.",
  ...
  "enterprise.faq.q1": "Was ist OpenCorvus Enterprise?",
  "enterprise.faq.a1":
    "OpenCorvus Enterprise ist für Organisationen, die sicherstellen wollen, dass Code und Daten niemals ihre Infrastruktur verlassen. Dies geschieht durch eine zentrale Konfiguration, die in Ihr SSO und internes AI-Gateway integriert wird.",
  "enterprise.faq.q2": "Wie starte ich mit OpenCorvus Enterprise?",
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. OpenCorvus speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.q4": "Sind meine Daten mit OpenCorvus Enterprise sicher?",
  "enterprise.faq.a4":
    "Ja. OpenCorvus speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "OpenCorvus | Marke",
  "brand.meta.description": "OpenCorvus Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der OpenCorvus-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "OpenCorvus | Changelog",
  "changelog.meta.description": "OpenCorvus Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für OpenCorvus",
