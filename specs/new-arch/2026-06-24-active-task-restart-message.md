...
| Source                                                         | Constraint                                                                                                                |
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `specs/task-queue-explicit-wake-no-poll-2026-06-17.md`         | Do not restore the A2A task-flow poller; queue work advances only from explicit enqueue/completion/message events.        |
| `specs/operator-wake-status-facts-not-scheduler-2026-06-17.md` | Startup must not terminalize active tasks; status facts are context, and real operator messages are the wake boundary.    |
| `specs/operator-wake-open-tool-facts-2026-06-17.md`            | Do not mutate lifecycle for run-less open tools; expose facts and let the next orchestrator wake decide.                  |
| `specs/new-arch/2026-06-21-dispatch-algorithm-agent-audit.md`  | Durable queued operator wakes drain through `engine/queue.ts`; cwd serialization remains the single queue admission path. |
