export const dict = {
  ...
  "desktop.menu.help.documentation": "Argus Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Argus",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Argus has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Argus CLI binary is missing. Try reinstalling the desktop app.",
