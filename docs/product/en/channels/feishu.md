...
Feishu adapter uses **Webhook mode** (event subscription + encrypted validation).
...
**Text MVP** (`.env.example:48`). Text messaging is complete; images and files use Feishu's `/open-apis/im/v1/images` and `/files`. Rich cards not yet supported.
