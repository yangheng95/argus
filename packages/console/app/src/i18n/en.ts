export const dict = {
  ...
  "notFound.title": "Not Found | argus",
  ...
  "app.meta.description": "Argus - The open source coding agent.",

  "home.title": "Argus | The open source AI coding agent",

  "temp.title": "argus | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by argus",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "argus TUI with the tokyonight theme",
  "temp.screenshot.alt": "argus TUI with tokyonight theme",
  ...
  "home.what.title": "What is Argus?",
  "home.what.body": "Argus is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Argus is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Argus does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Argus?",
  "home.faq.a1":
    "Argus is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Argus?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Argus?",
  "home.faq.a3.p1":
    "Not necessarily, Argus comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Argus also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Argus?",
  "home.faq.a4.p1":
    "Yes, Argus supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Argus in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Argus is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Argus cost?",
  "home.faq.a6":
    "Argus is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Argus open source?",
  "home.faq.a8.p1": "Yes, Argus is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Argus has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "Argus Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Argus has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is Argus Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Argus.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Argus can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Argus adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Argus, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Argus users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Argus, you can use Zen with any agent.",
  ...
  "black.meta.title": "Argus Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with Argus Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "Argus Black | Pricing",
  ...
  "black.workspace.title": "Argus Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to Argus Black",
  ...
  "black.subscribe.success.title": "You're on the Argus Black waitlist",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with argus whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select argus",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start argus and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing argus services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an argus Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to Argus Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month Argus Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month Argus Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to Argus Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "Argus Go" as the provider in your argus configuration to use Go models.',
  "workspace.lite.other.title": "Go Subscription",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to Argus Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.title": "Argus Go",
  "workspace.lite.promo.description":
    "Argus Go is a $10 per month subscription that provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.meta.description": "Download Argus for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Argus to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Argus works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Argus is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Argus works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Argus.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Argus | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Argus for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Argus operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Argus Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with Argus Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Argus by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Argus Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.meta.description": "Argus brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Argus brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Argus | Changelog",
  "changelog.meta.description": "Argus release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Argus",
