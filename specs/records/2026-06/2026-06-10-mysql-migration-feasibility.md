...
- `specs/records/2026-06/db-schema-drift-reset-2026-06-03.md` intentionally removed compatibility migrations and chose reset-on-drift with `SCHEMA_DDL` as the single schema source.
- `specs/current/architecture/16-unified-teardown.md` repeatedly treats schema changes as reset-DB work, not migration-script work.
