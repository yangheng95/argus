...
- Plan: 2 goals
- Active run: run_d5251c349001o9WfaF5tqscNKY (running)
- Budget: 7/20 runs, 0/8 fixes
...
Executor run run_d5251c349001o9WfaF5tqscNKY completed.
...
测试目标仍在运行状态，但执行器已经完成了。让我重新创建运行并提交执行来完成测试目标。
