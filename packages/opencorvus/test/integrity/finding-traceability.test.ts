  ...
  test("reviewer and consensus prompts echo traceability at role level", () => {
    ...
    const consensusPrompt = buildSupervisorConsensusPrompt(
      ...
      [
        {
          reviewerID: "scope",
          checkIDs: ["check-scope"],
          scope: "Scope reviewer",
          verdict: "concerns",
          summary: "Bundle concern is untraced and should be dropped.",
          investigationPlan,
          evidence: [{ checkIDs: ["check-scope"], note: "No REQ or AS names bundle size." }],
          openQuestions: [],
        },
        {
          reviewerID: "runtime",
          checkIDs: ["check-runtime"],
          scope: "Runtime reviewer",
          verdict: "pass",
          summary: "Runtime behavior is covered.",
          investigationPlan,
          evidence: [{ checkIDs: ["check-runtime"], note: "acc-errors names 401 Chinese error." }],
          openQuestions: [],
        },
      ],
    )
