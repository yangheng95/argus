...
| Log storage      | `specs/records/2026-06/2026-06-04-unified-log-storage-http-api.md` records `/log`, `/log/files`, and `/log/tail` as the unified server log API. | Do not add another API route for this UI change.                                                     |
