---
title: خوادم LSP
description: يتكامل Argus مع خوادم LSP لديك.
---

يتكامل Argus مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Argus مع عدة خوادم LSP مدمجة للغات الشائعة:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات argus.
