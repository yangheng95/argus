...
- Plan: 2 goals
- Active run: run_d5255a3f7001IWojsE7Lz7aPS3 (running)
- Budget: 12/20 runs, 0/8 fixes
...
Executor run run_d5255a3f7001IWojsE7Lz7aPS3 completed.
...
测试目标状态为 running，但执行器已经完成了。让我重新创建运行并提交执行：
