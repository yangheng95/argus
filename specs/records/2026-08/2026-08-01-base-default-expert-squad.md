...
7. Perform a final semantic diff review, stage only task-owned paths/hunks, commit
   with `dsw-33987`, push `v0.0.27beta` to `myhexin`, and verify remote equality.
