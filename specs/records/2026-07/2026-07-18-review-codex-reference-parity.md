...
| Git baseline | Branch `work-v0.0.9beta-yr-0718` started this task clean at `d6289d1c2`, equal to `myhexin/work-v0.0.9beta-yr-0718`; the baseline push and repository hooks passed before this record was written. |
...
7. Record the exact evidence, commit only task-owned files with the required prefix, and push the delivery branch through normal git-cc hooks.
