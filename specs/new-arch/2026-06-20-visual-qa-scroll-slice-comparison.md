...
Add a visual-qa-only tool named `browser_preview_compare_scroll_slices`.
...
| `packages/opencorvus/src/visual-qa/static-tools.ts`               | Allows `browser_preview`, bind, and region compare.                                               | Add `browser_preview_compare_scroll_slices` only to visual-qa implementation tools.                                                                                           |
...
- `browser_preview_compare_scroll_slices` is available to visual-qa and not to
  build.
