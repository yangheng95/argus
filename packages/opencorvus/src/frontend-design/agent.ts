...
function buildUserPrompt(input: {
  ...
  sections.push(
    ...
    "Populate the target delivery project directly with file-edit tools by copying/adapting the runnable baseline from `frontend-design-skeleton` first, then replacing selected regions. " +
