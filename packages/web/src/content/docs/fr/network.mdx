...
OpenCorvus prend en charge les variables d'environnement proxy standard et les certificats personnalisés pour les environnements réseau d'entreprise.

---

## Proxy

OpenCorvus respecte les variables d'environnement proxy standard.
...
Si votre entreprise utilise des autorités de certification personnalisées pour les connexions HTTPS, configurez OpenCorvus pour leur faire confiance.
