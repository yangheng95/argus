...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/argus.git")).toEqual({ owner: "sst", repo: "argus" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/argus")).toEqual({ owner: "sst", repo: "argus" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/argus.git")).toEqual({ owner: "sst", repo: "argus" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/argus")).toEqual({ owner: "sst", repo: "argus" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/argus.git")).toEqual({ owner: "sst", repo: "argus" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/argus")).toEqual({ owner: "sst", repo: "argus" })
})
