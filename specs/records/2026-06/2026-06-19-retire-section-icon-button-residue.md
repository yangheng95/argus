...
| `rg -n "section-head-action    | section-actions" packages/overlay/src packages/overlay/test specs --glob "_._"` | These are separate surface classes and are not the phantom `.oc-section__icon-btn` owner. | Leave them unchanged. |
