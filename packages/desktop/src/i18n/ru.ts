export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Argus",
  ...
  "desktop.updater.downloaded.prompt": "Версия Argus {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.menu.help.documentation": "Документация Argus",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Argus CLI. Попробуйте переустановить настольное приложение.",
