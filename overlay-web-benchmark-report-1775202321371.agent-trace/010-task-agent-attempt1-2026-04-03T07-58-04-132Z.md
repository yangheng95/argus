...
- Plan: 2 goals
- Active run: run_d5258a75300102RC8H7IZPN3Bm (running)
...
Executor run run_d5258a75300102RC8H7IZPN3Bm completed.
...
目标已经在运行中。让我等待执行完成后再检查状态。由于执行器已经完成，但目标仍在运行状态，我需要检查是否有问题。让我尝试创建一个新的运行来同时执行两个目标。
