...
| `specs/records/2026-06/2026-06-29-spec-consolidation.md`                          | The old task tree external note is historical; current behavior must be pinned by local tests and source contracts.     |
