---
title: Compartir
description: Comparte tus conversaciones OpenCorvus.
---

La función para compartir de OpenCorvus te permite crear enlaces públicos a tus conversaciones de OpenCorvus, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, OpenCorvus:
...
OpenCorvus admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, OpenCorvus usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `opencorvus.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de opencorvus en su organización.
