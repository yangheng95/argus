---
title: TUI
description: Bruke opencorvus-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

opencorvus gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre opencorvus starter TUI for gjeldende katalog.
...
Når du bruker opencorvus TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til opencorvus. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt opencorvus. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom opencorvus-konfigurasjonsfilen.
