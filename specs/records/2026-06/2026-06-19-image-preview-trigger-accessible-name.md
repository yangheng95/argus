...
| ----------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ---------------- | ------------ | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| `rg -n "Open image preview                            | data-image-preview-trigger                                              | data-image-preview-alt                                                  | PreviewableImage | ImagePreview | image preview" packages/overlay/src packages/overlay/test specs` | Fixed labels live in `ImagePreview.tsx` and `markdown.ts`; delegated open logic in `main.tsx` already reads `data-image-preview-alt`. | Replace both fixed labels through one helper. |
