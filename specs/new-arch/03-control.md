...
**Capability 举例**（完整列表见 `panel/capability.ts`）：
```
view_plan · view_board · view_tasks
create_task · send_task_message
reply_interaction · reject_interaction
retry_task · replan_task · cancel_task
update_checks · update_goal · delete_goal
capture_overlay_screenshot
set_executor · select_task · select_session · invalidate_session
create_session · fork_session · delete_session · export_session_html
```
