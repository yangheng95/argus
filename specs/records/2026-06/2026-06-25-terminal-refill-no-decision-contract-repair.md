...
- `specs/records/2026-06/orchestrator-no-decision-stop-2026-06-18.md` introduced strict
  ...
  fuse boundary.
- `specs/records/2026-06/2026-06-22-orchestrator-live-build-park-prompt.md` keeps the
  no-decision classifier strict but relies on terminal refill facts as the
  next source of scheduling evidence.
- `specs/records/2026-06/2026-06-21-dispatch-algorithm-agent-audit.md` keeps
