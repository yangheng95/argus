      ...
      execute: async (params) => {
        ...
        return {
          ...
          output: [
            ...
            "6. Populate target source files next for that selected region. The next target-project write should be `src/App.tsx` or a semantic component/data/style/asset module, not `index.html`, `package.json`, `tsconfig.json`, or bundler config. Do not write imports for components/data/style modules that you are not creating in the same pass.",
