...
يوجد نوعان من الوكلاء في Argus: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Argus مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Argus مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Argus مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `argus.json`:
...
- عام: `~/.config/argus/agents/`
- لكل مشروع: `.argus/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Argus القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Argus العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Argus الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Argus Zen](/docs/zen)، فستستخدم `argus/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `argus models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/yangheng95/argus).
:::
