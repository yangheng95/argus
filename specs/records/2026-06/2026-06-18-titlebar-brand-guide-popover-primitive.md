...
| Sweep                         | Result         |
| ----------------------------- | -------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| `rg -n "brand-guide           | brand\\.guide  | solidTitlebarBrandGuide                                                                                   | guide_usage_4" packages/overlay/src packages/overlay/test specs`                                | Brand guide is limited to static HTML, i18n strings, `titlebar.css`, titlebar browser geometry checks, and architecture/surface guards. |
