...
export type ReviewStreamPhase = "integrity" | "delivery"
...
export function reviewIDForDelivery(taskID: string, iteration: number): string {
  return `delivery:${taskID}:${iteration}`
}
