...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `OPENCORVUS_HOME`                   | Portable root for OpenCorvus-owned directories. When set, data, config, cache, and state live under this root. | unset; use XDG directories or `%APPDATA%` / `%LOCALAPPDATA%`               |
| `OPENCORVUS_GLOBAL_CONFIG_DIR`      | Override the global user config directory.                                                                     | XDG config directory, `%APPDATA%/opencorvus`, or `$OPENCORVUS_HOME/config` |
...
| `OPENCORVUS_PERMISSION`             | Inline JSON permission patch.                                                                                  | unset                                                                      |
...
| Variable                                      | Purpose                                                    | Default         |
| --------------------------------------------- | ---------------------------------------------------------- | --------------- |
| `OPENCORVUS_AUTO_DISCOVER_EXECUTORS`          | Enable executor discovery during startup.                  | `0`             |
| `OPENCORVUS_EXECUTOR_SEARCH_PATHS`            | Extra paths scanned for executor binaries.                 | unset           |
| `OPENCORVUS_EXECUTOR_CODEX_MODEL`             | Default model for discovered Codex executor config.        | unset           |
| `OPENCORVUS_EXECUTOR_CODEX_SYSTEM`            | Extra system prompt for discovered Codex executor config.  | unset           |
| `OPENCORVUS_EXECUTOR_CODEX_MAX_TURNS`         | Max turns for discovered Codex executor config.            | unset           |
| `OPENCORVUS_EXECUTOR_CODEX_PROTOCOL`          | Codex executor protocol selector.                          | runtime default |
| `OPENCORVUS_EXECUTOR_CODEX_APPROVAL`          | Codex app-server approval mode.                            | runtime default |
| `OPENCORVUS_EXECUTOR_CODEX_SANDBOX`           | Codex app-server sandbox mode.                             | runtime default |
| `OPENCORVUS_EXECUTOR_CODEX_NETWORK`           | Codex app-server network mode.                             | runtime default |
| `OPENCORVUS_EXECUTOR_CLAUDE_MODEL`            | Default model for discovered Claude executor config.       | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_SYSTEM`           | Extra system prompt for discovered Claude executor config. | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_MAX_TURNS`        | Max turns for discovered Claude executor config.           | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_PERMISSION_MODE`  | Claude executor permission mode.                           | `default`       |
| `OPENCORVUS_EXECUTOR_CLAUDE_ALLOWED_TOOLS`    | Comma-separated allowed Claude tools.                      | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_DISALLOWED_TOOLS` | Comma-separated disallowed Claude tools.                   | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_EFFORT`           | Claude reasoning effort.                                   | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_MAX_BUDGET_USD`   | Claude executor budget ceiling in USD.                     | unset           |
...
| `DASHSCOPE_API_KEY`            | DashScope standard endpoint key.                   |
| `CODING_DASHSCOPE_API_KEY`     | DashScope Coding Plan key.                         |
| `DASHSCOPE_CODING_BASE_URL`    | DashScope Coding Plan base URL.                    |
| `DASHSCOPE_INTL_BASE_URL`      | DashScope international endpoint base URL.         |
| `ALIBABA_CODING_PLAN_API_KEY`  | DashScope Coding Plan key used by channel runtime. |
