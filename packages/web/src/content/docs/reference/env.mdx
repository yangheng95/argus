...
| `OPENCORVUS_EXECUTOR_OPENCORVUS_BIN`          | Explicit OpenCorvus executor binary path.                  | unset           |
| `OPENCORVUS_EXECUTOR_CODEX_BIN`               | Explicit Codex executor binary path.                       | unset           |
| `OPENCORVUS_EXECUTOR_CLAUDE_CODE_BIN`         | Explicit Claude Code executor binary path.                 | unset           |
