...
| `specs/current/architecture/01-agents.md`                                                               | The orchestrator is the only lifecycle decision host. Workers do not own task-level scheduling.                                                                                                 |
| `specs/current/architecture/13-agent-communication-matrix.md`                                           | Current communication is a hybrid of channel ingress, control messages, orchestrator tools, build tools, and task subagents. There is no canonical durable A2A mailbox.                         |
| `specs/records/2026-06/2026-06-24-tool-pool-convergence.md`                                        | Agent, tool, and skill contracts must move together. Tool pools express visibility and ownership, not duplicate semantic tools.                                                                 |
| `specs/records/2026-06/2026-06-24-agent-abstraction-convergence.md`                                | Agent abstractions converge to `host` and `worker`; role-specific behavior is metadata, not another agent class.                                                                                |
| `specs/records/2026-06/2026-06-24-remove-steer-subagent-tool.md` from the dirty main worktree      | `steer_subagent` is a wrong surface and must not be preserved as A2A. A replacement must be request-bound and visible.                                                                          |
| `specs/records/2026-06/2026-06-24-remove-restart-stage-goal-reset.md` from the dirty main worktree | `restart_from_stage` is task-wide rewind behavior and must not be the default repair path for worker failures.                                                                                  |
| `specs/records/2026-06/2026-06-22-build-terminal-finalizer-continuation.md`                        | `stage_continuation_request` is a narrow same-session finalizer-miss recovery artifact. Reuse its durable claim pattern, not its scope.                                                         |
