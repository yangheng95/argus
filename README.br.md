...
nix run nixpkgs#opencode           # ou github:yangheng95/argus para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/yangheng95/argus/releases) ou em [opencode.ai/download](https://opencode.ai/download).
