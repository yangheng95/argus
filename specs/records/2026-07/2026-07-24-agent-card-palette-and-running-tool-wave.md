...
- The first required `legacy-remote` push attempt ran the real pre-push hook and was blocked by unrelated Fact Check / Visual QA TypeScript errors in the concurrent dirty worktree. A final push retry remains required after this task's commit.
