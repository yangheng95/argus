...
- `specs/new-arch/2026-06-27-a2a-adversarial-audit.md`
...
- Do not treat `specs/new-arch/11-agent-oop-protocol.md` as current runtime
...
Get-Content -LiteralPath specs/new-arch/01-agents.md
Get-Content -LiteralPath specs/new-arch/13-agent-communication-matrix.md
Get-Content -LiteralPath specs/new-arch/2026-06-27-a2a-adversarial-audit.md
