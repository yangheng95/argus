...
| Source                                                                     | Constraint                                                                                                                             |
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `specs/records/2026-06/task-execution-terminalization-2026-06-16.md`                       | Shutdown must terminate process-owned live task/session/goal state so restarted servers do not show zombie active tasks.               |
| `specs/records/2026-06/event-log-task-project-directory-2026-06-16.md`                     | Shutdown/event-log code must resolve task project context from task/project rows, not ambient `Instance`.                              |
| `specs/records/2026-06/2026-06-22-delete-active-task-record-context.md`           | Process-lifecycle terminalization is distinct from user cancellation and may mark task-owned sessions aborted while the process exits. |
| `specs/records/2026-06/2026-06-21-world-economy-stuck-adversarial-goal-review.md` | Runtime must not hide failures with automatic resume/retry. Recovery must remain explicit operator action.                             |
