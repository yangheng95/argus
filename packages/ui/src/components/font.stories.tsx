...
const docs = `### Overview
Loads Argus typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Argus Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Argus Mono Sample</div>
    </div>
  ),
}
