---
title: Zen
description: Lista curata di modelli fornita da Argus.
---
...
Argus Zen e una lista di modelli testati e verificati dal team di Argus.

:::note
Argus Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Argus. Accedi a Argus Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Argus.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Argus.
:::
...
Argus Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

Argus Zen funziona come qualunque altro provider in Argus.

1. Accedi a **<a href={console}>Argus Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Argus Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Argus usa il formato `argus/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `argus/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su Argus per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su Argus per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su Argus per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Argus per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Argus.
